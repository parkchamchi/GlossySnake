...
class ParserTestCase(APITransactionTestCase):
	def test_divide_parse(self):
		...
		#Test /parse/divide
		url = reverse("api-v4-parser-divide")
		p_delims = ['\n']
		...
		#Test /tasks/<pk>
		url = reverse("api-v4-tasks-pk", args=[task_id])
		...
		#Test /parser/parse
		url = reverse("api-v4-parser-parse")
		t_delims = None
		...
		url = reverse("api-v4-annotator-annotate")
		lang_from = "english"
		lang_to = "french"
