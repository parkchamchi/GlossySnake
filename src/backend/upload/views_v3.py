...
class ManipulatorAPIViewV3(APIView):
	parser_classes = [JSONParser]
	permission_classes = (AllowAny, )
...
class ParserDivideAPIViewV3(ManipulatorAPIViewV3):
	def __init__(self):
...
class ParserParserAPIViewV3(ManipulatorAPIViewV3):
	def __init__(self):
...
class AnnotatorAnnotateAPIViewV3(ManipulatorAPIViewV3):
	def __init__(self):
...
class CorpusesAPIViewV3(APIView):
	parser_classes = [JSONParser]
	permission_classes = (AllowAny, )
...
class CorpusesListAPIViewV3(APIView):
	parser_classes = [JSONParser]
	permission_classes = (AllowAny, )
...
class TasksListAPIViewV3(APIView):
	parser_classes = [JSONParser]
	permission_classes = (AllowAny, )
