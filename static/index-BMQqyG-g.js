...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function Xs(t){const e=Object.create(null);for(const s of t.split(","))e[s]=1;return s=>s in e}const U={},xe=[],It=()=>{},vn=()=>!1,cs=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),tl=t=>t.startsWith("onUpdate:"),rt=Object.assign,el=(t,e)=>{const s=t.indexOf(e);s>-1&&t.splice(s,1)},yn=Object.prototype.hasOwnProperty,L=(t,e)=>yn.call(t,e),D=Array.isArray,he=t=>Ue(t)==="[object Map]",Ee=t=>Ue(t)==="[object Set]",Tl=t=>Ue(t)==="[object Date]",O=t=>typeof t=="function",Y=t=>typeof t=="string",Pt=t=>typeof t=="symbol",B=t=>t!==null&&typeof t=="object",gi=t=>(B(t)||O(t))&&O(t.then)&&O(t.catch),fi=Object.prototype.toString,Ue=t=>fi.call(t),Tn=t=>Ue(t).slice(8,-1),xi=t=>Ue(t)==="[object Object]",sl=t=>Y(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Oe=Xs(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ps=t=>{const e=Object.create(null);return s=>e[s]||(e[s]=t(s))},Dn=/-(\w)/g,Dt=ps(t=>t.replace(Dn,(e,s)=>s?s.toUpperCase():"")),Sn=/\B([A-Z])/g,_e=ps(t=>t.replace(Sn,"-$1").toLowerCase()),bs=ps(t=>t.charAt(0).toUpperCase()+t.slice(1)),Gs=ps(t=>t?`on${bs(t)}`:""),ue=(t,e)=>!Object.is(t,e),ns=(t,...e)=>{for(let s=0;s<t.length;s++)t[s](...e)},hi=(t,e,s,l=!1)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,writable:l,value:s})},ms=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Dl;const ci=()=>Dl||(Dl=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function ll(t){if(D(t)){const e={};for(let s=0;s<t.length;s++){const l=t[s],i=Y(l)?On(l):ll(l);if(i)for(const n in i)e[n]=i[n]}return e}else if(Y(t)||B(t))return t}const Nn=/;(?![^(]*\))/g,Gn=/:([^]+)/,jn=/\/\*[^]*?\*\//g;function On(t){const e={};return t.replace(jn,"").split(Nn).forEach(s=>{if(s){const l=s.split(Gn);l.length>1&&(e[l[0].trim()]=l[1].trim())}}),e}function Rt(t){let e="";if(Y(t))e=t;else if(D(t))for(let s=0;s<t.length;s++){const l=Rt(t[s]);l&&(e+=l+" ")}else if(B(t))for(const s in t)t[s]&&(e+=s+" ");return e.trim()}const Cn="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Rn=Xs(Cn);function pi(t){return!!t||t===""}function Wn(t,e){if(t.length!==e.length)return!1;let s=!0;for(let l=0;s&&l<t.length;l++)s=qe(t[l],e[l]);return s}function qe(t,e){if(t===e)return!0;let s=Tl(t),l=Tl(e);if(s||l)return s&&l?t.getTime()===e.getTime():!1;if(s=Pt(t),l=Pt(e),s||l)return t===e;if(s=D(t),l=D(e),s||l)return s&&l?Wn(t,e):!1;if(s=B(t),l=B(e),s||l){if(!s||!l)return!1;const i=Object.keys(t).length,n=Object.keys(e).length;if(i!==n)return!1;for(const r in t){const o=t.hasOwnProperty(r),a=e.hasOwnProperty(r);if(o&&!a||!o&&a||!qe(t[r],e[r]))return!1}}return String(t)===String(e)}function il(t,e){return t.findIndex(s=>qe(s,e))}const bi=t=>!!(t&&t.__v_isRef===!0),At=t=>Y(t)?t:t==null?"":D(t)||B(t)&&(t.toString===fi||!O(t.toString))?bi(t)?At(t.value):JSON.stringify(t,ki,2):String(t),ki=(t,e)=>bi(e)?ki(t,e.value):he(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((s,[l,i],n)=>(s[js(l,n)+" =>"]=i,s),{})}:Ee(e)?{[`Set(${e.size})`]:[...e.values()].map(s=>js(s))}:Pt(e)?js(e):B(e)&&!D(e)&&!xi(e)?String(e):e,js=(t,e="")=>{var s;return Pt(t)?`Symbol(${(s=t.description)!=null?s:e})`:t};/**
* @vue/reactivity v3.5.5
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let pt;class In{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=pt,!e&&pt&&(this.index=(pt.scopes||(pt.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,s;if(this.scopes)for(e=0,s=this.scopes.length;e<s;e++)this.scopes[e].pause();for(e=0,s=this.effects.length;e<s;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,s;if(this.scopes)for(e=0,s=this.scopes.length;e<s;e++)this.scopes[e].resume();for(e=0,s=this.effects.length;e<s;e++)this.effects[e].resume()}}run(e){if(this._active){const s=pt;try{return pt=this,e()}finally{pt=s}}}on(){pt=this}off(){pt=this.parent}stop(e){if(this._active){let s,l;for(s=0,l=this.effects.length;s<l;s++)this.effects[s].stop();for(s=0,l=this.cleanups.length;s<l;s++)this.cleanups[s]();if(this.scopes)for(s=0,l=this.scopes.length;s<l;s++)this.scopes[s].stop(!0);if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0,this._active=!1}}}function Pn(){return pt}let M;const Os=new WeakSet;class wi{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.nextEffect=void 0,this.cleanup=void 0,this.scheduler=void 0,pt&&pt.active&&pt.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Os.has(this)&&(Os.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||(this.flags|=8,this.nextEffect=Ce,Ce=this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Sl(this),Ei(this);const e=M,s=yt;M=this,yt=!0;try{return this.fn()}finally{vi(this),M=e,yt=s,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)ol(e);this.deps=this.depsTail=void 0,Sl(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Os.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Hs(this)&&this.run()}get dirty(){return Hs(this)}}let Ai=0,Ce;function nl(){Ai++}function rl(){if(--Ai>0)return;let t;for(;Ce;){let e=Ce;for(Ce=void 0;e;){const s=e.nextEffect;if(e.nextEffect=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(l){t||(t=l)}e=s}}if(t)throw t}function Ei(t){for(let e=t.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function vi(t){let e,s=t.depsTail,l=s;for(;l;){const i=l.prevDep;l.version===-1?(l===s&&(s=i),ol(l),zn(l)):e=l,l.dep.activeLink=l.prevActiveLink,l.prevActiveLink=void 0,l=i}t.deps=e,t.depsTail=s}function Hs(t){for(let e=t.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&yi(e.dep.computed)||e.dep.version!==e.version)return!0;return!!t._dirty}function yi(t){if(t.flags&4&&!(t.flags&16)||(t.flags&=-17,t.globalVersion===Pe))return;t.globalVersion=Pe;const e=t.dep;if(t.flags|=2,e.version>0&&!t.isSSR&&!Hs(t)){t.flags&=-3;return}const s=M,l=yt;M=t,yt=!0;try{Ei(t);const i=t.fn(t._value);(e.version===0||ue(i,t._value))&&(t._value=i,e.version++)}catch(i){throw e.version++,i}finally{M=s,yt=l,vi(t),t.flags&=-3}}function ol(t){const{dep:e,prevSub:s,nextSub:l}=t;if(s&&(s.nextSub=l,t.prevSub=void 0),l&&(l.prevSub=s,t.nextSub=void 0),e.subs===t&&(e.subs=s),!e.subs&&e.computed){e.computed.flags&=-5;for(let i=e.computed.deps;i;i=i.nextDep)ol(i)}}function zn(t){const{prevDep:e,nextDep:s}=t;e&&(e.nextDep=s,t.prevDep=void 0),s&&(s.prevDep=e,t.nextDep=void 0)}let yt=!0;const Ti=[];function Xt(){Ti.push(yt),yt=!1}function te(){const t=Ti.pop();yt=t===void 0?!0:t}function Sl(t){const{cleanup:e}=t;if(t.cleanup=void 0,e){const s=M;M=void 0;try{e()}finally{M=s}}}let Pe=0;class Ln{constructor(e,s){this.sub=e,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Di{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0}track(e){if(!M||!yt||M===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==M)s=this.activeLink=new Ln(M,this),M.deps?(s.prevDep=M.depsTail,M.depsTail.nextDep=s,M.depsTail=s):M.deps=M.depsTail=s,M.flags&4&&Si(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const l=s.nextDep;l.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=l),s.prevDep=M.depsTail,s.nextDep=void 0,M.depsTail.nextDep=s,M.depsTail=s,M.deps===s&&(M.deps=l)}return s}trigger(e){this.version++,Pe++,this.notify(e)}notify(e){nl();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()}finally{rl()}}}function Si(t){const e=t.dep.computed;if(e&&!t.dep.subs){e.flags|=20;for(let l=e.deps;l;l=l.nextDep)Si(l)}const s=t.dep.subs;s!==t&&(t.prevSub=s,s&&(s.nextSub=t)),t.dep.subs=t}const Ms=new WeakMap,oe=Symbol(""),Us=Symbol(""),ze=Symbol("");function ot(t,e,s){if(yt&&M){let l=Ms.get(t);l||Ms.set(t,l=new Map);let i=l.get(s);i||l.set(s,i=new Di),i.track()}}function Mt(t,e,s,l,i,n){const r=Ms.get(t);if(!r){Pe++;return}const o=a=>{a&&a.trigger()};if(nl(),e==="clear")r.forEach(o);else{const a=D(t),_=a&&sl(s);if(a&&s==="length"){const m=Number(l);r.forEach((f,k)=>{(k==="length"||k===ze||!Pt(k)&&k>=m)&&o(f)})}else switch(s!==void 0&&o(r.get(s)),_&&o(r.get(ze)),e){case"add":a?_&&o(r.get("length")):(o(r.get(oe)),he(t)&&o(r.get(Us)));break;case"delete":a||(o(r.get(oe)),he(t)&&o(r.get(Us)));break;case"set":he(t)&&o(r.get(oe));break}}rl()}function ge(t){const e=H(t);return e===t?e:(ot(e,"iterate",ze),Tt(t)?e:e.map(_t))}function ks(t){return ot(t=H(t),"iterate",ze),t}const Fn={__proto__:null,[Symbol.iterator](){return Cs(this,Symbol.iterator,_t)},concat(...t){return ge(this).concat(...t.map(e=>D(e)?ge(e):e))},entries(){return Cs(this,"entries",t=>(t[1]=_t(t[1]),t))},every(t,e){return Lt(this,"every",t,e,void 0,arguments)},filter(t,e){return Lt(this,"filter",t,e,s=>s.map(_t),arguments)},find(t,e){return Lt(this,"find",t,e,_t,arguments)},findIndex(t,e){return Lt(this,"findIndex",t,e,void 0,arguments)},findLast(t,e){return Lt(this,"findLast",t,e,_t,arguments)},findLastIndex(t,e){return Lt(this,"findLastIndex",t,e,void 0,arguments)},forEach(t,e){return Lt(this,"forEach",t,e,void 0,arguments)},includes(...t){return Rs(this,"includes",t)},indexOf(...t){return Rs(this,"indexOf",t)},join(t){return ge(this).join(t)},lastIndexOf(...t){return Rs(this,"lastIndexOf",t)},map(t,e){return Lt(this,"map",t,e,void 0,arguments)},pop(){return Se(this,"pop")},push(...t){return Se(this,"push",t)},reduce(t,...e){return Nl(this,"reduce",t,e)},reduceRight(t,...e){return Nl(this,"reduceRight",t,e)},shift(){return Se(this,"shift")},some(t,e){return Lt(this,"some",t,e,void 0,arguments)},splice(...t){return Se(this,"splice",t)},toReversed(){return ge(this).toReversed()},toSorted(t){return ge(this).toSorted(t)},toSpliced(...t){return ge(this).toSpliced(...t)},unshift(...t){return Se(this,"unshift",t)},values(){return Cs(this,"values",_t)}};function Cs(t,e,s){const l=ks(t),i=l[e]();return l!==t&&!Tt(t)&&(i._next=i.next,i.next=()=>{const n=i._next();return n.value&&(n.value=s(n.value)),n}),i}const Hn=Array.prototype;function Lt(t,e,s,l,i,n){const r=ks(t),o=r!==t&&!Tt(t),a=r[e];if(a!==Hn[e]){const f=a.apply(t,n);return o?_t(f):f}let _=s;r!==t&&(o?_=function(f,k){return s.call(this,_t(f),k,t)}:s.length>2&&(_=function(f,k){return s.call(this,f,k,t)}));const m=a.call(r,_,l);return o&&i?i(m):m}function Nl(t,e,s,l){const i=ks(t);let n=s;return i!==t&&(Tt(t)?s.length>3&&(n=function(r,o,a){return s.call(this,r,o,a,t)}):n=function(r,o,a){return s.call(this,r,_t(o),a,t)}),i[e](n,...l)}function Rs(t,e,s){const l=H(t);ot(l,"iterate",ze);const i=l[e](...s);return(i===-1||i===!1)&&ml(s[0])?(s[0]=H(s[0]),l[e](...s)):i}function Se(t,e,s=[]){Xt(),nl();const l=H(t)[e].apply(t,s);return rl(),te(),l}const Mn=Xs("__proto__,__v_isRef,__isVue"),Ni=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Pt));function Un(t){Pt(t)||(t=String(t));const e=H(this);return ot(e,"has",t),e.hasOwnProperty(t)}class Gi{constructor(e=!1,s=!1){this._isReadonly=e,this._isShallow=s}get(e,s,l){const i=this._isReadonly,n=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return n;if(s==="__v_raw")return l===(i?n?sr:Ri:n?Ci:Oi).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(l)?e:void 0;const r=D(e);if(!i){let a;if(r&&(a=Fn[s]))return a;if(s==="hasOwnProperty")return Un}const o=Reflect.get(e,s,mt(e)?e:l);return(Pt(s)?Ni.has(s):Mn(s))||(i||ot(e,"get",s),n)?o:mt(o)?r&&sl(s)?o:o.value:B(o)?i?Wi(o):$e(o):o}}class ji extends Gi{constructor(e=!1){super(!1,e)}set(e,s,l,i){let n=e[s];if(!this._isShallow){const a=ke(n);if(!Tt(l)&&!ke(l)&&(n=H(n),l=H(l)),!D(e)&&mt(n)&&!mt(l))return a?!1:(n.value=l,!0)}const r=D(e)&&sl(s)?Number(s)<e.length:L(e,s),o=Reflect.set(e,s,l,mt(e)?e:i);return e===H(i)&&(r?ue(l,n)&&Mt(e,"set",s,l):Mt(e,"add",s,l)),o}deleteProperty(e,s){const l=L(e,s);e[s];const i=Reflect.deleteProperty(e,s);return i&&l&&Mt(e,"delete",s,void 0),i}has(e,s){const l=Reflect.has(e,s);return(!Pt(s)||!Ni.has(s))&&ot(e,"has",s),l}ownKeys(e){return ot(e,"iterate",D(e)?"length":oe),Reflect.ownKeys(e)}}class qn extends Gi{constructor(e=!1){super(!0,e)}set(e,s){return!0}deleteProperty(e,s){return!0}}const $n=new ji,Bn=new qn,Kn=new ji(!0);const al=t=>t,ws=t=>Reflect.getPrototypeOf(t);function Xe(t,e,s=!1,l=!1){t=t.__v_raw;const i=H(t),n=H(e);s||(ue(e,n)&&ot(i,"get",e),ot(i,"get",n));const{has:r}=ws(i),o=l?al:s?_l:_t;if(r.call(i,e))return o(t.get(e));if(r.call(i,n))return o(t.get(n));t!==i&&t.get(e)}function ts(t,e=!1){const s=this.__v_raw,l=H(s),i=H(t);return e||(ue(t,i)&&ot(l,"has",t),ot(l,"has",i)),t===i?s.has(t):s.has(t)||s.has(i)}function es(t,e=!1){return t=t.__v_raw,!e&&ot(H(t),"iterate",oe),Reflect.get(t,"size",t)}function Gl(t,e=!1){!e&&!Tt(t)&&!ke(t)&&(t=H(t));const s=H(this);return ws(s).has.call(s,t)||(s.add(t),Mt(s,"add",t,t)),this}function jl(t,e,s=!1){!s&&!Tt(e)&&!ke(e)&&(e=H(e));const l=H(this),{has:i,get:n}=ws(l);let r=i.call(l,t);r||(t=H(t),r=i.call(l,t));const o=n.call(l,t);return l.set(t,e),r?ue(e,o)&&Mt(l,"set",t,e):Mt(l,"add",t,e),this}function Ol(t){const e=H(this),{has:s,get:l}=ws(e);let i=s.call(e,t);i||(t=H(t),i=s.call(e,t)),l&&l.call(e,t);const n=e.delete(t);return i&&Mt(e,"delete",t,void 0),n}function Cl(){const t=H(this),e=t.size!==0,s=t.clear();return e&&Mt(t,"clear",void 0,void 0),s}function ss(t,e){return function(l,i){const n=this,r=n.__v_raw,o=H(r),a=e?al:t?_l:_t;return!t&&ot(o,"iterate",oe),r.forEach((_,m)=>l.call(i,a(_),a(m),n))}}function ls(t,e,s){return function(...l){const i=this.__v_raw,n=H(i),r=he(n),o=t==="entries"||t===Symbol.iterator&&r,a=t==="keys"&&r,_=i[t](...l),m=s?al:e?_l:_t;return!e&&ot(n,"iterate",a?Us:oe),{next(){const{value:f,done:k}=_.next();return k?{value:f,done:k}:{value:o?[m(f[0]),m(f[1])]:m(f),done:k}},[Symbol.iterator](){return this}}}}function Vt(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function Vn(){const t={get(n){return Xe(this,n)},get size(){return es(this)},has:ts,add:Gl,set:jl,delete:Ol,clear:Cl,forEach:ss(!1,!1)},e={get(n){return Xe(this,n,!1,!0)},get size(){return es(this)},has:ts,add(n){return Gl.call(this,n,!0)},set(n,r){return jl.call(this,n,r,!0)},delete:Ol,clear:Cl,forEach:ss(!1,!0)},s={get(n){return Xe(this,n,!0)},get size(){return es(this,!0)},has(n){return ts.call(this,n,!0)},add:Vt("add"),set:Vt("set"),delete:Vt("delete"),clear:Vt("clear"),forEach:ss(!0,!1)},l={get(n){return Xe(this,n,!0,!0)},get size(){return es(this,!0)},has(n){return ts.call(this,n,!0)},add:Vt("add"),set:Vt("set"),delete:Vt("delete"),clear:Vt("clear"),forEach:ss(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(n=>{t[n]=ls(n,!1,!1),s[n]=ls(n,!0,!1),e[n]=ls(n,!1,!0),l[n]=ls(n,!0,!0)}),[t,s,e,l]}const[Jn,Qn,Yn,Zn]=Vn();function ul(t,e){const s=e?t?Zn:Yn:t?Qn:Jn;return(l,i,n)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?l:Reflect.get(L(s,i)&&i in l?s:l,i,n)}const Xn={get:ul(!1,!1)},tr={get:ul(!1,!0)},er={get:ul(!0,!1)};const Oi=new WeakMap,Ci=new WeakMap,Ri=new WeakMap,sr=new WeakMap;function lr(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function ir(t){return t.__v_skip||!Object.isExtensible(t)?0:lr(Tn(t))}function $e(t){return ke(t)?t:dl(t,!1,$n,Xn,Oi)}function nr(t){return dl(t,!1,Kn,tr,Ci)}function Wi(t){return dl(t,!0,Bn,er,Ri)}function dl(t,e,s,l,i){if(!B(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const n=i.get(t);if(n)return n;const r=ir(t);if(r===0)return t;const o=new Proxy(t,r===2?l:s);return i.set(t,o),o}function ce(t){return ke(t)?ce(t.__v_raw):!!(t&&t.__v_isReactive)}function ke(t){return!!(t&&t.__v_isReadonly)}function Tt(t){return!!(t&&t.__v_isShallow)}function ml(t){return t?!!t.__v_raw:!1}function H(t){const e=t&&t.__v_raw;return e?H(e):t}function rr(t){return!L(t,"__v_skip")&&Object.isExtensible(t)&&hi(t,"__v_skip",!0),t}const _t=t=>B(t)?$e(t):t,_l=t=>B(t)?Wi(t):t;function mt(t){return t?t.__v_isRef===!0:!1}function or(t){return mt(t)?t.value:t}const ar={get:(t,e,s)=>e==="__v_raw"?t:or(Reflect.get(t,e,s)),set:(t,e,s,l)=>{const i=t[e];return mt(i)&&!mt(s)?(i.value=s,!0):Reflect.set(t,e,s,l)}};function Ii(t){return ce(t)?t:new Proxy(t,ar)}class ur{constructor(e,s,l){this.fn=e,this.setter=s,this._value=void 0,this.dep=new Di(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Pe-1,this.effect=this,this.__v_isReadonly=!s,this.isSSR=l}notify(){this.flags|=16,M!==this&&this.dep.notify()}get value(){const e=this.dep.track();return yi(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function dr(t,e,s=!1){let l,i;return O(t)?l=t:(l=t.get,i=t.set),new ur(l,i,s)}const is={},_s=new WeakMap;let re;function mr(t,e=!1,s=re){if(s){let l=_s.get(s);l||_s.set(s,l=[]),l.push(t)}}function _r(t,e,s=U){const{immediate:l,deep:i,once:n,scheduler:r,augmentJob:o,call:a}=s,_=S=>i?S:Tt(S)||i===!1||i===0?Ht(S,1):Ht(S);let m,f,k,N,W=!1,j=!1;if(mt(t)?(f=()=>t.value,W=Tt(t)):ce(t)?(f=()=>_(t),W=!0):D(t)?(j=!0,W=t.some(S=>ce(S)||Tt(S)),f=()=>t.map(S=>{if(mt(S))return S.value;if(ce(S))return _(S);if(O(S))return a?a(S,2):S()})):O(t)?e?f=a?()=>a(t,2):t:f=()=>{if(k){Xt();try{k()}finally{te()}}const S=re;re=m;try{return a?a(t,3,[N]):t(N)}finally{re=S}}:f=It,e&&i){const S=f,X=i===!0?1/0:i;f=()=>Ht(S(),X)}const Z=Pn(),P=()=>{m.stop(),Z&&el(Z.effects,m)};if(n)if(e){const S=e;e=(...X)=>{S(...X),P()}}else{const S=f;f=()=>{S(),P()}}let V=j?new Array(t.length).fill(is):is;const J=S=>{if(!(!(m.flags&1)||!m.dirty&&!S))if(e){const X=m.run();if(i||W||(j?X.some((Bt,St)=>ue(Bt,V[St])):ue(X,V))){k&&k();const Bt=re;re=m;try{const St=[X,V===is?void 0:j&&V[0]===is?[]:V,N];a?a(e,3,St):e(...St),V=X}finally{re=Bt}}}else m.run()};return o&&o(J),m=new wi(f),m.scheduler=r?()=>r(J,!1):J,N=S=>mr(S,!1,m),k=m.onStop=()=>{const S=_s.get(m);if(S){if(a)a(S,4);else for(const X of S)X();_s.delete(m)}},e?l?J(!0):V=m.run():r?r(J.bind(null,!0),!0):m.run(),P.pause=m.pause.bind(m),P.resume=m.resume.bind(m),P.stop=P,P}function Ht(t,e=1/0,s){if(e<=0||!B(t)||t.__v_skip||(s=s||new Set,s.has(t)))return t;if(s.add(t),e--,mt(t))Ht(t.value,e,s);else if(D(t))for(let l=0;l<t.length;l++)Ht(t[l],e,s);else if(Ee(t)||he(t))t.forEach(l=>{Ht(l,e,s)});else if(xi(t)){for(const l in t)Ht(t[l],e,s);for(const l of Object.getOwnPropertySymbols(t))Object.prototype.propertyIsEnumerable.call(t,l)&&Ht(t[l],e,s)}return t}/**
* @vue/runtime-core v3.5.5
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Be(t,e,s,l){try{return l?t(...l):t()}catch(i){As(i,e,s)}}function zt(t,e,s,l){if(O(t)){const i=Be(t,e,s,l);return i&&gi(i)&&i.catch(n=>{As(n,e,s)}),i}if(D(t)){const i=[];for(let n=0;n<t.length;n++)i.push(zt(t[n],e,s,l));return i}}function As(t,e,s,l=!0){const i=e?e.vnode:null,{errorHandler:n,throwUnhandledErrorInProduction:r}=e&&e.appContext.config||U;if(e){let o=e.parent;const a=e.proxy,_=`https://vuejs.org/error-reference/#runtime-${s}`;for(;o;){const m=o.ec;if(m){for(let f=0;f<m.length;f++)if(m[f](t,a,_)===!1)return}o=o.parent}if(n){Xt(),Be(n,null,10,[t,a,_]),te();return}}gr(t,s,i,l,r)}function gr(t,e,s,l=!0,i=!1){if(i)throw t;console.error(t)}let Le=!1,qs=!1;const dt=[];let Ot=0;const pe=[];let Qt=null,fe=0;const Pi=Promise.resolve();let gl=null;function zi(t){const e=gl||Pi;return t?e.then(this?t.bind(this):t):e}function fr(t){let e=Le?Ot+1:0,s=dt.length;for(;e<s;){const l=e+s>>>1,i=dt[l],n=Fe(i);n<t||n===t&&i.flags&2?e=l+1:s=l}return e}function fl(t){if(!(t.flags&1)){const e=Fe(t),s=dt[dt.length-1];!s||!(t.flags&2)&&e>=Fe(s)?dt.push(t):dt.splice(fr(e),0,t),t.flags|=1,Li()}}function Li(){!Le&&!qs&&(qs=!0,gl=Pi.then(Hi))}function xr(t){D(t)?pe.push(...t):Qt&&t.id===-1?Qt.splice(fe+1,0,t):t.flags&1||(pe.push(t),t.flags|=1),Li()}function Rl(t,e,s=Le?Ot+1:0){for(;s<dt.length;s++){const l=dt[s];if(l&&l.flags&2){if(t&&l.id!==t.uid)continue;dt.splice(s,1),s--,l.flags&4&&(l.flags&=-2),l(),l.flags&=-2}}}function Fi(t){if(pe.length){const e=[...new Set(pe)].sort((s,l)=>Fe(s)-Fe(l));if(pe.length=0,Qt){Qt.push(...e);return}for(Qt=e,fe=0;fe<Qt.length;fe++){const s=Qt[fe];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}Qt=null,fe=0}}const Fe=t=>t.id==null?t.flags&2?-1:1/0:t.id;function Hi(t){qs=!1,Le=!0;try{for(Ot=0;Ot<dt.length;Ot++){const e=dt[Ot];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),Be(e,e.i,e.i?15:14),e.flags&=-2)}}finally{for(;Ot<dt.length;Ot++){const e=dt[Ot];e&&(e.flags&=-2)}Ot=0,dt.length=0,Fi(),Le=!1,gl=null,(dt.length||pe.length)&&Hi()}}let kt=null,Mi=null;function gs(t){const e=kt;return kt=t,Mi=t&&t.type.__scopeId||null,e}function hr(t,e=kt,s){if(!e||t._n)return t;const l=(...i)=>{l._d&&Ul(-1);const n=gs(e);let r;try{r=t(...i)}finally{gs(n),l._d&&Ul(1)}return r};return l._n=!0,l._c=!0,l._d=!0,l}function Wt(t,e){if(kt===null)return t;const s=Ds(kt),l=t.dirs||(t.dirs=[]);for(let i=0;i<e.length;i++){let[n,r,o,a=U]=e[i];n&&(O(n)&&(n={mounted:n,updated:n}),n.deep&&Ht(r),l.push({dir:n,instance:s,value:r,oldValue:void 0,arg:o,modifiers:a}))}return t}function ie(t,e,s,l){const i=t.dirs,n=e&&e.dirs;for(let r=0;r<i.length;r++){const o=i[r];n&&(o.oldValue=n[r].value);let a=o.dir[l];a&&(Xt(),zt(a,s,8,[t.el,o,t,e]),te())}}const cr=Symbol("_vte"),pr=t=>t.__isTeleport;function xl(t,e){t.shapeFlag&6&&t.component?(t.transition=e,xl(t.component.subTree,e)):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function Ui(t){t.ids=[t.ids[0]+t.ids[2]+++"-",0,0]}function $s(t,e,s,l,i=!1){if(D(t)){t.forEach((W,j)=>$s(W,e&&(D(e)?e[j]:e),s,l,i));return}if(Re(l)&&!i)return;const n=l.shapeFlag&4?Ds(l.component):l.el,r=i?null:n,{i:o,r:a}=t,_=e&&e.r,m=o.refs===U?o.refs={}:o.refs,f=o.setupState,k=H(f),N=f===U?()=>!1:W=>L(k,W);if(_!=null&&_!==a&&(Y(_)?(m[_]=null,N(_)&&(f[_]=null)):mt(_)&&(_.value=null)),O(a))Be(a,o,12,[r,m]);else{const W=Y(a),j=mt(a);if(W||j){const Z=()=>{if(t.f){const P=W?N(a)?f[a]:m[a]:a.value;i?D(P)&&el(P,n):D(P)?P.includes(n)||P.push(n):W?(m[a]=[n],N(a)&&(f[a]=m[a])):(a.value=[n],t.k&&(m[t.k]=a.value))}else W?(m[a]=r,N(a)&&(f[a]=r)):j&&(a.value=r,t.k&&(m[t.k]=r))};r?(Z.id=-1,ct(Z,s)):Z()}}}const Re=t=>!!t.type.__asyncLoader,qi=t=>t.type.__isKeepAlive;function br(t,e){$i(t,"a",e)}function kr(t,e){$i(t,"da",e)}function $i(t,e,s=it){const l=t.__wdc||(t.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(Es(e,l,s),s){let i=s.parent;for(;i&&i.parent;)qi(i.parent.vnode)&&wr(l,e,s,i),i=i.parent}}function wr(t,e,s,l){const i=Es(e,t,l,!0);Bi(()=>{el(l[e],i)},s)}function Es(t,e,s=it,l=!1){if(s){const i=s[t]||(s[t]=[]),n=e.__weh||(e.__weh=(...r)=>{Xt();const o=Ke(s),a=zt(e,s,t,r);return o(),te(),a});return l?i.unshift(n):i.push(n),n}}const $t=t=>(e,s=it)=>{(!Ts||t==="sp")&&Es(t,(...l)=>e(...l),s)},Ar=$t("bm"),Er=$t("m"),vr=$t("bu"),yr=$t("u"),Tr=$t("bum"),Bi=$t("um"),Dr=$t("sp"),Sr=$t("rtg"),Nr=$t("rtc");function Gr(t,e=it){Es("ec",t,e)}const Ki="components";function bt(t,e){return Or(Ki,t,!0,e)||t}const jr=Symbol.for("v-ndc");function Or(t,e,s=!0,l=!1){const i=kt||it;if(i){const n=i.type;if(t===Ki){const o=Ao(n,!1);if(o&&(o===e||o===Dt(e)||o===bs(Dt(e))))return n}const r=Wl(i[t]||n[t],e)||Wl(i.appContext[t],e);return!r&&l?n:r}}function Wl(t,e){return t&&(t[e]||t[Dt(e)]||t[bs(Dt(e))])}function ae(t,e,s,l){let i;const n=s,r=D(t);if(r||Y(t)){const o=r&&ce(t);let a=!1;o&&(a=!Tt(t),t=ks(t)),i=new Array(t.length);for(let _=0,m=t.length;_<m;_++)i[_]=e(a?_t(t[_]):t[_],_,void 0,n)}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,n)}else if(B(t))if(t[Symbol.iterator])i=Array.from(t,(o,a)=>e(o,a,void 0,n));else{const o=Object.keys(t);i=new Array(o.length);for(let a=0,_=o.length;a<_;a++){const m=o[a];i[a]=e(t[m],m,a,n)}}else i=[];return i}const Bs=t=>t?fn(t)?Ds(t):Bs(t.parent):null,We=rt(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Bs(t.parent),$root:t=>Bs(t.root),$host:t=>t.ce,$emit:t=>t.emit,$options:t=>hl(t),$forceUpdate:t=>t.f||(t.f=()=>{fl(t.update)}),$nextTick:t=>t.n||(t.n=zi.bind(t.proxy)),$watch:t=>to.bind(t)}),Ws=(t,e)=>t!==U&&!t.__isScriptSetup&&L(t,e),Cr={get({_:t},e){if(e==="__v_skip")return!0;const{ctx:s,setupState:l,data:i,props:n,accessCache:r,type:o,appContext:a}=t;let _;if(e[0]!=="$"){const N=r[e];if(N!==void 0)switch(N){case 1:return l[e];case 2:return i[e];case 4:return s[e];case 3:return n[e]}else{if(Ws(l,e))return r[e]=1,l[e];if(i!==U&&L(i,e))return r[e]=2,i[e];if((_=t.propsOptions[0])&&L(_,e))return r[e]=3,n[e];if(s!==U&&L(s,e))return r[e]=4,s[e];Ks&&(r[e]=0)}}const m=We[e];let f,k;if(m)return e==="$attrs"&&ot(t.attrs,"get",""),m(t);if((f=o.__cssModules)&&(f=f[e]))return f;if(s!==U&&L(s,e))return r[e]=4,s[e];if(k=a.config.globalProperties,L(k,e))return k[e]},set({_:t},e,s){const{data:l,setupState:i,ctx:n}=t;return Ws(i,e)?(i[e]=s,!0):l!==U&&L(l,e)?(l[e]=s,!0):L(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(n[e]=s,!0)},has({_:{data:t,setupState:e,accessCache:s,ctx:l,appContext:i,propsOptions:n}},r){let o;return!!s[r]||t!==U&&L(t,r)||Ws(e,r)||(o=n[0])&&L(o,r)||L(l,r)||L(We,r)||L(i.config.globalProperties,r)},defineProperty(t,e,s){return s.get!=null?t._.accessCache[e]=0:L(s,"value")&&this.set(t,e,s.value,null),Reflect.defineProperty(t,e,s)}};function Il(t){return D(t)?t.reduce((e,s)=>(e[s]=null,e),{}):t}let Ks=!0;function Rr(t){const e=hl(t),s=t.proxy,l=t.ctx;Ks=!1,e.beforeCreate&&Pl(e.beforeCreate,t,"bc");const{data:i,computed:n,methods:r,watch:o,provide:a,inject:_,created:m,beforeMount:f,mounted:k,beforeUpdate:N,updated:W,activated:j,deactivated:Z,beforeDestroy:P,beforeUnmount:V,destroyed:J,unmounted:S,render:X,renderTracked:Bt,renderTriggered:St,errorCaptured:Kt,serverPrefetch:Ve,expose:ee,inheritAttrs:ve,components:Je,directives:Qe,filters:Ss}=e;if(_&&Wr(_,l,null),r)for(const K in r){const q=r[K];O(q)&&(l[K]=q.bind(s))}if(i){const K=i.call(s,s);B(K)&&(t.data=$e(K))}if(Ks=!0,n)for(const K in n){const q=n[K],se=O(q)?q.bind(s,s):O(q.get)?q.get.bind(s,s):It,Ye=!O(q)&&O(q.set)?q.set.bind(s):It,le=vo({get:se,set:Ye});Object.defineProperty(l,K,{enumerable:!0,configurable:!0,get:()=>le.value,set:Nt=>le.value=Nt})}if(o)for(const K in o)Vi(o[K],l,s,K);if(a){const K=O(a)?a.call(s):a;Reflect.ownKeys(K).forEach(q=>{Hr(q,K[q])})}m&&Pl(m,t,"c");function at(K,q){D(q)?q.forEach(se=>K(se.bind(s))):q&&K(q.bind(s))}if(at(Ar,f),at(Er,k),at(vr,N),at(yr,W),at(br,j),at(kr,Z),at(Gr,Kt),at(Nr,Bt),at(Sr,St),at(Tr,V),at(Bi,S),at(Dr,Ve),D(ee))if(ee.length){const K=t.exposed||(t.exposed={});ee.forEach(q=>{Object.defineProperty(K,q,{get:()=>s[q],set:se=>s[q]=se})})}else t.exposed||(t.exposed={});X&&t.render===It&&(t.render=X),ve!=null&&(t.inheritAttrs=ve),Je&&(t.components=Je),Qe&&(t.directives=Qe),Ve&&Ui(t)}function Wr(t,e,s=It){D(t)&&(t=Vs(t));for(const l in t){const i=t[l];let n;B(i)?"default"in i?n=rs(i.from||l,i.default,!0):n=rs(i.from||l):n=rs(i),mt(n)?Object.defineProperty(e,l,{enumerable:!0,configurable:!0,get:()=>n.value,set:r=>n.value=r}):e[l]=n}}function Pl(t,e,s){zt(D(t)?t.map(l=>l.bind(e.proxy)):t.bind(e.proxy),e,s)}function Vi(t,e,s,l){let i=l.includes(".")?un(s,l):()=>s[l];if(Y(t)){const n=e[t];O(n)&&os(i,n)}else if(O(t))os(i,t.bind(s));else if(B(t))if(D(t))t.forEach(n=>Vi(n,e,s,l));else{const n=O(t.handler)?t.handler.bind(s):e[t.handler];O(n)&&os(i,n,t)}}function hl(t){const e=t.type,{mixins:s,extends:l}=e,{mixins:i,optionsCache:n,config:{optionMergeStrategies:r}}=t.appContext,o=n.get(e);let a;return o?a=o:!i.length&&!s&&!l?a=e:(a={},i.length&&i.forEach(_=>fs(a,_,r,!0)),fs(a,e,r)),B(e)&&n.set(e,a),a}function fs(t,e,s,l=!1){const{mixins:i,extends:n}=e;n&&fs(t,n,s,!0),i&&i.forEach(r=>fs(t,r,s,!0));for(const r in e)if(!(l&&r==="expose")){const o=Ir[r]||s&&s[r];t[r]=o?o(t[r],e[r]):e[r]}return t}const Ir={data:zl,props:Ll,emits:Ll,methods:Ge,computed:Ge,beforeCreate:ut,created:ut,beforeMount:ut,mounted:ut,beforeUpdate:ut,updated:ut,beforeDestroy:ut,beforeUnmount:ut,destroyed:ut,unmounted:ut,activated:ut,deactivated:ut,errorCaptured:ut,serverPrefetch:ut,components:Ge,directives:Ge,watch:zr,provide:zl,inject:Pr};function zl(t,e){return e?t?function(){return rt(O(t)?t.call(this,this):t,O(e)?e.call(this,this):e)}:e:t}function Pr(t,e){return Ge(Vs(t),Vs(e))}function Vs(t){if(D(t)){const e={};for(let s=0;s<t.length;s++)e[t[s]]=t[s];return e}return t}function ut(t,e){return t?[...new Set([].concat(t,e))]:e}function Ge(t,e){return t?rt(Object.create(null),t,e):e}function Ll(t,e){return t?D(t)&&D(e)?[...new Set([...t,...e])]:rt(Object.create(null),Il(t),Il(e??{})):e}function zr(t,e){if(!t)return e;if(!e)return t;const s=rt(Object.create(null),t);for(const l in e)s[l]=ut(t[l],e[l]);return s}function Ji(){return{app:null,config:{isNativeTag:vn,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Lr=0;function Fr(t,e){return function(l,i=null){O(l)||(l=rt({},l)),i!=null&&!B(i)&&(i=null);const n=Ji(),r=new WeakSet,o=[];let a=!1;const _=n.app={_uid:Lr++,_component:l,_props:i,_container:null,_context:n,_instance:null,version:yo,get config(){return n.config},set config(m){},use(m,...f){return r.has(m)||(m&&O(m.install)?(r.add(m),m.install(_,...f)):O(m)&&(r.add(m),m(_,...f))),_},mixin(m){return n.mixins.includes(m)||n.mixins.push(m),_},component(m,f){return f?(n.components[m]=f,_):n.components[m]},directive(m,f){return f?(n.directives[m]=f,_):n.directives[m]},mount(m,f,k){if(!a){const N=_._ceVNode||et(l,i);return N.appContext=n,k===!0?k="svg":k===!1&&(k=void 0),f&&e?e(N,m):t(N,m,k),a=!0,_._container=m,m.__vue_app__=_,Ds(N.component)}},onUnmount(m){o.push(m)},unmount(){a&&(zt(o,_._instance,16),t(null,_._container),delete _._container.__vue_app__)},provide(m,f){return n.provides[m]=f,_},runWithContext(m){const f=be;be=_;try{return m()}finally{be=f}}};return _}}let be=null;function Hr(t,e){if(it){let s=it.provides;const l=it.parent&&it.parent.provides;l===s&&(s=it.provides=Object.create(l)),s[t]=e}}function rs(t,e,s=!1){const l=it||kt;if(l||be){const i=be?be._context.provides:l?l.parent==null?l.vnode.appContext&&l.vnode.appContext.provides:l.parent.provides:void 0;if(i&&t in i)return i[t];if(arguments.length>1)return s&&O(e)?e.call(l&&l.proxy):e}}const Qi={},Yi=()=>Object.create(Qi),Zi=t=>Object.getPrototypeOf(t)===Qi;function Mr(t,e,s,l=!1){const i={},n=Yi();t.propsDefaults=Object.create(null),Xi(t,e,i,n);for(const r in t.propsOptions[0])r in i||(i[r]=void 0);s?t.props=l?i:nr(i):t.type.props?t.props=i:t.props=n,t.attrs=n}function Ur(t,e,s,l){const{props:i,attrs:n,vnode:{patchFlag:r}}=t,o=H(i),[a]=t.propsOptions;let _=!1;if((l||r>0)&&!(r&16)){if(r&8){const m=t.vnode.dynamicProps;for(let f=0;f<m.length;f++){let k=m[f];if(vs(t.emitsOptions,k))continue;const N=e[k];if(a)if(L(n,k))N!==n[k]&&(n[k]=N,_=!0);else{const W=Dt(k);i[W]=Js(a,o,W,N,t,!1)}else N!==n[k]&&(n[k]=N,_=!0)}}}else{Xi(t,e,i,n)&&(_=!0);let m;for(const f in o)(!e||!L(e,f)&&((m=_e(f))===f||!L(e,m)))&&(a?s&&(s[f]!==void 0||s[m]!==void 0)&&(i[f]=Js(a,o,f,void 0,t,!0)):delete i[f]);if(n!==o)for(const f in n)(!e||!L(e,f))&&(delete n[f],_=!0)}_&&Mt(t.attrs,"set","")}function Xi(t,e,s,l){const[i,n]=t.propsOptions;let r=!1,o;if(e)for(let a in e){if(Oe(a))continue;const _=e[a];let m;i&&L(i,m=Dt(a))?!n||!n.includes(m)?s[m]=_:(o||(o={}))[m]=_:vs(t.emitsOptions,a)||(!(a in l)||_!==l[a])&&(l[a]=_,r=!0)}if(n){const a=H(s),_=o||U;for(let m=0;m<n.length;m++){const f=n[m];s[f]=Js(i,a,f,_[f],t,!L(_,f))}}return r}function Js(t,e,s,l,i,n){const r=t[s];if(r!=null){const o=L(r,"default");if(o&&l===void 0){const a=r.default;if(r.type!==Function&&!r.skipFactory&&O(a)){const{propsDefaults:_}=i;if(s in _)l=_[s];else{const m=Ke(i);l=_[s]=a.call(null,e),m()}}else l=a;i.ce&&i.ce._setProp(s,l)}r[0]&&(n&&!o?l=!1:r[1]&&(l===""||l===_e(s))&&(l=!0))}return l}const qr=new WeakMap;function tn(t,e,s=!1){const l=s?qr:e.propsCache,i=l.get(t);if(i)return i;const n=t.props,r={},o=[];let a=!1;if(!O(t)){const m=f=>{a=!0;const[k,N]=tn(f,e,!0);rt(r,k),N&&o.push(...N)};!s&&e.mixins.length&&e.mixins.forEach(m),t.extends&&m(t.extends),t.mixins&&t.mixins.forEach(m)}if(!n&&!a)return B(t)&&l.set(t,xe),xe;if(D(n))for(let m=0;m<n.length;m++){const f=Dt(n[m]);Fl(f)&&(r[f]=U)}else if(n)for(const m in n){const f=Dt(m);if(Fl(f)){const k=n[m],N=r[f]=D(k)||O(k)?{type:k}:rt({},k),W=N.type;let j=!1,Z=!0;if(D(W))for(let P=0;P<W.length;++P){const V=W[P],J=O(V)&&V.name;if(J==="Boolean"){j=!0;break}else J==="String"&&(Z=!1)}else j=O(W)&&W.name==="Boolean";N[0]=j,N[1]=Z,(j||L(N,"default"))&&o.push(f)}}const _=[r,o];return B(t)&&l.set(t,_),_}function Fl(t){return t[0]!=="$"&&!Oe(t)}const en=t=>t[0]==="_"||t==="$stable",cl=t=>D(t)?t.map(Ct):[Ct(t)],$r=(t,e,s)=>{if(e._n)return e;const l=hr((...i)=>cl(e(...i)),s);return l._c=!1,l},sn=(t,e,s)=>{const l=t._ctx;for(const i in t){if(en(i))continue;const n=t[i];if(O(n))e[i]=$r(i,n,l);else if(n!=null){const r=cl(n);e[i]=()=>r}}},ln=(t,e)=>{const s=cl(e);t.slots.default=()=>s},nn=(t,e,s)=>{for(const l in e)(s||l!=="_")&&(t[l]=e[l])},Br=(t,e,s)=>{const l=t.slots=Yi();if(t.vnode.shapeFlag&32){const i=e._;i?(nn(l,e,s),s&&hi(l,"_",i,!0)):sn(e,l)}else e&&ln(t,e)},Kr=(t,e,s)=>{const{vnode:l,slots:i}=t;let n=!0,r=U;if(l.shapeFlag&32){const o=e._;o?s&&o===1?n=!1:nn(i,e,s):(n=!e.$stable,sn(e,i)),r=e}else e&&(ln(t,e),r={default:1});if(n)for(const o in i)!en(o)&&r[o]==null&&delete i[o]},ct=oo;function Vr(t){return Jr(t)}function Jr(t,e){const s=ci();s.__VUE__=!0;const{insert:l,remove:i,patchProp:n,createElement:r,createText:o,createComment:a,setText:_,setElementText:m,parentNode:f,nextSibling:k,setScopeId:N=It,insertStaticContent:W}=t,j=(u,d,g,p=null,x=null,h=null,E=void 0,A=null,w=!!d.dynamicChildren)=>{if(u===d)return;u&&!Ne(u,d)&&(p=Ze(u),Nt(u,x,h,!0),u=null),d.patchFlag===-2&&(w=!1,d.dynamicChildren=null);const{type:b,ref:T,shapeFlag:v}=d;switch(b){case ys:Z(u,d,g,p);break;case de:P(u,d,g,p);break;case as:u==null&&V(d,g,p,E);break;case Q:Je(u,d,g,p,x,h,E,A,w);break;default:v&1?X(u,d,g,p,x,h,E,A,w):v&6?Qe(u,d,g,p,x,h,E,A,w):(v&64||v&128)&&b.process(u,d,g,p,x,h,E,A,w,Te)}T!=null&&x&&$s(T,u&&u.ref,h,d||u,!d)},Z=(u,d,g,p)=>{if(u==null)l(d.el=o(d.children),g,p);else{const x=d.el=u.el;d.children!==u.children&&_(x,d.children)}},P=(u,d,g,p)=>{u==null?l(d.el=a(d.children||""),g,p):d.el=u.el},V=(u,d,g,p)=>{[u.el,u.anchor]=W(u.children,d,g,p,u.el,u.anchor)},J=({el:u,anchor:d},g,p)=>{let x;for(;u&&u!==d;)x=k(u),l(u,g,p),u=x;l(d,g,p)},S=({el:u,anchor:d})=>{let g;for(;u&&u!==d;)g=k(u),i(u),u=g;i(d)},X=(u,d,g,p,x,h,E,A,w)=>{d.type==="svg"?E="svg":d.type==="math"&&(E="mathml"),u==null?Bt(d,g,p,x,h,E,A,w):Ve(u,d,x,h,E,A,w)},Bt=(u,d,g,p,x,h,E,A)=>{let w,b;const{props:T,shapeFlag:v,transition:y,dirs:G}=u;if(w=u.el=r(u.type,h,T&&T.is,T),v&8?m(w,u.children):v&16&&Kt(u.children,w,null,p,x,Is(u,h),E,A),G&&ie(u,null,p,"created"),St(w,u,u.scopeId,E,p),T){for(const $ in T)$!=="value"&&!Oe($)&&n(w,$,null,T[$],h,p);"value"in T&&n(w,"value",null,T.value,h),(b=T.onVnodeBeforeMount)&&jt(b,p,u)}G&&ie(u,null,p,"beforeMount");const I=Qr(x,y);I&&y.beforeEnter(w),l(w,d,g),((b=T&&T.onVnodeMounted)||I||G)&&ct(()=>{b&&jt(b,p,u),I&&y.enter(w),G&&ie(u,null,p,"mounted")},x)},St=(u,d,g,p,x)=>{if(g&&N(u,g),p)for(let h=0;h<p.length;h++)N(u,p[h]);if(x){let h=x.subTree;if(d===h||mn(h.type)&&(h.ssContent===d||h.ssFallback===d)){const E=x.vnode;St(u,E,E.scopeId,E.slotScopeIds,x.parent)}}},Kt=(u,d,g,p,x,h,E,A,w=0)=>{for(let b=w;b<u.length;b++){const T=u[b]=A?Yt(u[b]):Ct(u[b]);j(null,T,d,g,p,x,h,E,A)}},Ve=(u,d,g,p,x,h,E)=>{const A=d.el=u.el;let{patchFlag:w,dynamicChildren:b,dirs:T}=d;w|=u.patchFlag&16;const v=u.props||U,y=d.props||U;let G;if(g&&ne(g,!1),(G=y.onVnodeBeforeUpdate)&&jt(G,g,d,u),T&&ie(d,u,g,"beforeUpdate"),g&&ne(g,!0),(v.innerHTML&&y.innerHTML==null||v.textContent&&y.textContent==null)&&m(A,""),b?ee(u.dynamicChildren,b,A,g,p,Is(d,x),h):E||q(u,d,A,null,g,p,Is(d,x),h,!1),w>0){if(w&16)ve(A,v,y,g,x);else if(w&2&&v.class!==y.class&&n(A,"class",null,y.class,x),w&4&&n(A,"style",v.style,y.style,x),w&8){const I=d.dynamicProps;for(let $=0;$<I.length;$++){const F=I[$],ft=v[F],lt=y[F];(lt!==ft||F==="value")&&n(A,F,ft,lt,x,g)}}w&1&&u.children!==d.children&&m(A,d.children)}else!E&&b==null&&ve(A,v,y,g,x);((G=y.onVnodeUpdated)||T)&&ct(()=>{G&&jt(G,g,d,u),T&&ie(d,u,g,"updated")},p)},ee=(u,d,g,p,x,h,E)=>{for(let A=0;A<d.length;A++){const w=u[A],b=d[A],T=w.el&&(w.type===Q||!Ne(w,b)||w.shapeFlag&70)?f(w.el):g;j(w,b,T,null,p,x,h,E,!0)}},ve=(u,d,g,p,x)=>{if(d!==g){if(d!==U)for(const h in d)!Oe(h)&&!(h in g)&&n(u,h,d[h],null,x,p);for(const h in g){if(Oe(h))continue;const E=g[h],A=d[h];E!==A&&h!=="value"&&n(u,h,A,E,x,p)}"value"in g&&n(u,"value",d.value,g.value,x)}},Je=(u,d,g,p,x,h,E,A,w)=>{const b=d.el=u?u.el:o(""),T=d.anchor=u?u.anchor:o("");let{patchFlag:v,dynamicChildren:y,slotScopeIds:G}=d;G&&(A=A?A.concat(G):G),u==null?(l(b,g,p),l(T,g,p),Kt(d.children||[],g,T,x,h,E,A,w)):v>0&&v&64&&y&&u.dynamicChildren?(ee(u.dynamicChildren,y,g,x,h,E,A),(d.key!=null||x&&d===x.subTree)&&rn(u,d,!0)):q(u,d,g,T,x,h,E,A,w)},Qe=(u,d,g,p,x,h,E,A,w)=>{d.slotScopeIds=A,u==null?d.shapeFlag&512?x.ctx.activate(d,g,p,E,w):Ss(d,g,p,x,h,E,w):bl(u,d,w)},Ss=(u,d,g,p,x,h,E)=>{const A=u.component=co(u,p,x);if(qi(u)&&(A.ctx.renderer=Te),po(A,!1,E),A.asyncDep){if(x&&x.registerDep(A,at,E),!u.el){const w=A.subTree=et(de);P(null,w,d,g)}}else at(A,u,d,g,x,h,E)},bl=(u,d,g)=>{const p=d.component=u.component;if(no(u,d,g))if(p.asyncDep&&!p.asyncResolved){K(p,d,g);return}else p.next=d,p.update();else d.el=u.el,p.vnode=d},at=(u,d,g,p,x,h,E)=>{const A=()=>{if(u.isMounted){let{next:v,bu:y,u:G,parent:I,vnode:$}=u;{const xt=on(u);if(xt){v&&(v.el=$.el,K(u,v,E)),xt.asyncDep.then(()=>{u.isUnmounted||A()});return}}let F=v,ft;ne(u,!1),v?(v.el=$.el,K(u,v,E)):v=$,y&&ns(y),(ft=v.props&&v.props.onVnodeBeforeUpdate)&&jt(ft,I,v,$),ne(u,!0);const lt=Ps(u),Et=u.subTree;u.subTree=lt,j(Et,lt,f(Et.el),Ze(Et),u,x,h),v.el=lt.el,F===null&&ro(u,lt.el),G&&ct(G,x),(ft=v.props&&v.props.onVnodeUpdated)&&ct(()=>jt(ft,I,v,$),x)}else{let v;const{el:y,props:G}=d,{bm:I,m:$,parent:F,root:ft,type:lt}=u,Et=Re(d);if(ne(u,!1),I&&ns(I),!Et&&(v=G&&G.onVnodeBeforeMount)&&jt(v,F,d),ne(u,!0),y&&El){const xt=()=>{u.subTree=Ps(u),El(y,u.subTree,u,x,null)};Et&&lt.__asyncHydrate?lt.__asyncHydrate(y,u,xt):xt()}else{ft.ce&&ft.ce._injectChildStyle(lt);const xt=u.subTree=Ps(u);j(null,xt,g,p,u,x,h),d.el=xt.el}if($&&ct($,x),!Et&&(v=G&&G.onVnodeMounted)){const xt=d;ct(()=>jt(v,F,xt),x)}(d.shapeFlag&256||F&&Re(F.vnode)&&F.vnode.shapeFlag&256)&&u.a&&ct(u.a,x),u.isMounted=!0,d=g=p=null}};u.scope.on();const w=u.effect=new wi(A);u.scope.off();const b=u.update=w.run.bind(w),T=u.job=w.runIfDirty.bind(w);T.i=u,T.id=u.uid,w.scheduler=()=>fl(T),ne(u,!0),b()},K=(u,d,g)=>{d.component=u;const p=u.vnode.props;u.vnode=d,u.next=null,Ur(u,d.props,p,g),Kr(u,d.children,g),Xt(),Rl(u),te()},q=(u,d,g,p,x,h,E,A,w=!1)=>{const b=u&&u.children,T=u?u.shapeFlag:0,v=d.children,{patchFlag:y,shapeFlag:G}=d;if(y>0){if(y&128){Ye(b,v,g,p,x,h,E,A,w);return}else if(y&256){se(b,v,g,p,x,h,E,A,w);return}}G&8?(T&16&&ye(b,x,h),v!==b&&m(g,v)):T&16?G&16?Ye(b,v,g,p,x,h,E,A,w):ye(b,x,h,!0):(T&8&&m(g,""),G&16&&Kt(v,g,p,x,h,E,A,w))},se=(u,d,g,p,x,h,E,A,w)=>{u=u||xe,d=d||xe;const b=u.length,T=d.length,v=Math.min(b,T);let y;for(y=0;y<v;y++){const G=d[y]=w?Yt(d[y]):Ct(d[y]);j(u[y],G,g,null,x,h,E,A,w)}b>T?ye(u,x,h,!0,!1,v):Kt(d,g,p,x,h,E,A,w,v)},Ye=(u,d,g,p,x,h,E,A,w)=>{let b=0;const T=d.length;let v=u.length-1,y=T-1;for(;b<=v&&b<=y;){const G=u[b],I=d[b]=w?Yt(d[b]):Ct(d[b]);if(Ne(G,I))j(G,I,g,null,x,h,E,A,w);else break;b++}for(;b<=v&&b<=y;){const G=u[v],I=d[y]=w?Yt(d[y]):Ct(d[y]);if(Ne(G,I))j(G,I,g,null,x,h,E,A,w);else break;v--,y--}if(b>v){if(b<=y){const G=y+1,I=G<T?d[G].el:p;for(;b<=y;)j(null,d[b]=w?Yt(d[b]):Ct(d[b]),g,I,x,h,E,A,w),b++}}else if(b>y)for(;b<=v;)Nt(u[b],x,h,!0),b++;else{const G=b,I=b,$=new Map;for(b=I;b<=y;b++){const ht=d[b]=w?Yt(d[b]):Ct(d[b]);ht.key!=null&&$.set(ht.key,b)}let F,ft=0;const lt=y-I+1;let Et=!1,xt=0;const De=new Array(lt);for(b=0;b<lt;b++)De[b]=0;for(b=G;b<=v;b++){const ht=u[b];if(ft>=lt){Nt(ht,x,h,!0);continue}let Gt;if(ht.key!=null)Gt=$.get(ht.key);else for(F=I;F<=y;F++)if(De[F-I]===0&&Ne(ht,d[F])){Gt=F;break}Gt===void 0?Nt(ht,x,h,!0):(De[Gt-I]=b+1,Gt>=xt?xt=Gt:Et=!0,j(ht,d[Gt],g,null,x,h,E,A,w),ft++)}const vl=Et?Yr(De):xe;for(F=vl.length-1,b=lt-1;b>=0;b--){const ht=I+b,Gt=d[ht],yl=ht+1<T?d[ht+1].el:p;De[b]===0?j(null,Gt,g,yl,x,h,E,A,w):Et&&(F<0||b!==vl[F]?le(Gt,g,yl,2):F--)}}},le=(u,d,g,p,x=null)=>{const{el:h,type:E,transition:A,children:w,shapeFlag:b}=u;if(b&6){le(u.component.subTree,d,g,p);return}if(b&128){u.suspense.move(d,g,p);return}if(b&64){E.move(u,d,g,Te);return}if(E===Q){l(h,d,g);for(let v=0;v<w.length;v++)le(w[v],d,g,p);l(u.anchor,d,g);return}if(E===as){J(u,d,g);return}if(p!==2&&b&1&&A)if(p===0)A.beforeEnter(h),l(h,d,g),ct(()=>A.enter(h),x);else{const{leave:v,delayLeave:y,afterLeave:G}=A,I=()=>l(h,d,g),$=()=>{v(h,()=>{I(),G&&G()})};y?y(h,I,$):$()}else l(h,d,g)},Nt=(u,d,g,p=!1,x=!1)=>{const{type:h,props:E,ref:A,children:w,dynamicChildren:b,shapeFlag:T,patchFlag:v,dirs:y,cacheIndex:G}=u;if(v===-2&&(x=!1),A!=null&&$s(A,null,g,u,!0),G!=null&&(d.renderCache[G]=void 0),T&256){d.ctx.deactivate(u);return}const I=T&1&&y,$=!Re(u);let F;if($&&(F=E&&E.onVnodeBeforeUnmount)&&jt(F,d,u),T&6)En(u.component,g,p);else{if(T&128){u.suspense.unmount(g,p);return}I&&ie(u,null,d,"beforeUnmount"),T&64?u.type.remove(u,d,g,Te,p):b&&!b.hasOnce&&(h!==Q||v>0&&v&64)?ye(b,d,g,!1,!0):(h===Q&&v&384||!x&&T&16)&&ye(w,d,g),p&&kl(u)}($&&(F=E&&E.onVnodeUnmounted)||I)&&ct(()=>{F&&jt(F,d,u),I&&ie(u,null,d,"unmounted")},g)},kl=u=>{const{type:d,el:g,anchor:p,transition:x}=u;if(d===Q){An(g,p);return}if(d===as){S(u);return}const h=()=>{i(g),x&&!x.persisted&&x.afterLeave&&x.afterLeave()};if(u.shapeFlag&1&&x&&!x.persisted){const{leave:E,delayLeave:A}=x,w=()=>E(g,h);A?A(u.el,h,w):w()}else h()},An=(u,d)=>{let g;for(;u!==d;)g=k(u),i(u),u=g;i(d)},En=(u,d,g)=>{const{bum:p,scope:x,job:h,subTree:E,um:A,m:w,a:b}=u;Hl(w),Hl(b),p&&ns(p),x.stop(),h&&(h.flags|=8,Nt(E,u,d,g)),A&&ct(A,d),ct(()=>{u.isUnmounted=!0},d),d&&d.pendingBranch&&!d.isUnmounted&&u.asyncDep&&!u.asyncResolved&&u.suspenseId===d.pendingId&&(d.deps--,d.deps===0&&d.resolve())},ye=(u,d,g,p=!1,x=!1,h=0)=>{for(let E=h;E<u.length;E++)Nt(u[E],d,g,p,x)},Ze=u=>{if(u.shapeFlag&6)return Ze(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const d=k(u.anchor||u.el),g=d&&d[cr];return g?k(g):d};let Ns=!1;const wl=(u,d,g)=>{u==null?d._vnode&&Nt(d._vnode,null,null,!0):j(d._vnode||null,u,d,null,null,null,g),d._vnode=u,Ns||(Ns=!0,Rl(),Fi(),Ns=!1)},Te={p:j,um:Nt,m:le,r:kl,mt:Ss,mc:Kt,pc:q,pbc:ee,n:Ze,o:t};let Al,El;return{render:wl,hydrate:Al,createApp:Fr(wl,Al)}}function Is({type:t,props:e},s){return s==="svg"&&t==="foreignObject"||s==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:s}function ne({effect:t,job:e},s){s?(t.flags|=32,e.flags|=4):(t.flags&=-33,e.flags&=-5)}function Qr(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function rn(t,e,s=!1){const l=t.children,i=e.children;if(D(l)&&D(i))for(let n=0;n<l.length;n++){const r=l[n];let o=i[n];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=i[n]=Yt(i[n]),o.el=r.el),!s&&o.patchFlag!==-2&&rn(r,o)),o.type===ys&&(o.el=r.el)}}function Yr(t){const e=t.slice(),s=[0];let l,i,n,r,o;const a=t.length;for(l=0;l<a;l++){const _=t[l];if(_!==0){if(i=s[s.length-1],t[i]<_){e[l]=i,s.push(l);continue}for(n=0,r=s.length-1;n<r;)o=n+r>>1,t[s[o]]<_?n=o+1:r=o;_<t[s[n]]&&(n>0&&(e[l]=s[n-1]),s[n]=l)}}for(n=s.length,r=s[n-1];n-- >0;)s[n]=r,r=e[r];return s}function on(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:on(e)}function Hl(t){if(t)for(let e=0;e<t.length;e++)t[e].flags|=8}const Zr=Symbol.for("v-scx"),Xr=()=>rs(Zr);function os(t,e,s){return an(t,e,s)}function an(t,e,s=U){const{immediate:l,deep:i,flush:n,once:r}=s,o=rt({},s);let a;if(Ts)if(n==="sync"){const k=Xr();a=k.__watcherHandles||(k.__watcherHandles=[])}else if(!e||l)o.once=!0;else return{stop:It,resume:It,pause:It};const _=it;o.call=(k,N,W)=>zt(k,_,N,W);let m=!1;n==="post"?o.scheduler=k=>{ct(k,_&&_.suspense)}:n!=="sync"&&(m=!0,o.scheduler=(k,N)=>{N?k():fl(k)}),o.augmentJob=k=>{e&&(k.flags|=4),m&&(k.flags|=2,_&&(k.id=_.uid,k.i=_))};const f=_r(t,e,o);return a&&a.push(f),f}function to(t,e,s){const l=this.proxy,i=Y(t)?t.includes(".")?un(l,t):()=>l[t]:t.bind(l,l);let n;O(e)?n=e:(n=e.handler,s=e);const r=Ke(this),o=an(i,n.bind(l),s);return r(),o}function un(t,e){const s=e.split(".");return()=>{let l=t;for(let i=0;i<s.length&&l;i++)l=l[s[i]];return l}}const eo=(t,e)=>e==="modelValue"||e==="model-value"?t.modelModifiers:t[`${e}Modifiers`]||t[`${Dt(e)}Modifiers`]||t[`${_e(e)}Modifiers`];function so(t,e,...s){if(t.isUnmounted)return;const l=t.vnode.props||U;let i=s;const n=e.startsWith("update:"),r=n&&eo(l,e.slice(7));r&&(r.trim&&(i=s.map(m=>Y(m)?m.trim():m)),r.number&&(i=s.map(ms)));let o,a=l[o=Gs(e)]||l[o=Gs(Dt(e))];!a&&n&&(a=l[o=Gs(_e(e))]),a&&zt(a,t,6,i);const _=l[o+"Once"];if(_){if(!t.emitted)t.emitted={};else if(t.emitted[o])return;t.emitted[o]=!0,zt(_,t,6,i)}}function dn(t,e,s=!1){const l=e.emitsCache,i=l.get(t);if(i!==void 0)return i;const n=t.emits;let r={},o=!1;if(!O(t)){const a=_=>{const m=dn(_,e,!0);m&&(o=!0,rt(r,m))};!s&&e.mixins.length&&e.mixins.forEach(a),t.extends&&a(t.extends),t.mixins&&t.mixins.forEach(a)}return!n&&!o?(B(t)&&l.set(t,null),null):(D(n)?n.forEach(a=>r[a]=null):rt(r,n),B(t)&&l.set(t,r),r)}function vs(t,e){return!t||!cs(e)?!1:(e=e.slice(2).replace(/Once$/,""),L(t,e[0].toLowerCase()+e.slice(1))||L(t,_e(e))||L(t,e))}function Ps(t){const{type:e,vnode:s,proxy:l,withProxy:i,propsOptions:[n],slots:r,attrs:o,emit:a,render:_,renderCache:m,props:f,data:k,setupState:N,ctx:W,inheritAttrs:j}=t,Z=gs(t);let P,V;try{if(s.shapeFlag&4){const S=i||l,X=S;P=Ct(_.call(X,S,m,f,N,k,W)),V=o}else{const S=e;P=Ct(S.length>1?S(f,{attrs:o,slots:r,emit:a}):S(f,null)),V=e.props?o:lo(o)}}catch(S){Ie.length=0,As(S,t,1),P=et(de)}let J=P;if(V&&j!==!1){const S=Object.keys(V),{shapeFlag:X}=J;S.length&&X&7&&(n&&S.some(tl)&&(V=io(V,n)),J=we(J,V,!1,!0))}return s.dirs&&(J=we(J,null,!1,!0),J.dirs=J.dirs?J.dirs.concat(s.dirs):s.dirs),s.transition&&xl(J,s.transition),P=J,gs(Z),P}const lo=t=>{let e;for(const s in t)(s==="class"||s==="style"||cs(s))&&((e||(e={}))[s]=t[s]);return e},io=(t,e)=>{const s={};for(const l in t)(!tl(l)||!(l.slice(9)in e))&&(s[l]=t[l]);return s};function no(t,e,s){const{props:l,children:i,component:n}=t,{props:r,children:o,patchFlag:a}=e,_=n.emitsOptions;if(e.dirs||e.transition)return!0;if(s&&a>=0){if(a&1024)return!0;if(a&16)return l?Ml(l,r,_):!!r;if(a&8){const m=e.dynamicProps;for(let f=0;f<m.length;f++){const k=m[f];if(r[k]!==l[k]&&!vs(_,k))return!0}}}else return(i||o)&&(!o||!o.$stable)?!0:l===r?!1:l?r?Ml(l,r,_):!0:!!r;return!1}function Ml(t,e,s){const l=Object.keys(e);if(l.length!==Object.keys(t).length)return!0;for(let i=0;i<l.length;i++){const n=l[i];if(e[n]!==t[n]&&!vs(s,n))return!0}return!1}function ro({vnode:t,parent:e},s){for(;e;){const l=e.subTree;if(l.suspense&&l.suspense.activeBranch===t&&(l.el=t.el),l===t)(t=e.vnode).el=s,e=e.parent;else break}}const mn=t=>t.__isSuspense;function oo(t,e){e&&e.pendingBranch?D(t)?e.effects.push(...t):e.effects.push(t):xr(t)}const Q=Symbol.for("v-fgt"),ys=Symbol.for("v-txt"),de=Symbol.for("v-cmt"),as=Symbol.for("v-stc"),Ie=[];let wt=null;function R(t=!1){Ie.push(wt=t?null:[])}function ao(){Ie.pop(),wt=Ie[Ie.length-1]||null}let He=1;function Ul(t){He+=t,t<0&&wt&&(wt.hasOnce=!0)}function _n(t){return t.dynamicChildren=He>0?wt||xe:null,ao(),He>0&&wt&&wt.push(t),t}function z(t,e,s,l,i,n){return _n(c(t,e,s,l,i,n,!0))}function me(t,e,s,l,i){return _n(et(t,e,s,l,i,!0))}function uo(t){return t?t.__v_isVNode===!0:!1}function Ne(t,e){return t.type===e.type&&t.key===e.key}const gn=({key:t})=>t??null,us=({ref:t,ref_key:e,ref_for:s})=>(typeof t=="number"&&(t=""+t),t!=null?Y(t)||mt(t)||O(t)?{i:kt,r:t,k:e,f:!!s}:t:null);function c(t,e=null,s=null,l=0,i=null,n=t===Q?0:1,r=!1,o=!1){const a={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&gn(e),ref:e&&us(e),scopeId:Mi,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:n,patchFlag:l,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:kt};return o?(pl(a,s),n&128&&t.normalize(a)):s&&(a.shapeFlag|=Y(s)?8:16),He>0&&!r&&wt&&(a.patchFlag>0||n&6)&&a.patchFlag!==32&&wt.push(a),a}const et=mo;function mo(t,e=null,s=null,l=0,i=null,n=!1){if((!t||t===jr)&&(t=de),uo(t)){const o=we(t,e,!0);return s&&pl(o,s),He>0&&!n&&wt&&(o.shapeFlag&6?wt[wt.indexOf(t)]=o:wt.push(o)),o.patchFlag=-2,o}if(Eo(t)&&(t=t.__vccOpts),e){e=_o(e);let{class:o,style:a}=e;o&&!Y(o)&&(e.class=Rt(o)),B(a)&&(ml(a)&&!D(a)&&(a=rt({},a)),e.style=ll(a))}const r=Y(t)?1:mn(t)?128:pr(t)?64:B(t)?4:O(t)?2:0;return c(t,e,s,l,i,r,n,!0)}function _o(t){return t?ml(t)||Zi(t)?rt({},t):t:null}function we(t,e,s=!1,l=!1){const{props:i,ref:n,patchFlag:r,children:o,transition:a}=t,_=e?fo(i||{},e):i,m={__v_isVNode:!0,__v_skip:!0,type:t.type,props:_,key:_&&gn(_),ref:e&&e.ref?s&&n?D(n)?n.concat(us(e)):[n,us(e)]:us(e):n,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetStart:t.targetStart,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Q?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:a,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&we(t.ssContent),ssFallback:t.ssFallback&&we(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce};return a&&l&&xl(m,a.clone(m)),m}function xs(t=" ",e=0){return et(ys,null,t,e)}function go(t,e){const s=et(as,null,t);return s.staticCount=e,s}function Ut(t="",e=!1){return e?(R(),me(de,null,t)):et(de,null,t)}function Ct(t){return t==null||typeof t=="boolean"?et(de):D(t)?et(Q,null,t.slice()):typeof t=="object"?Yt(t):et(ys,null,String(t))}function Yt(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:we(t)}function pl(t,e){let s=0;const{shapeFlag:l}=t;if(e==null)e=null;else if(D(e))s=16;else if(typeof e=="object")if(l&65){const i=e.default;i&&(i._c&&(i._d=!1),pl(t,i()),i._c&&(i._d=!0));return}else{s=32;const i=e._;!i&&!Zi(e)?e._ctx=kt:i===3&&kt&&(kt.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else O(e)?(e={default:e,_ctx:kt},s=32):(e=String(e),l&64?(s=16,e=[xs(e)]):s=8);t.children=e,t.shapeFlag|=s}function fo(...t){const e={};for(let s=0;s<t.length;s++){const l=t[s];for(const i in l)if(i==="class")e.class!==l.class&&(e.class=Rt([e.class,l.class]));else if(i==="style")e.style=ll([e.style,l.style]);else if(cs(i)){const n=e[i],r=l[i];r&&n!==r&&!(D(n)&&n.includes(r))&&(e[i]=n?[].concat(n,r):r)}else i!==""&&(e[i]=l[i])}return e}function jt(t,e,s,l=null){zt(t,e,7,[s,l])}const xo=Ji();let ho=0;function co(t,e,s){const l=t.type,i=(e?e.appContext:t.appContext)||xo,n={uid:ho++,vnode:t,type:l,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new In(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:tn(l,i),emitsOptions:dn(l,i),emit:null,emitted:null,propsDefaults:U,inheritAttrs:l.inheritAttrs,ctx:U,data:U,props:U,attrs:U,slots:U,refs:U,setupState:U,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return n.ctx={_:n},n.root=e?e.root:n,n.emit=so.bind(null,n),t.ce&&t.ce(n),n}let it=null,hs,Qs;{const t=ci(),e=(s,l)=>{let i;return(i=t[s])||(i=t[s]=[]),i.push(l),n=>{i.length>1?i.forEach(r=>r(n)):i[0](n)}};hs=e("__VUE_INSTANCE_SETTERS__",s=>it=s),Qs=e("__VUE_SSR_SETTERS__",s=>Ts=s)}const Ke=t=>{const e=it;return hs(t),t.scope.on(),()=>{t.scope.off(),hs(e)}},ql=()=>{it&&it.scope.off(),hs(null)};function fn(t){return t.vnode.shapeFlag&4}let Ts=!1;function po(t,e=!1,s=!1){e&&Qs(e);const{props:l,children:i}=t.vnode,n=fn(t);Mr(t,l,n,e),Br(t,i,s);const r=n?bo(t,e):void 0;return e&&Qs(!1),r}function bo(t,e){const s=t.type;t.accessCache=Object.create(null),t.proxy=new Proxy(t.ctx,Cr);const{setup:l}=s;if(l){const i=t.setupContext=l.length>1?wo(t):null,n=Ke(t);Xt();const r=Be(l,t,0,[t.props,i]);if(te(),n(),gi(r)){if(Re(t)||Ui(t),r.then(ql,ql),e)return r.then(o=>{$l(t,o,e)}).catch(o=>{As(o,t,0)});t.asyncDep=r}else $l(t,r,e)}else xn(t,e)}function $l(t,e,s){O(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:B(e)&&(t.setupState=Ii(e)),xn(t,s)}let Bl;function xn(t,e,s){const l=t.type;if(!t.render){if(!e&&Bl&&!l.render){const i=l.template||hl(t).template;if(i){const{isCustomElement:n,compilerOptions:r}=t.appContext.config,{delimiters:o,compilerOptions:a}=l,_=rt(rt({isCustomElement:n,delimiters:o},r),a);l.render=Bl(i,_)}}t.render=l.render||It}{const i=Ke(t);Xt();try{Rr(t)}finally{te(),i()}}}const ko={get(t,e){return ot(t,"get",""),t[e]}};function wo(t){const e=s=>{t.exposed=s||{}};return{attrs:new Proxy(t.attrs,ko),slots:t.slots,emit:t.emit,expose:e}}function Ds(t){return t.exposed?t.exposeProxy||(t.exposeProxy=new Proxy(Ii(rr(t.exposed)),{get(e,s){if(s in e)return e[s];if(s in We)return We[s](t)},has(e,s){return s in e||s in We}})):t.proxy}function Ao(t,e=!0){return O(t)?t.displayName||t.name:t.name||e&&t.__name}function Eo(t){return O(t)&&"__vccOpts"in t}const vo=(t,e)=>dr(t,e,Ts),yo="3.5.5";/**
* @vue/runtime-dom v3.5.5
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ys;const Kl=typeof window<"u"&&window.trustedTypes;if(Kl)try{Ys=Kl.createPolicy("vue",{createHTML:t=>t})}catch{}const hn=Ys?t=>Ys.createHTML(t):t=>t,To="http://www.w3.org/2000/svg",Do="http://www.w3.org/1998/Math/MathML",Ft=typeof document<"u"?document:null,Vl=Ft&&Ft.createElement("template"),So={insert:(t,e,s)=>{e.insertBefore(t,s||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,s,l)=>{const i=e==="svg"?Ft.createElementNS(To,t):e==="mathml"?Ft.createElementNS(Do,t):s?Ft.createElement(t,{is:s}):Ft.createElement(t);return t==="select"&&l&&l.multiple!=null&&i.setAttribute("multiple",l.multiple),i},createText:t=>Ft.createTextNode(t),createComment:t=>Ft.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Ft.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,s,l,i,n){const r=s?s.previousSibling:e.lastChild;if(i&&(i===n||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),s),!(i===n||!(i=i.nextSibling)););else{Vl.innerHTML=hn(l==="svg"?`<svg>${t}</svg>`:l==="mathml"?`<math>${t}</math>`:t);const o=Vl.content;if(l==="svg"||l==="mathml"){const a=o.firstChild;for(;a.firstChild;)o.appendChild(a.firstChild);o.removeChild(a)}e.insertBefore(o,s)}return[r?r.nextSibling:e.firstChild,s?s.previousSibling:e.lastChild]}},No=Symbol("_vtc");function Go(t,e,s){const l=t[No];l&&(e=(e?[e,...l]:[...l]).join(" ")),e==null?t.removeAttribute("class"):s?t.setAttribute("class",e):t.className=e}const Jl=Symbol("_vod"),jo=Symbol("_vsh"),Oo=Symbol(""),Co=/(^|;)\s*display\s*:/;function Ro(t,e,s){const l=t.style,i=Y(s);let n=!1;if(s&&!i){if(e)if(Y(e))for(const r of e.split(";")){const o=r.slice(0,r.indexOf(":")).trim();s[o]==null&&ds(l,o,"")}else for(const r in e)s[r]==null&&ds(l,r,"");for(const r in s)r==="display"&&(n=!0),ds(l,r,s[r])}else if(i){if(e!==s){const r=l[Oo];r&&(s+=";"+r),l.cssText=s,n=Co.test(s)}}else e&&t.removeAttribute("style");Jl in t&&(t[Jl]=n?l.display:"",t[jo]&&(l.display="none"))}const Ql=/\s*!important$/;function ds(t,e,s){if(D(s))s.forEach(l=>ds(t,e,l));else if(s==null&&(s=""),e.startsWith("--"))t.setProperty(e,s);else{const l=Wo(t,e);Ql.test(s)?t.setProperty(_e(l),s.replace(Ql,""),"important"):t[l]=s}}const Yl=["Webkit","Moz","ms"],zs={};function Wo(t,e){const s=zs[e];if(s)return s;let l=Dt(e);if(l!=="filter"&&l in t)return zs[e]=l;l=bs(l);for(let i=0;i<Yl.length;i++){const n=Yl[i]+l;if(n in t)return zs[e]=n}return e}const Zl="http://www.w3.org/1999/xlink";function Xl(t,e,s,l,i,n=Rn(e)){l&&e.startsWith("xlink:")?s==null?t.removeAttributeNS(Zl,e.slice(6,e.length)):t.setAttributeNS(Zl,e,s):s==null||n&&!pi(s)?t.removeAttribute(e):t.setAttribute(e,n?"":Pt(s)?String(s):s)}function Io(t,e,s,l){if(e==="innerHTML"||e==="textContent"){s!=null&&(t[e]=e==="innerHTML"?hn(s):s);return}const i=t.tagName;if(e==="value"&&i!=="PROGRESS"&&!i.includes("-")){const r=i==="OPTION"?t.getAttribute("value")||"":t.value,o=s==null?t.type==="checkbox"?"on":"":String(s);(r!==o||!("_value"in t))&&(t.value=o),s==null&&t.removeAttribute(e),t._value=s;return}let n=!1;if(s===""||s==null){const r=typeof t[e];r==="boolean"?s=pi(s):s==null&&r==="string"?(s="",n=!0):r==="number"&&(s=0,n=!0)}try{t[e]=s}catch{}n&&t.removeAttribute(e)}function Zt(t,e,s,l){t.addEventListener(e,s,l)}function Po(t,e,s,l){t.removeEventListener(e,s,l)}const ti=Symbol("_vei");function zo(t,e,s,l,i=null){const n=t[ti]||(t[ti]={}),r=n[e];if(l&&r)r.value=l;else{const[o,a]=Lo(e);if(l){const _=n[e]=Mo(l,i);Zt(t,o,_,a)}else r&&(Po(t,o,r,a),n[e]=void 0)}}const ei=/(?:Once|Passive|Capture)$/;function Lo(t){let e;if(ei.test(t)){e={};let l;for(;l=t.match(ei);)t=t.slice(0,t.length-l[0].length),e[l[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):_e(t.slice(2)),e]}let Ls=0;const Fo=Promise.resolve(),Ho=()=>Ls||(Fo.then(()=>Ls=0),Ls=Date.now());function Mo(t,e){const s=l=>{if(!l._vts)l._vts=Date.now();else if(l._vts<=s.attached)return;zt(Uo(l,s.value),e,5,[l])};return s.value=t,s.attached=Ho(),s}function Uo(t,e){if(D(e)){const s=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{s.call(t),t._stopped=!0},e.map(l=>i=>!i._stopped&&l&&l(i))}else return e}const si=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,qo=(t,e,s,l,i,n)=>{const r=i==="svg";e==="class"?Go(t,l,r):e==="style"?Ro(t,s,l):cs(e)?tl(e)||zo(t,e,s,l,n):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):$o(t,e,l,r))?(Io(t,e,l),!t.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&Xl(t,e,l,r,n,e!=="value")):(e==="true-value"?t._trueValue=l:e==="false-value"&&(t._falseValue=l),Xl(t,e,l,r))};function $o(t,e,s,l){if(l)return!!(e==="innerHTML"||e==="textContent"||e in t&&si(e)&&O(s));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const i=t.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return si(e)&&Y(s)?!1:!!(e in t||t._isVueCE&&(/[A-Z]/.test(e)||!Y(s)))}const Ae=t=>{const e=t.props["onUpdate:modelValue"]||!1;return D(e)?s=>ns(e,s):e};function Bo(t){t.target.composing=!0}function li(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const qt=Symbol("_assign"),je={created(t,{modifiers:{lazy:e,trim:s,number:l}},i){t[qt]=Ae(i);const n=l||i.props&&i.props.type==="number";Zt(t,e?"change":"input",r=>{if(r.target.composing)return;let o=t.value;s&&(o=o.trim()),n&&(o=ms(o)),t[qt](o)}),s&&Zt(t,"change",()=>{t.value=t.value.trim()}),e||(Zt(t,"compositionstart",Bo),Zt(t,"compositionend",li),Zt(t,"change",li))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,oldValue:s,modifiers:{lazy:l,trim:i,number:n}},r){if(t[qt]=Ae(r),t.composing)return;const o=(n||t.type==="number")&&!/^0\d/.test(t.value)?ms(t.value):t.value,a=e??"";o!==a&&(document.activeElement===t&&t.type!=="range"&&(l&&e===s||i&&t.value.trim()===a)||(t.value=a))}},cn={deep:!0,created(t,e,s){t[qt]=Ae(s),Zt(t,"change",()=>{const l=t._modelValue,i=Me(t),n=t.checked,r=t[qt];if(D(l)){const o=il(l,i),a=o!==-1;if(n&&!a)r(l.concat(i));else if(!n&&a){const _=[...l];_.splice(o,1),r(_)}}else if(Ee(l)){const o=new Set(l);n?o.add(i):o.delete(i),r(o)}else r(pn(t,n))})},mounted:ii,beforeUpdate(t,e,s){t[qt]=Ae(s),ii(t,e,s)}};function ii(t,{value:e,oldValue:s},l){t._modelValue=e;let i;D(e)?i=il(e,l.props.value)>-1:Ee(e)?i=e.has(l.props.value):i=qe(e,pn(t,!0)),t.checked!==i&&(t.checked=i)}const Fs={deep:!0,created(t,{value:e,modifiers:{number:s}},l){const i=Ee(e);Zt(t,"change",()=>{const n=Array.prototype.filter.call(t.options,r=>r.selected).map(r=>s?ms(Me(r)):Me(r));t[qt](t.multiple?i?new Set(n):n:n[0]),t._assigning=!0,zi(()=>{t._assigning=!1})}),t[qt]=Ae(l)},mounted(t,{value:e,modifiers:{number:s}}){ni(t,e)},beforeUpdate(t,e,s){t[qt]=Ae(s)},updated(t,{value:e,modifiers:{number:s}}){t._assigning||ni(t,e)}};function ni(t,e,s){const l=t.multiple,i=D(e);if(!(l&&!i&&!Ee(e))){for(let n=0,r=t.options.length;n<r;n++){const o=t.options[n],a=Me(o);if(l)if(i){const _=typeof a;_==="string"||_==="number"?o.selected=e.some(m=>String(m)===String(a)):o.selected=il(e,a)>-1}else o.selected=e.has(a);else if(qe(Me(o),e)){t.selectedIndex!==n&&(t.selectedIndex=n);return}}!l&&t.selectedIndex!==-1&&(t.selectedIndex=-1)}}function Me(t){return"_value"in t?t._value:t.value}function pn(t,e){const s=e?"_trueValue":"_falseValue";return s in t?t[s]:e}const Ko=rt({patchProp:qo},So);let ri;function Vo(){return ri||(ri=Vr(Ko))}const Jo=(...t)=>{const e=Vo().createApp(...t),{mount:s}=e;return e.mount=l=>{const i=Yo(l);if(!i)return;const n=e._component;!O(n)&&!n.render&&!n.template&&(n.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const r=s(i,!1,Qo(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),r},e};function Qo(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function Yo(t){return Y(t)?document.querySelector(t):t}const gt=(t,e)=>{const s=t.__vccOpts||t;for(const[l,i]of e)s[l]=i;return s},Zo={};function Xo(t,e){return R(),z(Q,null,[e[0]||(e[0]=c("h1",null,"GlossySnake",-1)),e[1]||(e[1]=c("p",null,[xs("INDEX PAGE | "),c("a",{href:"https://github.com/parkchamchi/GlossySnake"},"Repo")],-1))],64)}const ta=gt(Zo,[["render",Xo],["__scopeId","data-v-76cc459c"]]),Jt=$e({}),st={on(t,e){Jt[t]||(Jt[t]=[]),Jt[t].push(e)},off(t,e){Jt[t]&&(Jt[t]=Jt[t].filter(s=>s!==e))},emit(t,e){Jt[t]&&Jt[t].forEach(s=>s(e))}};function nt(){}nt.prototype.host="https://api.glossysnake.com";nt.prototype.api="/api/v4";nt.prototype.uri=function(t){return this.host+this.api+t};nt.prototype.jsonHelper=async function(t){try{return await t.json()}catch(e){return console.log(e),{error:JSON.parse(JSON.stringify(e,Object.getOwnPropertyNames(e)))}}};nt.prototype.submit=async function(t,e="GET",s=null,l=!0){const i=this.uri(t);let n={method:e,headers:{"Content-type":"application/json; charset=UTF-8"},credentials:"include"};e!="GET"&&(n.body=JSON.stringify(s)),l&&(n.headers.Authorization="Token "+nt._key);const r=await fetch(i,n);if(!r.ok){const o=await this.jsonHelper(r),a=i+": "+r.statusText+`
> `+JSON.stringify(o);throw st.emit("addAlert",{message:a,alertClass:"alert-warning"}),new Error(a)}return this.emitCorpusesUpdate(t),r};nt.prototype.emitCorpusesUpdate=async function(t){["/corpuses/","/tasks/","/user/check","/user/get-temp-user","/user/logout","/rest-auth/registration/","/rest-auth/login/","/rest-auth/logout/"].some(s=>t.endsWith(s))||(st.emit("updateCorpuses"),st.emit("updateTasks"))};const ea={data(){return{api:new nt,loggedin:!1}},computed:{userinfo(){return this.loggedin?"Guest.":"Log in."}},methods:{meow(){console.log("meow")},async getTempUser(){const e=await(await this.api.submit("/user/get-temp-user","GET",null,!1)).json();return e.success?(nt._key=e.key,!0):(console.error("get-temp-user unsuccessful"),!1)},async updateUser(){if(!nt._key&&!await this.getTempUser()){console.error("could not get the temp user.");return}this.loggedin=!0,st.emit("updateCorpuses"),st.emit("updateTasks")},async logout(){this.api.submit("/user/logout").then(()=>{nt._key=null,this.loggedin=!1,this.updateUser()})}},async created(){await this.updateUser()}},sa={id:"frontend_auth_div"},la={class:"userinfo_p"};function ia(t,e,s,l,i,n){return R(),z("div",sa,[c("p",la,At(n.userinfo),1),c("p",{onClick:e[0]||(e[0]=r=>n.logout()),class:"btn logout_button"}," Logout ")])}const na=gt(ea,[["render",ia],["__scopeId","data-v-bb2b082d"]]),ra=JSON.parse(localStorage.getItem("sharedState"))||{},C=$e({annotator_name:"chatgpt_ft0",lang_from:"German",lang_to:"English",toRemote:!0,openaiApiKey:null,openaiModel:"gpt-4o-mini",outerRetry:2,innerRetry:3,fullPrompt:!0,...ra}),oa={data(){return C},watch:{annotator_name(){this.emitChange()},lang_from(){this.emitChange()},lang_to(){this.emitChange()},toRemote(){this.emitChange()}},methods:{emitChange(){C.annotator_name=this.annotator_name,C.lang_from=this.lang_from,C.lang_to=this.lang_to,C.toRemote=this.toRemote}}},aa={class:"container mt-4"},ua={class:"row"},da={class:"col-md-4"},ma={class:"col-md-4"},_a={class:"col-md-4"};function ga(t,e,s,l,i,n){return R(),z(Q,null,[c("div",aa,[c("div",ua,[c("div",da,[e[5]||(e[5]=c("label",{for:"annotator_name"},"annotator_name:",-1)),Wt(c("select",{"onUpdate:modelValue":e[0]||(e[0]=r=>t.annotator_name=r),name:"annotator_name",id:"annotator_name_select",class:"form-control"},e[4]||(e[4]=[go('<option value="dummy">dummy</option><option value="chatgpt_ft0">chatgpt_ft0</option><option value="chatgpt_gpt-4o-mini-untrained_0">chatgpt_gpt-4o-mini-untrained_0</option><option value="chatgpt_gpt-4o-mini-pretrained_0">chatgpt_gpt-4o-mini-pretrained_0</option><option value="chatgpt_gpt-3.5-turbo-untrained_0">chatgpt_gpt-3.5-turbo-untrained_0</option><option value="chatgpt_gpt-3.5-turbo-pretrained_0">chatgpt_gpt-3.5-turbo-pretrained_0</option>',6)]),512),[[Fs,t.annotator_name]])]),c("div",ma,[e[7]||(e[7]=c("label",{for:"lang_from"},"lang_from:",-1)),Wt(c("select",{"onUpdate:modelValue":e[1]||(e[1]=r=>t.lang_from=r),name:"lang_from",id:"lang_from_select",class:"form-control"},e[6]||(e[6]=[c("option",{value:"French"},"French",-1),c("option",{value:"German"},"German",-1),c("option",{value:"Latin"},"Latin",-1)]),512),[[Fs,t.lang_from]])]),c("div",_a,[e[9]||(e[9]=c("label",{for:"lang_to"},"lang_to:",-1)),Wt(c("select",{"onUpdate:modelValue":e[2]||(e[2]=r=>t.lang_to=r),name:"lang_to",id:"lang_to_select",class:"form-control"},e[8]||(e[8]=[c("option",{value:"English"},"English",-1)]),512),[[Fs,t.lang_to]])])])]),e[11]||(e[11]=c("br",null,null,-1)),c("div",null,[Wt(c("input",{"onUpdate:modelValue":e[3]||(e[3]=r=>t.toRemote=r),type:"checkbox",name:"toRemote",id:"toRemote_input",class:"form-check-input",checked:""},null,512),[[cn,t.toRemote]]),e[10]||(e[10]=c("label",{for:"toRemote_input",class:"form-check-label"},"To the remote server",-1))])],64)}const fa=gt(oa,[["render",ga]]),xa={data(){return C},watch:{openaiApiKey(){this.emitChange()},openaiModel(){this.emitChange()},outerRetry(){this.emitChange()},innerRetry(){this.emitChange()},fullPrompt(){this.emitChange()}},computed:{visibility(){return!C.toRemote}},methods:{emitChange(){C.openaiApiKey=this.openaiApiKey,C.openaiModel=this.openaiModel,C.outerRetry=this.outerRetry,C.innerRetry=this.innerRetry,C.fullPrompt=this.fullPrompt},exportData(){console.log("test");const t=JSON.stringify(C,null,2),e=new Blob([t],{type:"application/json"}),s=URL.createObjectURL(e),l=document.createElement("a");l.href=s,l.download="sharedState.json",l.click(),URL.revokeObjectURL(s)},async importData(t){const s=await t.target.files[0].text(),l=JSON.parse(s);Object.keys(l).forEach(i=>{C.hasOwnProperty(i)&&(C[i]=l[i])})}},mounted(){os(()=>C,t=>{localStorage.setItem("sharedState",JSON.stringify(t))},{deep:!0})}},ha={key:0,class:"container mt-3"},ca={class:"row"},pa={class:"col-md-2"},ba={class:"col-md-2"},ka={class:"col-md-2"},wa={class:"col-md-2"},Aa={class:"col-md-2 d-flex align-items-center"},Ea={class:"row"},va={class:"col-md-2 d-flex align-items-center"},ya={class:"col-md-2 d-flex align-items-center"};function Ta(t,e,s,l,i,n){return R(),z(Q,null,[e[13]||(e[13]=c("h4",null,"Local Annotator Options",-1)),n.visibility?(R(),z("div",ha,[c("div",ca,[c("div",pa,[e[7]||(e[7]=c("label",{for:"openaiApiKey"},"OpenAI API Key",-1)),Wt(c("input",{type:"password",class:"form-control",id:"openaiApiKey","onUpdate:modelValue":e[0]||(e[0]=r=>t.openaiApiKey=r)},null,512),[[je,t.openaiApiKey]])]),c("div",ba,[e[8]||(e[8]=c("label",{for:"openaiModel"},"OpenAI Model",-1)),Wt(c("input",{type:"text",class:"form-control",id:"openaiModel","onUpdate:modelValue":e[1]||(e[1]=r=>t.openaiModel=r)},null,512),[[je,t.openaiModel]])]),c("div",ka,[e[9]||(e[9]=c("label",{for:"outerRetry"},"Outer Retry",-1)),Wt(c("input",{type:"number",class:"form-control",id:"outerRetry","onUpdate:modelValue":e[2]||(e[2]=r=>t.outerRetry=r)},null,512),[[je,t.outerRetry]])]),c("div",wa,[e[10]||(e[10]=c("label",{for:"innerRetry"},"Inner Retry",-1)),Wt(c("input",{type:"number",class:"form-control",id:"innerRetry","onUpdate:modelValue":e[3]||(e[3]=r=>t.innerRetry=r)},null,512),[[je,t.innerRetry]])]),c("div",Aa,[Wt(c("input",{type:"checkbox",class:"form-check-input",id:"fullPrompt","onUpdate:modelValue":e[4]||(e[4]=r=>t.fullPrompt=r)},null,512),[[cn,t.fullPrompt]]),e[11]||(e[11]=c("label",{class:"form-check-label",for:"fullPrompt"},"Full Prompt",-1))])]),c("div",Ea,[e[12]||(e[12]=c("div",{class:"col-md-2 d-flex align-items-center"},[c("button",{class:"btn btn-link mt-3"},[c("a",{href:"https://github.com/parkchamchi/GlossySnake/blob/master/docs/design/local.md"},"Info")])],-1)),c("div",va,[c("button",{class:"btn btn-link mt-3",onClick:e[5]||(e[5]=(...r)=>n.exportData&&n.exportData(...r))},"Export")]),c("div",ya,[c("input",{type:"file",onChange:e[6]||(e[6]=(...r)=>n.importData&&n.importData(...r)),class:"form-control"},null,32)])])])):Ut("",!0)],64)}const Da=gt(xa,[["render",Ta]]),Sa=[{corpus_id:"Winterreise",corpuses_history:[{paragraphs:[{pstate:"ANNOTATED",tokens:[{txt:"#",is_delimiter:!1,gloss:"#"},{txt:" ",is_delimiter:!0,gloss:null},{txt:"Gute",is_delimiter:!1,gloss:"Good"},{txt:" ",is_delimiter:!0,gloss:null},{txt:"Nacht.",is_delimiter:!1,gloss:"Night."}],is_delimiter:!1,token_delimiters:` 	
...
`;if(e){const o=[1,2];return[{role:"system",content:`
					...
					Parse this corpus (Interlinear gloss). 
					${l}
				`,[{role:"system",content:s}]}}function _i(t,e){return console.log(t),t&&t.startsWith("chatgpt_")?new Ca(t,e):new wn}const Ia={props:{t:{type:Object,required:!0},index:{type:Number,required:!0}},data(){return{isSelected:!1}},computed:{is_delimiter(){return this.t.is_delimiter},should_linebreak(){return this.t.txt.includes(`
`)},txt(){return this.t.txt},gloss(){let t=this.t.gloss;return t=="!UNKNOWN"&&(t="-"),t}},methods:{toggle(){this.isSelected=!this.isSelected,this.$emit("selectionChanged",{tIndex:this.index,isSelected:this.isSelected})}}},Pa={class:"token_ul list-group list-group-flush"},za={class:"list-group-item token_txt"},La={class:"list-group-item gloss"},Fa={key:1},Ha={key:2,class:"token_wrapper"};function Ma(t,e,s,l,i,n){return n.is_delimiter?n.should_linebreak?(R(),z("br",Fa)):(R(),z("div",Ha,[c("span",null,At(n.txt),1)])):(R(),z("div",{key:0,class:Rt(["token_wrapper","card",{"selected-token":i.isSelected}]),onClick:e[0]||(e[0]=r=>n.toggle())},[c("ul",Pa,[c("li",za,At(n.txt),1),c("li",La,At(n.gloss),1)])],2))}const Ua=gt(Ia,[["render",Ma],["__scopeId","data-v-77eee0fc"]]),qa={props:{p:{type:Object,required:!0},index:{type:Number,required:!0},remote:{type:Boolean,default:!1}},components:{Token:Ua},computed:{isAnnotateButtonVisible(){return!this.p.is_delimiter&&this.p.tokens&&this.p.tokens.length},shouldShowManipulatorButtons(){return this.remote&&C.toRemote||!this.remote&&!C.toRemote&&C.openaiApiKey}},data(){return{selectedTokens:new Set,showPre:!1}},methods:{annotateP(){this.$emit("annotateP",this.index)},reannotateP(){this.$emit("reannotateP",this.index,Array.from(this.selectedTokens))},onSelectionChanged({tIndex:t,isSelected:e}){e?this.selectedTokens.add(t):this.selectedTokens.delete(t)}}},$a={class:"paragraph_wrapper"},Ba={key:0,class:"paragraph_annotate_buttons_span"},Ka={key:1};function Va(t,e,s,l,i,n){const r=bt("Token");return R(),z("div",$a,[n.isAnnotateButtonVisible&&n.shouldShowManipulatorButtons?(R(),z("span",Ba,[c("button",{class:"corpus_button btn btn-light",onClick:e[0]||(e[0]=o=>n.annotateP(s.index))}," Annotate "),c("button",{class:"corpus_button btn btn-light",onClick:e[1]||(e[1]=o=>n.reannotateP(s.index))}," Reannotate "),e[2]||(e[2]=c("br",null,null,-1))])):Ut("",!0),i.showPre?(R(),z("pre",Ka,At(JSON.stringify(s.p)),1)):Ut("",!0),(R(!0),z(Q,null,ae(s.p.tokens,(o,a)=>(R(),me(r,{key:a,t:o,index:a,onSelectionChanged:n.onSelectionChanged},null,8,["t","index","onSelectionChanged"]))),128))])}const Ja=gt(qa,[["render",Va],["__scopeId","data-v-6408b70f"]]),Qa={props:{corpus_id:{required:!0},corpus:{type:Object,required:!0},remote:{type:Boolean,default:!1}},components:{Paragraph:Ja},data(){return{api:new nt,sharedState:C,isCorpusVisible:!1,showPre:!1}},computed:{pseudoState(){return!this.corpus.paragraphs||this.corpus.paragraphs.length<=0?"PLAIN":this.corpus.paragraphs[0].pstate},divideButtonClass(){const t=this.pseudoState=="PLAIN";return{"btn-primary":t,"btn-light":!t}},parseButtonClass(){const t=this.pseudoState=="DIVIDED";return{"btn-primary":t,"btn-light":!t}},annotateButtonClass(){const t=this.pseudoState=="PARSED";return{"btn-primary":t,"btn-light":!t}},header(){return this.remote?"REMOTE":"LOCAL"},shouldShowManipulatorButtons(){return this.remote&&C.toRemote||!this.remote&&!C.toRemote&&C.openaiApiKey}},methods:{toggleCorpusVisibility(){this.isCorpusVisible=!this.isCorpusVisible},download(){const t=JSON.stringify(this.corpus);console.log("Downloading...");let e=document.createElement("a"),s=new Blob([t],{type:"text/plain"});e.download=this.corpus_id+".corpus.json",e.href=URL.createObjectURL(s),e.click()},async divide(t=`
`){return C.toRemote?this.divideRemote(t):this.divideLocal(t)},async parse(){return C.toRemote?this.parseRemote():this.parseLocal()},async annotate(t=null){return C.toRemote?this.annotateRemote(t):this.annotateLocal(t)},async reannotate(t,e){if(!e){console.error("target_tokens is not given");return}if(e.length==0){st.emit("addAlert",{message:"No token selected.",alertClass:"alert-warning"});return}return C.toRemote?this.reannotateRemote(t,e):this.reannotateLocal(t,e)},async divideRemote(t){this.api.submit("/parser/divide","POST",{corpus_id:this.corpus_id,divide_options:{p_delims:[t]}})},async parseRemote(){this.api.submit("/parser/parse","POST",{corpus_id:this.corpus_id,parse_options:{t_delims:null}})},async annotateRemote(t){this.api.submit("/annotator/annotate","POST",{corpus_id:this.corpus_id,annotate_options:{annotator_name:this.sharedState.annotator_name,lang_from:this.sharedState.lang_from,lang_to:this.sharedState.lang_to,target_paragraphs:t}})},async reannotateRemote(t,e){this.api.submit("/annotator/reannotate","POST",{corpus_id:this.corpus_id,annotate_options:{annotator_name:this.sharedState.annotator_name,lang_from:this.sharedState.lang_from,lang_to:this.sharedState.lang_to,target_paragraphs:t},reannotate_options:{target_tokens:e}})},async divideLocal(t){ui.divide_into_paragraphs(this.corpus,[t])},async parseLocal(){for(const t of this.corpus.paragraphs)ui.parse_paragraph(t)},async annotateLocal(t){const e=_i(C.annotator_name),s=C.lang_from,l=C.lang_to;t&&(t.length==1&&t[0]==-1&&(t=this.corpus.paragraphs.map((i,n)=>({p:i,i:n})).filter(({p:i})=>!i.is_delimiter&&i.pstate!="ANNOTATED").map(({i})=>i)),console.log(t));for(const[i,n]of this.corpus.paragraphs.entries())t&&!t.includes(i)||await e.annotate(n,s,l)},async reannotateLocal(t,e){const s=_i(C.annotator_name),l=C.lang_from,i=C.lang_to,n=t[0],r=this.corpus.paragraphs[n];l||(l=r.annotator_info_obj.lang_from),i||(i=r.annotator_info_obj.lang_to),await s.reannotate(r,l,i,e)},onAnnotateP(t){this.annotate([t])},onReannotateP(t,e){this.reannotate([t],e)}}},Ya={class:"corpus_wrapper"},Za={key:0,class:"corpus"},Xa={class:"corpus_buttons_span"},tu={key:0},eu={key:0,class:"corpus-pre"};function su(t,e,s,l,i,n){const r=bt("Paragraph");return R(),z("div",Ya,[e[9]||(e[9]=c("hr",null,null,-1)),c("h4",{onClick:e[0]||(e[0]=o=>n.toggleCorpusVisibility())},At(n.header+": "+s.corpus_id),1),i.isCorpusVisible?(R(),z("div",Za,[c("span",Xa,[c("button",{class:"corpus_button btn btn-light",onClick:e[1]||(e[1]=o=>n.download())},"Download"),n.shouldShowManipulatorButtons?(R(),z("span",tu,[c("button",{class:Rt(["corpus_button","btn",n.divideButtonClass]),onClick:e[2]||(e[2]=o=>n.divide())},"Divide",2),c("button",{class:Rt(["corpus_button","btn",n.divideButtonClass]),onClick:e[3]||(e[3]=o=>n.divide("\\n\\n"))},"Divide (for poems)",2),c("button",{class:Rt(["corpus_button","btn",n.parseButtonClass]),onClick:e[4]||(e[4]=o=>n.parse())},"Parse",2),c("button",{class:Rt(["corpus_button","btn",n.annotateButtonClass]),onClick:e[5]||(e[5]=o=>n.annotate([-1]))}," Annotate ",2),c("button",{class:Rt(["corpus_button","btn",n.annotateButtonClass]),onClick:e[6]||(e[6]=o=>n.annotate(null))}," Annotate (Reset) ",2)])):Ut("",!0)]),e[7]||(e[7]=c("br",null,null,-1)),i.showPre?(R(),z("pre",eu,At(JSON.stringify(s.corpus)),1)):Ut("",!0),e[8]||(e[8]=c("h4",null,"paragraphs",-1)),(R(!0),z(Q,null,ae(s.corpus.paragraphs,(o,a)=>(R(),me(r,{key:a,p:o,index:a,remote:s.remote,onAnnotateP:n.onAnnotateP,onReannotateP:n.onReannotateP},null,8,["p","index","remote","onAnnotateP","onReannotateP"]))),128))])):Ut("",!0)])}const lu=gt(Qa,[["render",su],["__scopeId","data-v-a2703374"]]),iu={components:{Corpus:lu},data(){return{api:new nt,sampleHost:"https://parkchamchi.github.io/GlossySnake/samples/v1/",localCorpuses:JSON.parse(localStorage.getItem("localCorpuses"))||[...Sa],remoteCorpuses:[],remoteSampleFilenames:[]}},watch:{localCorpuses:{handler(t){localStorage.setItem("localCorpuses",JSON.stringify(t))},deep:!0}},methods:{async updateCorpuses(){const e=await(await this.api.submit("/corpuses/")).json();this.remoteCorpuses=e},async getRemoteSamples(){await fetch(this.sampleHost).then(t=>t.json()).then(t=>{this.remoteSampleFilenames=t.filenames})},async getRemoteSampleCorpus(t){fetch(this.sampleHost+t).then(e=>e.json()).then(e=>{const s=t.replace(".corpus.json","");this.addLocalCorpus({corpus_id:s,corpus:e})}).then(()=>{this.remoteSampleFilenames=this.remoteSampleFilenames.filter(e=>e!==t)})},async addLocalCorpus({corpus_id:t,corpus:e}){this.localCorpuses.push({corpus_id:t,corpuses_history:[e]})}},created(){st.on("updateCorpuses",this.updateCorpuses),st.on("addLocalCorpus",this.addLocalCorpus),this.getRemoteSamples()},beforeDestroy(){st.off("updateCorpuses",this.updateCorpuses),st.off("addLocalCorpus",this.addLocalCorpus)}},nu={key:0},ru=["onClick"];function ou(t,e,s,l,i,n){const r=bt("Corpus");return R(),z(Q,null,[i.remoteSampleFilenames.length>0?(R(),z("div",nu,[e[0]||(e[0]=c("h4",null,"Get a sample:",-1)),(R(!0),z(Q,null,ae(i.remoteSampleFilenames,(o,a)=>(R(),z("p",{class:"sampleLinkP",onClick:_=>n.getRemoteSampleCorpus(o)},At(o),9,ru))),256))])):Ut("",!0),c("div",null,[(R(!0),z(Q,null,ae(i.localCorpuses,(o,a)=>(R(),me(r,{key:a,corpus:o.corpuses_history.at(-1),corpus_id:o.corpus_id,remote:!1},null,8,["corpus","corpus_id"]))),128)),(R(!0),z(Q,null,ae(i.remoteCorpuses,(o,a)=>(R(),me(r,{key:a,corpus:o.corpuses_history.at(-1),corpus_id:o.corpus_id,remote:!0},null,8,["corpus","corpus_id"]))),128))])],64)}const au=gt(iu,[["render",ou],["__scopeId","data-v-cfea6369"]]),uu={data(){return{api:new nt,originalText:""}},methods:{async onUploadButtonClicked(){return C.toRemote?this.uploadOriginalTextRemote():this.uploadOriginalTextLocal()},async onJsonFileInput(t){const s=await t.target.files[0].text(),l=JSON.parse(s);return C.toRemote?this.uploadJsonFileRemote(l):this.uploadJsonFileLocal(l)},async uploadOriginalTextRemote(){this.api.submit("/upload","POST",{original_text:this.originalText}).then(t=>t.json()).then(t=>{st.emit("addAlert",{message:"Uploaded corpus "+t.corpus_id})})},async uploadJsonFileRemote(t){this.api.submit("/upload","POST",{corpus:t}).then(e=>e.json()).then(e=>{st.emit("addAlert",{message:"Uploaded corpus "+e.corpus_id})})},async uploadOriginalTextLocal(){const t=this.makeTitle(this.originalText),e=Ga.init_with_txt(this.originalText);st.emit("addLocalCorpus",{corpus_id:t,corpus:e})},async uploadJsonFileLocal(t){const e=this.makeTitle(t.original_text);st.emit("addLocalCorpus",{corpus_id:e,corpus:t})},makeTitle(t,e=16){return t.substring(0,e)}}},du={id:"frontend_upload_div"};function mu(t,e,s,l,i,n){return R(),z("div",du,[e[3]||(e[3]=c("h3",null,"Upload...",-1)),e[4]||(e[4]=c("label",{for:"frontend_original_text"},"Original Text",-1)),e[5]||(e[5]=c("br",null,null,-1)),Wt(c("textarea",{"onUpdate:modelValue":e[0]||(e[0]=r=>i.originalText=r),class:"context_input auto-resize field_input",name:"frontend_original_text",spellcheck:"false",autofocus:"",placeholder:"Original Text",id:"frontend_original_text_textarea"},null,512),[[je,i.originalText]]),e[6]||(e[6]=c("br",null,null,-1)),c("button",{onClick:e[1]||(e[1]=r=>n.onUploadButtonClicked()),id:"frontend_original_text_button",class:"btn btn-primary"}," Upload "),e[7]||(e[7]=c("br",null,null,-1)),e[8]||(e[8]=c("p",null,"...or the JSON file",-1)),c("input",{type:"file",id:"json_file_input",onChange:e[2]||(e[2]=(...r)=>n.onJsonFileInput&&n.onJsonFileInput(...r))},null,32),e[9]||(e[9]=c("br",null,null,-1))])}const _u=gt(uu,[["render",mu],["__scopeId","data-v-52619bea"]]),gu={props:{message:{type:String,required:!0},alertClass:{type:String,default:"alert-warning",validator(t){return["alert-success","alert-warning","alert-info","alert-light"].includes(t)}},timeout:{type:Number,default:5e4}},data(){return{showAlert:!1,alertMessage:this.message}},mounted(){this.showAlert=!0,setTimeout(()=>{this.showAlert=!1},this.timeout)}};function fu(t,e,s,l,i,n){return i.showAlert?(R(),z("div",{key:0,class:Rt(["alert",this.alertClass]),role:"alert"},At(i.alertMessage),3)):Ut("",!0)}const xu=gt(gu,[["render",fu]]),hu={components:{Alert:xu},data(){return{alerts:[],maxAlerts:3}},methods:{addAlert({message:t,alertClass:e="alert-light"}){this.alerts.length>=this.maxAlerts&&this.alerts.shift(),this.alerts.push({message:t,alertClass:e})}},created(){st.on("addAlert",this.addAlert)},beforeDestroy(){st.off("addAlert",this.addAlert)}};function cu(t,e,s,l,i,n){const r=bt("Alert");return R(),z("div",null,[(R(!0),z(Q,null,ae(i.alerts,(o,a)=>(R(),me(r,{key:a,message:o.message,timeout:o.timeout,alertClass:o.alertClass},null,8,["message","timeout","alertClass"]))),128))])}const pu=gt(hu,[["render",cu]]),bu={props:{task_id:{required:!0},status:{type:String,required:!0},target_corpus_id:{required:!0}},data(){return{api:new nt}},computed:{isAbortButtonShown(){return["READY","RUNNING"].includes(this.status)}},methods:{async abort(){this.api.submit("/tasks/"+this.task_id+"/abort")}}},ku={class:"task_wrapper"};function wu(t,e,s,l,i,n){return R(),z("div",ku,[e[1]||(e[1]=c("hr",null,null,-1)),c("p",null,[xs(" Task: "+At(s.task_id)+" ",1),n.isAbortButtonShown?(R(),z("button",{key:0,class:"task_button btn btn-light",onClick:e[0]||(e[0]=r=>n.abort())}," Abort ")):Ut("",!0),xs(" for corpus: "+At(s.target_corpus_id)+" ("+At(s.status)+") ",1)])])}const Au=gt(bu,[["render",wu]]),Eu={components:{Task:Au},data(){return{api:new nt,tasks:[]}},methods:{async updateTasks(){const e=await(await this.api.submit("/tasks/")).json();this.tasks=e}},created(){st.on("updateTasks",this.updateTasks)},beforeDestroy(){st.off("updateTasks",this.updateTasks)}};function vu(t,e,s,l,i,n){const r=bt("Task");return R(),z(Q,null,[e[0]||(e[0]=c("h3",null,"Tasks",-1)),c("div",null,[(R(!0),z(Q,null,ae(i.tasks,(o,a)=>(R(),me(r,{key:a,task_id:o.task_id,status:o.status,target_corpus_id:o.target_corpus_id},null,8,["task_id","status","target_corpus_id"]))),128))])],64)}const yu=gt(Eu,[["render",vu]]),Tu={components:{Header:ta,RestAuth:na,AnnotatorSelect:fa,LocalAnnotatorOptions:Da,CorpusesView:au,UploadView:_u,AlertsView:pu,TasksView:yu},data(){return{}}};function Du(t,e,s,l,i,n){const r=bt("Header"),o=bt("RestAuth"),a=bt("AnnotatorSelect"),_=bt("LocalAnnotatorOptions"),m=bt("CorpusesView"),f=bt("UploadView"),k=bt("AlertsView"),N=bt("TasksView");return R(),z(Q,null,[c("header",null,[et(r)]),c("main",null,[et(o),e[0]||(e[0]=c("hr",null,null,-1)),et(a),e[1]||(e[1]=c("hr",null,null,-1)),et(_),e[2]||(e[2]=c("hr",null,null,-1)),et(m),e[3]||(e[3]=c("hr",null,null,-1)),et(f),e[4]||(e[4]=c("hr",null,null,-1)),et(k),e[5]||(e[5]=c("hr",null,null,-1)),et(N)])],64)}const Su=gt(Tu,[["render",Du],["__scopeId","data-v-ebbae25a"]]);Jo(Su).mount("#app");
