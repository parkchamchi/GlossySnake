...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function tl(t){const e=Object.create(null);for(const s of t.split(","))e[s]=1;return s=>s in e}const U={},he=[],Pt=()=>{},yn=()=>!1,ps=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),el=t=>t.startsWith("onUpdate:"),rt=Object.assign,sl=(t,e)=>{const s=t.indexOf(e);s>-1&&t.splice(s,1)},Tn=Object.prototype.hasOwnProperty,L=(t,e)=>Tn.call(t,e),D=Array.isArray,ce=t=>qe(t)==="[object Map]",ve=t=>qe(t)==="[object Set]",Sl=t=>qe(t)==="[object Date]",C=t=>typeof t=="function",Y=t=>typeof t=="string",zt=t=>typeof t=="symbol",B=t=>t!==null&&typeof t=="object",fi=t=>(B(t)||C(t))&&C(t.then)&&C(t.catch),xi=Object.prototype.toString,qe=t=>xi.call(t),Sn=t=>qe(t).slice(8,-1),hi=t=>qe(t)==="[object Object]",ll=t=>Y(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Oe=tl(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),bs=t=>{const e=Object.create(null);return s=>e[s]||(e[s]=t(s))},Dn=/-(\w)/g,Nt=bs(t=>t.replace(Dn,(e,s)=>s?s.toUpperCase():"")),Nn=/\B([A-Z])/g,ge=bs(t=>t.replace(Nn,"-$1").toLowerCase()),ws=bs(t=>t.charAt(0).toUpperCase()+t.slice(1)),js=bs(t=>t?`on${ws(t)}`:""),de=(t,e)=>!Object.is(t,e),os=(t,...e)=>{for(let s=0;s<t.length;s++)t[s](...e)},ci=(t,e,s,l=!1)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,writable:l,value:s})},gs=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Dl;const pi=()=>Dl||(Dl=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function il(t){if(D(t)){const e={};for(let s=0;s<t.length;s++){const l=t[s],i=Y(l)?Cn(l):il(l);if(i)for(const n in i)e[n]=i[n]}return e}else if(Y(t)||B(t))return t}const Gn=/;(?![^(]*\))/g,jn=/:([^]+)/,On=/\/\*[^]*?\*\//g;function Cn(t){const e={};return t.replace(On,"").split(Gn).forEach(s=>{if(s){const l=s.split(jn);l.length>1&&(e[l[0].trim()]=l[1].trim())}}),e}function Tt(t){let e="";if(Y(t))e=t;else if(D(t))for(let s=0;s<t.length;s++){const l=Tt(t[s]);l&&(e+=l+" ")}else if(B(t))for(const s in t)t[s]&&(e+=s+" ");return e.trim()}const Rn="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Wn=tl(Rn);function bi(t){return!!t||t===""}function In(t,e){if(t.length!==e.length)return!1;let s=!0;for(let l=0;s&&l<t.length;l++)s=$e(t[l],e[l]);return s}function $e(t,e){if(t===e)return!0;let s=Sl(t),l=Sl(e);if(s||l)return s&&l?t.getTime()===e.getTime():!1;if(s=zt(t),l=zt(e),s||l)return t===e;if(s=D(t),l=D(e),s||l)return s&&l?In(t,e):!1;if(s=B(t),l=B(e),s||l){if(!s||!l)return!1;const i=Object.keys(t).length,n=Object.keys(e).length;if(i!==n)return!1;for(const r in t){const o=t.hasOwnProperty(r),a=e.hasOwnProperty(r);if(o&&!a||!o&&a||!$e(t[r],e[r]))return!1}}return String(t)===String(e)}function nl(t,e){return t.findIndex(s=>$e(s,e))}const wi=t=>!!(t&&t.__v_isRef===!0),xt=t=>Y(t)?t:t==null?"":D(t)||B(t)&&(t.toString===xi||!C(t.toString))?wi(t)?xt(t.value):JSON.stringify(t,ki,2):String(t),ki=(t,e)=>wi(e)?ki(t,e.value):ce(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((s,[l,i],n)=>(s[Os(l,n)+" =>"]=i,s),{})}:ve(e)?{[`Set(${e.size})`]:[...e.values()].map(s=>Os(s))}:zt(e)?Os(e):B(e)&&!D(e)&&!hi(e)?String(e):e,Os=(t,e="")=>{var s;return zt(t)?`Symbol(${(s=t.description)!=null?s:e})`:t};/**
* @vue/reactivity v3.5.5
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let wt;class Pn{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=wt,!e&&wt&&(this.index=(wt.scopes||(wt.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,s;if(this.scopes)for(e=0,s=this.scopes.length;e<s;e++)this.scopes[e].pause();for(e=0,s=this.effects.length;e<s;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,s;if(this.scopes)for(e=0,s=this.scopes.length;e<s;e++)this.scopes[e].resume();for(e=0,s=this.effects.length;e<s;e++)this.effects[e].resume()}}run(e){if(this._active){const s=wt;try{return wt=this,e()}finally{wt=s}}}on(){wt=this}off(){wt=this.parent}stop(e){if(this._active){let s,l;for(s=0,l=this.effects.length;s<l;s++)this.effects[s].stop();for(s=0,l=this.cleanups.length;s<l;s++)this.cleanups[s]();if(this.scopes)for(s=0,l=this.scopes.length;s<l;s++)this.scopes[s].stop(!0);if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0,this._active=!1}}}function zn(){return wt}let M;const Cs=new WeakSet;class Ai{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.nextEffect=void 0,this.cleanup=void 0,this.scheduler=void 0,wt&&wt.active&&wt.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Cs.has(this)&&(Cs.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||(this.flags|=8,this.nextEffect=Ce,Ce=this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Nl(this),vi(this);const e=M,s=St;M=this,St=!0;try{return this.fn()}finally{yi(this),M=e,St=s,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)al(e);this.deps=this.depsTail=void 0,Nl(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Cs.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Ms(this)&&this.run()}get dirty(){return Ms(this)}}let Ei=0,Ce;function rl(){Ei++}function ol(){if(--Ei>0)return;let t;for(;Ce;){let e=Ce;for(Ce=void 0;e;){const s=e.nextEffect;if(e.nextEffect=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(l){t||(t=l)}e=s}}if(t)throw t}function vi(t){for(let e=t.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function yi(t){let e,s=t.depsTail,l=s;for(;l;){const i=l.prevDep;l.version===-1?(l===s&&(s=i),al(l),Ln(l)):e=l,l.dep.activeLink=l.prevActiveLink,l.prevActiveLink=void 0,l=i}t.deps=e,t.depsTail=s}function Ms(t){for(let e=t.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&Ti(e.dep.computed)||e.dep.version!==e.version)return!0;return!!t._dirty}function Ti(t){if(t.flags&4&&!(t.flags&16)||(t.flags&=-17,t.globalVersion===Pe))return;t.globalVersion=Pe;const e=t.dep;if(t.flags|=2,e.version>0&&!t.isSSR&&!Ms(t)){t.flags&=-3;return}const s=M,l=St;M=t,St=!0;try{vi(t);const i=t.fn(t._value);(e.version===0||de(i,t._value))&&(t._value=i,e.version++)}catch(i){throw e.version++,i}finally{M=s,St=l,yi(t),t.flags&=-3}}function al(t){const{dep:e,prevSub:s,nextSub:l}=t;if(s&&(s.nextSub=l,t.prevSub=void 0),l&&(l.prevSub=s,t.nextSub=void 0),e.subs===t&&(e.subs=s),!e.subs&&e.computed){e.computed.flags&=-5;for(let i=e.computed.deps;i;i=i.nextDep)al(i)}}function Ln(t){const{prevDep:e,nextDep:s}=t;e&&(e.nextDep=s,t.prevDep=void 0),s&&(s.prevDep=e,t.nextDep=void 0)}let St=!0;const Si=[];function te(){Si.push(St),St=!1}function ee(){const t=Si.pop();St=t===void 0?!0:t}function Nl(t){const{cleanup:e}=t;if(t.cleanup=void 0,e){const s=M;M=void 0;try{e()}finally{M=s}}}let Pe=0;class Fn{constructor(e,s){this.sub=e,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Di{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0}track(e){if(!M||!St||M===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==M)s=this.activeLink=new Fn(M,this),M.deps?(s.prevDep=M.depsTail,M.depsTail.nextDep=s,M.depsTail=s):M.deps=M.depsTail=s,M.flags&4&&Ni(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const l=s.nextDep;l.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=l),s.prevDep=M.depsTail,s.nextDep=void 0,M.depsTail.nextDep=s,M.depsTail=s,M.deps===s&&(M.deps=l)}return s}trigger(e){this.version++,Pe++,this.notify(e)}notify(e){rl();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()}finally{ol()}}}function Ni(t){const e=t.dep.computed;if(e&&!t.dep.subs){e.flags|=20;for(let l=e.deps;l;l=l.nextDep)Ni(l)}const s=t.dep.subs;s!==t&&(t.prevSub=s,s&&(s.nextSub=t)),t.dep.subs=t}const Us=new WeakMap,ae=Symbol(""),qs=Symbol(""),ze=Symbol("");function ot(t,e,s){if(St&&M){let l=Us.get(t);l||Us.set(t,l=new Map);let i=l.get(s);i||l.set(s,i=new Di),i.track()}}function Ut(t,e,s,l,i,n){const r=Us.get(t);if(!r){Pe++;return}const o=a=>{a&&a.trigger()};if(rl(),e==="clear")r.forEach(o);else{const a=D(t),_=a&&ll(s);if(a&&s==="length"){const m=Number(l);r.forEach((f,w)=>{(w==="length"||w===ze||!zt(w)&&w>=m)&&o(f)})}else switch(s!==void 0&&o(r.get(s)),_&&o(r.get(ze)),e){case"add":a?_&&o(r.get("length")):(o(r.get(ae)),ce(t)&&o(r.get(qs)));break;case"delete":a||(o(r.get(ae)),ce(t)&&o(r.get(qs)));break;case"set":ce(t)&&o(r.get(ae));break}}ol()}function fe(t){const e=H(t);return e===t?e:(ot(e,"iterate",ze),Dt(t)?e:e.map(ft))}function ks(t){return ot(t=H(t),"iterate",ze),t}const Hn={__proto__:null,[Symbol.iterator](){return Rs(this,Symbol.iterator,ft)},concat(...t){return fe(this).concat(...t.map(e=>D(e)?fe(e):e))},entries(){return Rs(this,"entries",t=>(t[1]=ft(t[1]),t))},every(t,e){return Ft(this,"every",t,e,void 0,arguments)},filter(t,e){return Ft(this,"filter",t,e,s=>s.map(ft),arguments)},find(t,e){return Ft(this,"find",t,e,ft,arguments)},findIndex(t,e){return Ft(this,"findIndex",t,e,void 0,arguments)},findLast(t,e){return Ft(this,"findLast",t,e,ft,arguments)},findLastIndex(t,e){return Ft(this,"findLastIndex",t,e,void 0,arguments)},forEach(t,e){return Ft(this,"forEach",t,e,void 0,arguments)},includes(...t){return Ws(this,"includes",t)},indexOf(...t){return Ws(this,"indexOf",t)},join(t){return fe(this).join(t)},lastIndexOf(...t){return Ws(this,"lastIndexOf",t)},map(t,e){return Ft(this,"map",t,e,void 0,arguments)},pop(){return Ne(this,"pop")},push(...t){return Ne(this,"push",t)},reduce(t,...e){return Gl(this,"reduce",t,e)},reduceRight(t,...e){return Gl(this,"reduceRight",t,e)},shift(){return Ne(this,"shift")},some(t,e){return Ft(this,"some",t,e,void 0,arguments)},splice(...t){return Ne(this,"splice",t)},toReversed(){return fe(this).toReversed()},toSorted(t){return fe(this).toSorted(t)},toSpliced(...t){return fe(this).toSpliced(...t)},unshift(...t){return Ne(this,"unshift",t)},values(){return Rs(this,"values",ft)}};function Rs(t,e,s){const l=ks(t),i=l[e]();return l!==t&&!Dt(t)&&(i._next=i.next,i.next=()=>{const n=i._next();return n.value&&(n.value=s(n.value)),n}),i}const Mn=Array.prototype;function Ft(t,e,s,l,i,n){const r=ks(t),o=r!==t&&!Dt(t),a=r[e];if(a!==Mn[e]){const f=a.apply(t,n);return o?ft(f):f}let _=s;r!==t&&(o?_=function(f,w){return s.call(this,ft(f),w,t)}:s.length>2&&(_=function(f,w){return s.call(this,f,w,t)}));const m=a.call(r,_,l);return o&&i?i(m):m}function Gl(t,e,s,l){const i=ks(t);let n=s;return i!==t&&(Dt(t)?s.length>3&&(n=function(r,o,a){return s.call(this,r,o,a,t)}):n=function(r,o,a){return s.call(this,r,ft(o),a,t)}),i[e](n,...l)}function Ws(t,e,s){const l=H(t);ot(l,"iterate",ze);const i=l[e](...s);return(i===-1||i===!1)&&_l(s[0])?(s[0]=H(s[0]),l[e](...s)):i}function Ne(t,e,s=[]){te(),rl();const l=H(t)[e].apply(t,s);return ol(),ee(),l}const Un=tl("__proto__,__v_isRef,__isVue"),Gi=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(zt));function qn(t){zt(t)||(t=String(t));const e=H(this);return ot(e,"has",t),e.hasOwnProperty(t)}class ji{constructor(e=!1,s=!1){this._isReadonly=e,this._isShallow=s}get(e,s,l){const i=this._isReadonly,n=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return n;if(s==="__v_raw")return l===(i?n?lr:Wi:n?Ri:Ci).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(l)?e:void 0;const r=D(e);if(!i){let a;if(r&&(a=Hn[s]))return a;if(s==="hasOwnProperty")return qn}const o=Reflect.get(e,s,mt(e)?e:l);return(zt(s)?Gi.has(s):Un(s))||(i||ot(e,"get",s),n)?o:mt(o)?r&&ll(s)?o:o.value:B(o)?i?Ii(o):Be(o):o}}class Oi extends ji{constructor(e=!1){super(!1,e)}set(e,s,l,i){let n=e[s];if(!this._isShallow){const a=ke(n);if(!Dt(l)&&!ke(l)&&(n=H(n),l=H(l)),!D(e)&&mt(n)&&!mt(l))return a?!1:(n.value=l,!0)}const r=D(e)&&ll(s)?Number(s)<e.length:L(e,s),o=Reflect.set(e,s,l,mt(e)?e:i);return e===H(i)&&(r?de(l,n)&&Ut(e,"set",s,l):Ut(e,"add",s,l)),o}deleteProperty(e,s){const l=L(e,s);e[s];const i=Reflect.deleteProperty(e,s);return i&&l&&Ut(e,"delete",s,void 0),i}has(e,s){const l=Reflect.has(e,s);return(!zt(s)||!Gi.has(s))&&ot(e,"has",s),l}ownKeys(e){return ot(e,"iterate",D(e)?"length":ae),Reflect.ownKeys(e)}}class $n extends ji{constructor(e=!1){super(!0,e)}set(e,s){return!0}deleteProperty(e,s){return!0}}const Bn=new Oi,Vn=new $n,Kn=new Oi(!0);const ul=t=>t,As=t=>Reflect.getPrototypeOf(t);function ts(t,e,s=!1,l=!1){t=t.__v_raw;const i=H(t),n=H(e);s||(de(e,n)&&ot(i,"get",e),ot(i,"get",n));const{has:r}=As(i),o=l?ul:s?gl:ft;if(r.call(i,e))return o(t.get(e));if(r.call(i,n))return o(t.get(n));t!==i&&t.get(e)}function es(t,e=!1){const s=this.__v_raw,l=H(s),i=H(t);return e||(de(t,i)&&ot(l,"has",t),ot(l,"has",i)),t===i?s.has(t):s.has(t)||s.has(i)}function ss(t,e=!1){return t=t.__v_raw,!e&&ot(H(t),"iterate",ae),Reflect.get(t,"size",t)}function jl(t,e=!1){!e&&!Dt(t)&&!ke(t)&&(t=H(t));const s=H(this);return As(s).has.call(s,t)||(s.add(t),Ut(s,"add",t,t)),this}function Ol(t,e,s=!1){!s&&!Dt(e)&&!ke(e)&&(e=H(e));const l=H(this),{has:i,get:n}=As(l);let r=i.call(l,t);r||(t=H(t),r=i.call(l,t));const o=n.call(l,t);return l.set(t,e),r?de(e,o)&&Ut(l,"set",t,e):Ut(l,"add",t,e),this}function Cl(t){const e=H(this),{has:s,get:l}=As(e);let i=s.call(e,t);i||(t=H(t),i=s.call(e,t)),l&&l.call(e,t);const n=e.delete(t);return i&&Ut(e,"delete",t,void 0),n}function Rl(){const t=H(this),e=t.size!==0,s=t.clear();return e&&Ut(t,"clear",void 0,void 0),s}function ls(t,e){return function(l,i){const n=this,r=n.__v_raw,o=H(r),a=e?ul:t?gl:ft;return!t&&ot(o,"iterate",ae),r.forEach((_,m)=>l.call(i,a(_),a(m),n))}}function is(t,e,s){return function(...l){const i=this.__v_raw,n=H(i),r=ce(n),o=t==="entries"||t===Symbol.iterator&&r,a=t==="keys"&&r,_=i[t](...l),m=s?ul:e?gl:ft;return!e&&ot(n,"iterate",a?qs:ae),{next(){const{value:f,done:w}=_.next();return w?{value:f,done:w}:{value:o?[m(f[0]),m(f[1])]:m(f),done:w}},[Symbol.iterator](){return this}}}}function Kt(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function Jn(){const t={get(n){return ts(this,n)},get size(){return ss(this)},has:es,add:jl,set:Ol,delete:Cl,clear:Rl,forEach:ls(!1,!1)},e={get(n){return ts(this,n,!1,!0)},get size(){return ss(this)},has:es,add(n){return jl.call(this,n,!0)},set(n,r){return Ol.call(this,n,r,!0)},delete:Cl,clear:Rl,forEach:ls(!1,!0)},s={get(n){return ts(this,n,!0)},get size(){return ss(this,!0)},has(n){return es.call(this,n,!0)},add:Kt("add"),set:Kt("set"),delete:Kt("delete"),clear:Kt("clear"),forEach:ls(!0,!1)},l={get(n){return ts(this,n,!0,!0)},get size(){return ss(this,!0)},has(n){return es.call(this,n,!0)},add:Kt("add"),set:Kt("set"),delete:Kt("delete"),clear:Kt("clear"),forEach:ls(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(n=>{t[n]=is(n,!1,!1),s[n]=is(n,!0,!1),e[n]=is(n,!1,!0),l[n]=is(n,!0,!0)}),[t,s,e,l]}const[Qn,Yn,Zn,Xn]=Jn();function dl(t,e){const s=e?t?Xn:Zn:t?Yn:Qn;return(l,i,n)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?l:Reflect.get(L(s,i)&&i in l?s:l,i,n)}const tr={get:dl(!1,!1)},er={get:dl(!1,!0)},sr={get:dl(!0,!1)};const Ci=new WeakMap,Ri=new WeakMap,Wi=new WeakMap,lr=new WeakMap;function ir(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function nr(t){return t.__v_skip||!Object.isExtensible(t)?0:ir(Sn(t))}function Be(t){return ke(t)?t:ml(t,!1,Bn,tr,Ci)}function rr(t){return ml(t,!1,Kn,er,Ri)}function Ii(t){return ml(t,!0,Vn,sr,Wi)}function ml(t,e,s,l,i){if(!B(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const n=i.get(t);if(n)return n;const r=nr(t);if(r===0)return t;const o=new Proxy(t,r===2?l:s);return i.set(t,o),o}function pe(t){return ke(t)?pe(t.__v_raw):!!(t&&t.__v_isReactive)}function ke(t){return!!(t&&t.__v_isReadonly)}function Dt(t){return!!(t&&t.__v_isShallow)}function _l(t){return t?!!t.__v_raw:!1}function H(t){const e=t&&t.__v_raw;return e?H(e):t}function or(t){return!L(t,"__v_skip")&&Object.isExtensible(t)&&ci(t,"__v_skip",!0),t}const ft=t=>B(t)?Be(t):t,gl=t=>B(t)?Ii(t):t;function mt(t){return t?t.__v_isRef===!0:!1}function ar(t){return mt(t)?t.value:t}const ur={get:(t,e,s)=>e==="__v_raw"?t:ar(Reflect.get(t,e,s)),set:(t,e,s,l)=>{const i=t[e];return mt(i)&&!mt(s)?(i.value=s,!0):Reflect.set(t,e,s,l)}};function Pi(t){return pe(t)?t:new Proxy(t,ur)}class dr{constructor(e,s,l){this.fn=e,this.setter=s,this._value=void 0,this.dep=new Di(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Pe-1,this.effect=this,this.__v_isReadonly=!s,this.isSSR=l}notify(){this.flags|=16,M!==this&&this.dep.notify()}get value(){const e=this.dep.track();return Ti(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function mr(t,e,s=!1){let l,i;return C(t)?l=t:(l=t.get,i=t.set),new dr(l,i,s)}const ns={},fs=new WeakMap;let oe;function _r(t,e=!1,s=oe){if(s){let l=fs.get(s);l||fs.set(s,l=[]),l.push(t)}}function gr(t,e,s=U){const{immediate:l,deep:i,once:n,scheduler:r,augmentJob:o,call:a}=s,_=G=>i?G:Dt(G)||i===!1||i===0?Mt(G,1):Mt(G);let m,f,w,N,W=!1,O=!1;if(mt(t)?(f=()=>t.value,W=Dt(t)):pe(t)?(f=()=>_(t),W=!0):D(t)?(O=!0,W=t.some(G=>pe(G)||Dt(G)),f=()=>t.map(G=>{if(mt(G))return G.value;if(pe(G))return _(G);if(C(G))return a?a(G,2):G()})):C(t)?e?f=a?()=>a(t,2):t:f=()=>{if(w){te();try{w()}finally{ee()}}const G=oe;oe=m;try{return a?a(t,3,[N]):t(N)}finally{oe=G}}:f=Pt,e&&i){const G=f,X=i===!0?1/0:i;f=()=>Mt(G(),X)}const Z=zn(),z=()=>{m.stop(),Z&&sl(Z.effects,m)};if(n)if(e){const G=e;e=(...X)=>{G(...X),z()}}else{const G=f;f=()=>{G(),z()}}let J=O?new Array(t.length).fill(ns):ns;const Q=G=>{if(!(!(m.flags&1)||!m.dirty&&!G))if(e){const X=m.run();if(i||W||(O?X.some((Bt,Gt)=>de(Bt,J[Gt])):de(X,J))){w&&w();const Bt=oe;oe=m;try{const Gt=[X,J===ns?void 0:O&&J[0]===ns?[]:J,N];a?a(e,3,Gt):e(...Gt),J=X}finally{oe=Bt}}}else m.run()};return o&&o(Q),m=new Ai(f),m.scheduler=r?()=>r(Q,!1):Q,N=G=>_r(G,!1,m),w=m.onStop=()=>{const G=fs.get(m);if(G){if(a)a(G,4);else for(const X of G)X();fs.delete(m)}},e?l?Q(!0):J=m.run():r?r(Q.bind(null,!0),!0):m.run(),z.pause=m.pause.bind(m),z.resume=m.resume.bind(m),z.stop=z,z}function Mt(t,e=1/0,s){if(e<=0||!B(t)||t.__v_skip||(s=s||new Set,s.has(t)))return t;if(s.add(t),e--,mt(t))Mt(t.value,e,s);else if(D(t))for(let l=0;l<t.length;l++)Mt(t[l],e,s);else if(ve(t)||ce(t))t.forEach(l=>{Mt(l,e,s)});else if(hi(t)){for(const l in t)Mt(t[l],e,s);for(const l of Object.getOwnPropertySymbols(t))Object.prototype.propertyIsEnumerable.call(t,l)&&Mt(t[l],e,s)}return t}/**
* @vue/runtime-core v3.5.5
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ve(t,e,s,l){try{return l?t(...l):t()}catch(i){Es(i,e,s)}}function Lt(t,e,s,l){if(C(t)){const i=Ve(t,e,s,l);return i&&fi(i)&&i.catch(n=>{Es(n,e,s)}),i}if(D(t)){const i=[];for(let n=0;n<t.length;n++)i.push(Lt(t[n],e,s,l));return i}}function Es(t,e,s,l=!0){const i=e?e.vnode:null,{errorHandler:n,throwUnhandledErrorInProduction:r}=e&&e.appContext.config||U;if(e){let o=e.parent;const a=e.proxy,_=`https://vuejs.org/error-reference/#runtime-${s}`;for(;o;){const m=o.ec;if(m){for(let f=0;f<m.length;f++)if(m[f](t,a,_)===!1)return}o=o.parent}if(n){te(),Ve(n,null,10,[t,a,_]),ee();return}}fr(t,s,i,l,r)}function fr(t,e,s,l=!0,i=!1){if(i)throw t;console.error(t)}let Le=!1,$s=!1;const dt=[];let Rt=0;const be=[];let Qt=null,xe=0;const zi=Promise.resolve();let fl=null;function Li(t){const e=fl||zi;return t?e.then(this?t.bind(this):t):e}function xr(t){let e=Le?Rt+1:0,s=dt.length;for(;e<s;){const l=e+s>>>1,i=dt[l],n=Fe(i);n<t||n===t&&i.flags&2?e=l+1:s=l}return e}function xl(t){if(!(t.flags&1)){const e=Fe(t),s=dt[dt.length-1];!s||!(t.flags&2)&&e>=Fe(s)?dt.push(t):dt.splice(xr(e),0,t),t.flags|=1,Fi()}}function Fi(){!Le&&!$s&&($s=!0,fl=zi.then(Mi))}function hr(t){D(t)?be.push(...t):Qt&&t.id===-1?Qt.splice(xe+1,0,t):t.flags&1||(be.push(t),t.flags|=1),Fi()}function Wl(t,e,s=Le?Rt+1:0){for(;s<dt.length;s++){const l=dt[s];if(l&&l.flags&2){if(t&&l.id!==t.uid)continue;dt.splice(s,1),s--,l.flags&4&&(l.flags&=-2),l(),l.flags&=-2}}}function Hi(t){if(be.length){const e=[...new Set(be)].sort((s,l)=>Fe(s)-Fe(l));if(be.length=0,Qt){Qt.push(...e);return}for(Qt=e,xe=0;xe<Qt.length;xe++){const s=Qt[xe];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}Qt=null,xe=0}}const Fe=t=>t.id==null?t.flags&2?-1:1/0:t.id;function Mi(t){$s=!1,Le=!0;try{for(Rt=0;Rt<dt.length;Rt++){const e=dt[Rt];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),Ve(e,e.i,e.i?15:14),e.flags&=-2)}}finally{for(;Rt<dt.length;Rt++){const e=dt[Rt];e&&(e.flags&=-2)}Rt=0,dt.length=0,Hi(),Le=!1,fl=null,(dt.length||be.length)&&Mi()}}let At=null,Ui=null;function xs(t){const e=At;return At=t,Ui=t&&t.type.__scopeId||null,e}function cr(t,e=At,s){if(!e||t._n)return t;const l=(...i)=>{l._d&&ql(-1);const n=xs(e);let r;try{r=t(...i)}finally{xs(n),l._d&&ql(1)}return r};return l._n=!0,l._c=!0,l._d=!0,l}function kt(t,e){if(At===null)return t;const s=Ds(At),l=t.dirs||(t.dirs=[]);for(let i=0;i<e.length;i++){let[n,r,o,a=U]=e[i];n&&(C(n)&&(n={mounted:n,updated:n}),n.deep&&Mt(r),l.push({dir:n,instance:s,value:r,oldValue:void 0,arg:o,modifiers:a}))}return t}function ne(t,e,s,l){const i=t.dirs,n=e&&e.dirs;for(let r=0;r<i.length;r++){const o=i[r];n&&(o.oldValue=n[r].value);let a=o.dir[l];a&&(te(),Lt(a,s,8,[t.el,o,t,e]),ee())}}const pr=Symbol("_vte"),br=t=>t.__isTeleport;function hl(t,e){t.shapeFlag&6&&t.component?(t.transition=e,hl(t.component.subTree,e)):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function qi(t){t.ids=[t.ids[0]+t.ids[2]+++"-",0,0]}function Bs(t,e,s,l,i=!1){if(D(t)){t.forEach((W,O)=>Bs(W,e&&(D(e)?e[O]:e),s,l,i));return}if(Re(l)&&!i)return;const n=l.shapeFlag&4?Ds(l.component):l.el,r=i?null:n,{i:o,r:a}=t,_=e&&e.r,m=o.refs===U?o.refs={}:o.refs,f=o.setupState,w=H(f),N=f===U?()=>!1:W=>L(w,W);if(_!=null&&_!==a&&(Y(_)?(m[_]=null,N(_)&&(f[_]=null)):mt(_)&&(_.value=null)),C(a))Ve(a,o,12,[r,m]);else{const W=Y(a),O=mt(a);if(W||O){const Z=()=>{if(t.f){const z=W?N(a)?f[a]:m[a]:a.value;i?D(z)&&sl(z,n):D(z)?z.includes(n)||z.push(n):W?(m[a]=[n],N(a)&&(f[a]=m[a])):(a.value=[n],t.k&&(m[t.k]=a.value))}else W?(m[a]=r,N(a)&&(f[a]=r)):O&&(a.value=r,t.k&&(m[t.k]=r))};r?(Z.id=-1,bt(Z,s)):Z()}}}const Re=t=>!!t.type.__asyncLoader,$i=t=>t.type.__isKeepAlive;function wr(t,e){Bi(t,"a",e)}function kr(t,e){Bi(t,"da",e)}function Bi(t,e,s=it){const l=t.__wdc||(t.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(vs(e,l,s),s){let i=s.parent;for(;i&&i.parent;)$i(i.parent.vnode)&&Ar(l,e,s,i),i=i.parent}}function Ar(t,e,s,l){const i=vs(e,t,l,!0);Vi(()=>{sl(l[e],i)},s)}function vs(t,e,s=it,l=!1){if(s){const i=s[t]||(s[t]=[]),n=e.__weh||(e.__weh=(...r)=>{te();const o=Ke(s),a=Lt(e,s,t,r);return o(),ee(),a});return l?i.unshift(n):i.push(n),n}}const $t=t=>(e,s=it)=>{(!Ss||t==="sp")&&vs(t,(...l)=>e(...l),s)},Er=$t("bm"),vr=$t("m"),yr=$t("bu"),Tr=$t("u"),Sr=$t("bum"),Vi=$t("um"),Dr=$t("sp"),Nr=$t("rtg"),Gr=$t("rtc");function jr(t,e=it){vs("ec",t,e)}const Ki="components";function gt(t,e){return Cr(Ki,t,!0,e)||t}const Or=Symbol.for("v-ndc");function Cr(t,e,s=!0,l=!1){const i=At||it;if(i){const n=i.type;if(t===Ki){const o=Eo(n,!1);if(o&&(o===e||o===Nt(e)||o===ws(Nt(e))))return n}const r=Il(i[t]||n[t],e)||Il(i.appContext[t],e);return!r&&l?n:r}}function Il(t,e){return t&&(t[e]||t[Nt(e)]||t[ws(Nt(e))])}function ue(t,e,s,l){let i;const n=s,r=D(t);if(r||Y(t)){const o=r&&pe(t);let a=!1;o&&(a=!Dt(t),t=ks(t)),i=new Array(t.length);for(let _=0,m=t.length;_<m;_++)i[_]=e(a?ft(t[_]):t[_],_,void 0,n)}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,n)}else if(B(t))if(t[Symbol.iterator])i=Array.from(t,(o,a)=>e(o,a,void 0,n));else{const o=Object.keys(t);i=new Array(o.length);for(let a=0,_=o.length;a<_;a++){const m=o[a];i[a]=e(t[m],m,a,n)}}else i=[];return i}const Vs=t=>t?xn(t)?Ds(t):Vs(t.parent):null,We=rt(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Vs(t.parent),$root:t=>Vs(t.root),$host:t=>t.ce,$emit:t=>t.emit,$options:t=>cl(t),$forceUpdate:t=>t.f||(t.f=()=>{xl(t.update)}),$nextTick:t=>t.n||(t.n=Li.bind(t.proxy)),$watch:t=>eo.bind(t)}),Is=(t,e)=>t!==U&&!t.__isScriptSetup&&L(t,e),Rr={get({_:t},e){if(e==="__v_skip")return!0;const{ctx:s,setupState:l,data:i,props:n,accessCache:r,type:o,appContext:a}=t;let _;if(e[0]!=="$"){const N=r[e];if(N!==void 0)switch(N){case 1:return l[e];case 2:return i[e];case 4:return s[e];case 3:return n[e]}else{if(Is(l,e))return r[e]=1,l[e];if(i!==U&&L(i,e))return r[e]=2,i[e];if((_=t.propsOptions[0])&&L(_,e))return r[e]=3,n[e];if(s!==U&&L(s,e))return r[e]=4,s[e];Ks&&(r[e]=0)}}const m=We[e];let f,w;if(m)return e==="$attrs"&&ot(t.attrs,"get",""),m(t);if((f=o.__cssModules)&&(f=f[e]))return f;if(s!==U&&L(s,e))return r[e]=4,s[e];if(w=a.config.globalProperties,L(w,e))return w[e]},set({_:t},e,s){const{data:l,setupState:i,ctx:n}=t;return Is(i,e)?(i[e]=s,!0):l!==U&&L(l,e)?(l[e]=s,!0):L(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(n[e]=s,!0)},has({_:{data:t,setupState:e,accessCache:s,ctx:l,appContext:i,propsOptions:n}},r){let o;return!!s[r]||t!==U&&L(t,r)||Is(e,r)||(o=n[0])&&L(o,r)||L(l,r)||L(We,r)||L(i.config.globalProperties,r)},defineProperty(t,e,s){return s.get!=null?t._.accessCache[e]=0:L(s,"value")&&this.set(t,e,s.value,null),Reflect.defineProperty(t,e,s)}};function Pl(t){return D(t)?t.reduce((e,s)=>(e[s]=null,e),{}):t}let Ks=!0;function Wr(t){const e=cl(t),s=t.proxy,l=t.ctx;Ks=!1,e.beforeCreate&&zl(e.beforeCreate,t,"bc");const{data:i,computed:n,methods:r,watch:o,provide:a,inject:_,created:m,beforeMount:f,mounted:w,beforeUpdate:N,updated:W,activated:O,deactivated:Z,beforeDestroy:z,beforeUnmount:J,destroyed:Q,unmounted:G,render:X,renderTracked:Bt,renderTriggered:Gt,errorCaptured:Vt,serverPrefetch:Je,expose:se,inheritAttrs:ye,components:Qe,directives:Ye,filters:Ns}=e;if(_&&Ir(_,l,null),r)for(const V in r){const q=r[V];C(q)&&(l[V]=q.bind(s))}if(i){const V=i.call(s,s);B(V)&&(t.data=Be(V))}if(Ks=!0,n)for(const V in n){const q=n[V],le=C(q)?q.bind(s,s):C(q.get)?q.get.bind(s,s):Pt,Ze=!C(q)&&C(q.set)?q.set.bind(s):Pt,ie=yo({get:le,set:Ze});Object.defineProperty(l,V,{enumerable:!0,configurable:!0,get:()=>ie.value,set:jt=>ie.value=jt})}if(o)for(const V in o)Ji(o[V],l,s,V);if(a){const V=C(a)?a.call(s):a;Reflect.ownKeys(V).forEach(q=>{Mr(q,V[q])})}m&&zl(m,t,"c");function at(V,q){D(q)?q.forEach(le=>V(le.bind(s))):q&&V(q.bind(s))}if(at(Er,f),at(vr,w),at(yr,N),at(Tr,W),at(wr,O),at(kr,Z),at(jr,Vt),at(Gr,Bt),at(Nr,Gt),at(Sr,J),at(Vi,G),at(Dr,Je),D(se))if(se.length){const V=t.exposed||(t.exposed={});se.forEach(q=>{Object.defineProperty(V,q,{get:()=>s[q],set:le=>s[q]=le})})}else t.exposed||(t.exposed={});X&&t.render===Pt&&(t.render=X),ye!=null&&(t.inheritAttrs=ye),Qe&&(t.components=Qe),Ye&&(t.directives=Ye),Je&&qi(t)}function Ir(t,e,s=Pt){D(t)&&(t=Js(t));for(const l in t){const i=t[l];let n;B(i)?"default"in i?n=as(i.from||l,i.default,!0):n=as(i.from||l):n=as(i),mt(n)?Object.defineProperty(e,l,{enumerable:!0,configurable:!0,get:()=>n.value,set:r=>n.value=r}):e[l]=n}}function zl(t,e,s){Lt(D(t)?t.map(l=>l.bind(e.proxy)):t.bind(e.proxy),e,s)}function Ji(t,e,s,l){let i=l.includes(".")?dn(s,l):()=>s[l];if(Y(t)){const n=e[t];C(n)&&us(i,n)}else if(C(t))us(i,t.bind(s));else if(B(t))if(D(t))t.forEach(n=>Ji(n,e,s,l));else{const n=C(t.handler)?t.handler.bind(s):e[t.handler];C(n)&&us(i,n,t)}}function cl(t){const e=t.type,{mixins:s,extends:l}=e,{mixins:i,optionsCache:n,config:{optionMergeStrategies:r}}=t.appContext,o=n.get(e);let a;return o?a=o:!i.length&&!s&&!l?a=e:(a={},i.length&&i.forEach(_=>hs(a,_,r,!0)),hs(a,e,r)),B(e)&&n.set(e,a),a}function hs(t,e,s,l=!1){const{mixins:i,extends:n}=e;n&&hs(t,n,s,!0),i&&i.forEach(r=>hs(t,r,s,!0));for(const r in e)if(!(l&&r==="expose")){const o=Pr[r]||s&&s[r];t[r]=o?o(t[r],e[r]):e[r]}return t}const Pr={data:Ll,props:Fl,emits:Fl,methods:je,computed:je,beforeCreate:ut,created:ut,beforeMount:ut,mounted:ut,beforeUpdate:ut,updated:ut,beforeDestroy:ut,beforeUnmount:ut,destroyed:ut,unmounted:ut,activated:ut,deactivated:ut,errorCaptured:ut,serverPrefetch:ut,components:je,directives:je,watch:Lr,provide:Ll,inject:zr};function Ll(t,e){return e?t?function(){return rt(C(t)?t.call(this,this):t,C(e)?e.call(this,this):e)}:e:t}function zr(t,e){return je(Js(t),Js(e))}function Js(t){if(D(t)){const e={};for(let s=0;s<t.length;s++)e[t[s]]=t[s];return e}return t}function ut(t,e){return t?[...new Set([].concat(t,e))]:e}function je(t,e){return t?rt(Object.create(null),t,e):e}function Fl(t,e){return t?D(t)&&D(e)?[...new Set([...t,...e])]:rt(Object.create(null),Pl(t),Pl(e??{})):e}function Lr(t,e){if(!t)return e;if(!e)return t;const s=rt(Object.create(null),t);for(const l in e)s[l]=ut(t[l],e[l]);return s}function Qi(){return{app:null,config:{isNativeTag:yn,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Fr=0;function Hr(t,e){return function(l,i=null){C(l)||(l=rt({},l)),i!=null&&!B(i)&&(i=null);const n=Qi(),r=new WeakSet,o=[];let a=!1;const _=n.app={_uid:Fr++,_component:l,_props:i,_container:null,_context:n,_instance:null,version:To,get config(){return n.config},set config(m){},use(m,...f){return r.has(m)||(m&&C(m.install)?(r.add(m),m.install(_,...f)):C(m)&&(r.add(m),m(_,...f))),_},mixin(m){return n.mixins.includes(m)||n.mixins.push(m),_},component(m,f){return f?(n.components[m]=f,_):n.components[m]},directive(m,f){return f?(n.directives[m]=f,_):n.directives[m]},mount(m,f,w){if(!a){const N=_._ceVNode||tt(l,i);return N.appContext=n,w===!0?w="svg":w===!1&&(w=void 0),f&&e?e(N,m):t(N,m,w),a=!0,_._container=m,m.__vue_app__=_,Ds(N.component)}},onUnmount(m){o.push(m)},unmount(){a&&(Lt(o,_._instance,16),t(null,_._container),delete _._container.__vue_app__)},provide(m,f){return n.provides[m]=f,_},runWithContext(m){const f=we;we=_;try{return m()}finally{we=f}}};return _}}let we=null;function Mr(t,e){if(it){let s=it.provides;const l=it.parent&&it.parent.provides;l===s&&(s=it.provides=Object.create(l)),s[t]=e}}function as(t,e,s=!1){const l=it||At;if(l||we){const i=we?we._context.provides:l?l.parent==null?l.vnode.appContext&&l.vnode.appContext.provides:l.parent.provides:void 0;if(i&&t in i)return i[t];if(arguments.length>1)return s&&C(e)?e.call(l&&l.proxy):e}}const Yi={},Zi=()=>Object.create(Yi),Xi=t=>Object.getPrototypeOf(t)===Yi;function Ur(t,e,s,l=!1){const i={},n=Zi();t.propsDefaults=Object.create(null),tn(t,e,i,n);for(const r in t.propsOptions[0])r in i||(i[r]=void 0);s?t.props=l?i:rr(i):t.type.props?t.props=i:t.props=n,t.attrs=n}function qr(t,e,s,l){const{props:i,attrs:n,vnode:{patchFlag:r}}=t,o=H(i),[a]=t.propsOptions;let _=!1;if((l||r>0)&&!(r&16)){if(r&8){const m=t.vnode.dynamicProps;for(let f=0;f<m.length;f++){let w=m[f];if(ys(t.emitsOptions,w))continue;const N=e[w];if(a)if(L(n,w))N!==n[w]&&(n[w]=N,_=!0);else{const W=Nt(w);i[W]=Qs(a,o,W,N,t,!1)}else N!==n[w]&&(n[w]=N,_=!0)}}}else{tn(t,e,i,n)&&(_=!0);let m;for(const f in o)(!e||!L(e,f)&&((m=ge(f))===f||!L(e,m)))&&(a?s&&(s[f]!==void 0||s[m]!==void 0)&&(i[f]=Qs(a,o,f,void 0,t,!0)):delete i[f]);if(n!==o)for(const f in n)(!e||!L(e,f))&&(delete n[f],_=!0)}_&&Ut(t.attrs,"set","")}function tn(t,e,s,l){const[i,n]=t.propsOptions;let r=!1,o;if(e)for(let a in e){if(Oe(a))continue;const _=e[a];let m;i&&L(i,m=Nt(a))?!n||!n.includes(m)?s[m]=_:(o||(o={}))[m]=_:ys(t.emitsOptions,a)||(!(a in l)||_!==l[a])&&(l[a]=_,r=!0)}if(n){const a=H(s),_=o||U;for(let m=0;m<n.length;m++){const f=n[m];s[f]=Qs(i,a,f,_[f],t,!L(_,f))}}return r}function Qs(t,e,s,l,i,n){const r=t[s];if(r!=null){const o=L(r,"default");if(o&&l===void 0){const a=r.default;if(r.type!==Function&&!r.skipFactory&&C(a)){const{propsDefaults:_}=i;if(s in _)l=_[s];else{const m=Ke(i);l=_[s]=a.call(null,e),m()}}else l=a;i.ce&&i.ce._setProp(s,l)}r[0]&&(n&&!o?l=!1:r[1]&&(l===""||l===ge(s))&&(l=!0))}return l}const $r=new WeakMap;function en(t,e,s=!1){const l=s?$r:e.propsCache,i=l.get(t);if(i)return i;const n=t.props,r={},o=[];let a=!1;if(!C(t)){const m=f=>{a=!0;const[w,N]=en(f,e,!0);rt(r,w),N&&o.push(...N)};!s&&e.mixins.length&&e.mixins.forEach(m),t.extends&&m(t.extends),t.mixins&&t.mixins.forEach(m)}if(!n&&!a)return B(t)&&l.set(t,he),he;if(D(n))for(let m=0;m<n.length;m++){const f=Nt(n[m]);Hl(f)&&(r[f]=U)}else if(n)for(const m in n){const f=Nt(m);if(Hl(f)){const w=n[m],N=r[f]=D(w)||C(w)?{type:w}:rt({},w),W=N.type;let O=!1,Z=!0;if(D(W))for(let z=0;z<W.length;++z){const J=W[z],Q=C(J)&&J.name;if(Q==="Boolean"){O=!0;break}else Q==="String"&&(Z=!1)}else O=C(W)&&W.name==="Boolean";N[0]=O,N[1]=Z,(O||L(N,"default"))&&o.push(f)}}const _=[r,o];return B(t)&&l.set(t,_),_}function Hl(t){return t[0]!=="$"&&!Oe(t)}const sn=t=>t[0]==="_"||t==="$stable",pl=t=>D(t)?t.map(Wt):[Wt(t)],Br=(t,e,s)=>{if(e._n)return e;const l=cr((...i)=>pl(e(...i)),s);return l._c=!1,l},ln=(t,e,s)=>{const l=t._ctx;for(const i in t){if(sn(i))continue;const n=t[i];if(C(n))e[i]=Br(i,n,l);else if(n!=null){const r=pl(n);e[i]=()=>r}}},nn=(t,e)=>{const s=pl(e);t.slots.default=()=>s},rn=(t,e,s)=>{for(const l in e)(s||l!=="_")&&(t[l]=e[l])},Vr=(t,e,s)=>{const l=t.slots=Zi();if(t.vnode.shapeFlag&32){const i=e._;i?(rn(l,e,s),s&&ci(l,"_",i,!0)):ln(e,l)}else e&&nn(t,e)},Kr=(t,e,s)=>{const{vnode:l,slots:i}=t;let n=!0,r=U;if(l.shapeFlag&32){const o=e._;o?s&&o===1?n=!1:rn(i,e,s):(n=!e.$stable,ln(e,i)),r=e}else e&&(nn(t,e),r={default:1});if(n)for(const o in i)!sn(o)&&r[o]==null&&delete i[o]},bt=ao;function Jr(t){return Qr(t)}function Qr(t,e){const s=pi();s.__VUE__=!0;const{insert:l,remove:i,patchProp:n,createElement:r,createText:o,createComment:a,setText:_,setElementText:m,parentNode:f,nextSibling:w,setScopeId:N=Pt,insertStaticContent:W}=t,O=(u,d,g,p=null,h=null,c=null,E=void 0,A=null,k=!!d.dynamicChildren)=>{if(u===d)return;u&&!Ge(u,d)&&(p=Xe(u),jt(u,h,c,!0),u=null),d.patchFlag===-2&&(k=!1,d.dynamicChildren=null);const{type:b,ref:S,shapeFlag:v}=d;switch(b){case Ts:Z(u,d,g,p);break;case me:z(u,d,g,p);break;case ds:u==null&&J(d,g,p,E);break;case K:Qe(u,d,g,p,h,c,E,A,k);break;default:v&1?X(u,d,g,p,h,c,E,A,k):v&6?Ye(u,d,g,p,h,c,E,A,k):(v&64||v&128)&&b.process(u,d,g,p,h,c,E,A,k,Se)}S!=null&&h&&Bs(S,u&&u.ref,c,d||u,!d)},Z=(u,d,g,p)=>{if(u==null)l(d.el=o(d.children),g,p);else{const h=d.el=u.el;d.children!==u.children&&_(h,d.children)}},z=(u,d,g,p)=>{u==null?l(d.el=a(d.children||""),g,p):d.el=u.el},J=(u,d,g,p)=>{[u.el,u.anchor]=W(u.children,d,g,p,u.el,u.anchor)},Q=({el:u,anchor:d},g,p)=>{let h;for(;u&&u!==d;)h=w(u),l(u,g,p),u=h;l(d,g,p)},G=({el:u,anchor:d})=>{let g;for(;u&&u!==d;)g=w(u),i(u),u=g;i(d)},X=(u,d,g,p,h,c,E,A,k)=>{d.type==="svg"?E="svg":d.type==="math"&&(E="mathml"),u==null?Bt(d,g,p,h,c,E,A,k):Je(u,d,h,c,E,A,k)},Bt=(u,d,g,p,h,c,E,A)=>{let k,b;const{props:S,shapeFlag:v,transition:y,dirs:j}=u;if(k=u.el=r(u.type,c,S&&S.is,S),v&8?m(k,u.children):v&16&&Vt(u.children,k,null,p,h,Ps(u,c),E,A),j&&ne(u,null,p,"created"),Gt(k,u,u.scopeId,E,p),S){for(const $ in S)$!=="value"&&!Oe($)&&n(k,$,null,S[$],c,p);"value"in S&&n(k,"value",null,S.value,c),(b=S.onVnodeBeforeMount)&&Ct(b,p,u)}j&&ne(u,null,p,"beforeMount");const I=Yr(h,y);I&&y.beforeEnter(k),l(k,d,g),((b=S&&S.onVnodeMounted)||I||j)&&bt(()=>{b&&Ct(b,p,u),I&&y.enter(k),j&&ne(u,null,p,"mounted")},h)},Gt=(u,d,g,p,h)=>{if(g&&N(u,g),p)for(let c=0;c<p.length;c++)N(u,p[c]);if(h){let c=h.subTree;if(d===c||_n(c.type)&&(c.ssContent===d||c.ssFallback===d)){const E=h.vnode;Gt(u,E,E.scopeId,E.slotScopeIds,h.parent)}}},Vt=(u,d,g,p,h,c,E,A,k=0)=>{for(let b=k;b<u.length;b++){const S=u[b]=A?Yt(u[b]):Wt(u[b]);O(null,S,d,g,p,h,c,E,A)}},Je=(u,d,g,p,h,c,E)=>{const A=d.el=u.el;let{patchFlag:k,dynamicChildren:b,dirs:S}=d;k|=u.patchFlag&16;const v=u.props||U,y=d.props||U;let j;if(g&&re(g,!1),(j=y.onVnodeBeforeUpdate)&&Ct(j,g,d,u),S&&ne(d,u,g,"beforeUpdate"),g&&re(g,!0),(v.innerHTML&&y.innerHTML==null||v.textContent&&y.textContent==null)&&m(A,""),b?se(u.dynamicChildren,b,A,g,p,Ps(d,h),c):E||q(u,d,A,null,g,p,Ps(d,h),c,!1),k>0){if(k&16)ye(A,v,y,g,h);else if(k&2&&v.class!==y.class&&n(A,"class",null,y.class,h),k&4&&n(A,"style",v.style,y.style,h),k&8){const I=d.dynamicProps;for(let $=0;$<I.length;$++){const F=I[$],ht=v[F],lt=y[F];(lt!==ht||F==="value")&&n(A,F,ht,lt,h,g)}}k&1&&u.children!==d.children&&m(A,d.children)}else!E&&b==null&&ye(A,v,y,g,h);((j=y.onVnodeUpdated)||S)&&bt(()=>{j&&Ct(j,g,d,u),S&&ne(d,u,g,"updated")},p)},se=(u,d,g,p,h,c,E)=>{for(let A=0;A<d.length;A++){const k=u[A],b=d[A],S=k.el&&(k.type===K||!Ge(k,b)||k.shapeFlag&70)?f(k.el):g;O(k,b,S,null,p,h,c,E,!0)}},ye=(u,d,g,p,h)=>{if(d!==g){if(d!==U)for(const c in d)!Oe(c)&&!(c in g)&&n(u,c,d[c],null,h,p);for(const c in g){if(Oe(c))continue;const E=g[c],A=d[c];E!==A&&c!=="value"&&n(u,c,A,E,h,p)}"value"in g&&n(u,"value",d.value,g.value,h)}},Qe=(u,d,g,p,h,c,E,A,k)=>{const b=d.el=u?u.el:o(""),S=d.anchor=u?u.anchor:o("");let{patchFlag:v,dynamicChildren:y,slotScopeIds:j}=d;j&&(A=A?A.concat(j):j),u==null?(l(b,g,p),l(S,g,p),Vt(d.children||[],g,S,h,c,E,A,k)):v>0&&v&64&&y&&u.dynamicChildren?(se(u.dynamicChildren,y,g,h,c,E,A),(d.key!=null||h&&d===h.subTree)&&on(u,d,!0)):q(u,d,g,S,h,c,E,A,k)},Ye=(u,d,g,p,h,c,E,A,k)=>{d.slotScopeIds=A,u==null?d.shapeFlag&512?h.ctx.activate(d,g,p,E,k):Ns(d,g,p,h,c,E,k):wl(u,d,k)},Ns=(u,d,g,p,h,c,E)=>{const A=u.component=po(u,p,h);if($i(u)&&(A.ctx.renderer=Se),bo(A,!1,E),A.asyncDep){if(h&&h.registerDep(A,at,E),!u.el){const k=A.subTree=tt(me);z(null,k,d,g)}}else at(A,u,d,g,h,c,E)},wl=(u,d,g)=>{const p=d.component=u.component;if(ro(u,d,g))if(p.asyncDep&&!p.asyncResolved){V(p,d,g);return}else p.next=d,p.update();else d.el=u.el,p.vnode=d},at=(u,d,g,p,h,c,E)=>{const A=()=>{if(u.isMounted){let{next:v,bu:y,u:j,parent:I,vnode:$}=u;{const ct=an(u);if(ct){v&&(v.el=$.el,V(u,v,E)),ct.asyncDep.then(()=>{u.isUnmounted||A()});return}}let F=v,ht;re(u,!1),v?(v.el=$.el,V(u,v,E)):v=$,y&&os(y),(ht=v.props&&v.props.onVnodeBeforeUpdate)&&Ct(ht,I,v,$),re(u,!0);const lt=zs(u),vt=u.subTree;u.subTree=lt,O(vt,lt,f(vt.el),Xe(vt),u,h,c),v.el=lt.el,F===null&&oo(u,lt.el),j&&bt(j,h),(ht=v.props&&v.props.onVnodeUpdated)&&bt(()=>Ct(ht,I,v,$),h)}else{let v;const{el:y,props:j}=d,{bm:I,m:$,parent:F,root:ht,type:lt}=u,vt=Re(d);if(re(u,!1),I&&os(I),!vt&&(v=j&&j.onVnodeBeforeMount)&&Ct(v,F,d),re(u,!0),y&&vl){const ct=()=>{u.subTree=zs(u),vl(y,u.subTree,u,h,null)};vt&&lt.__asyncHydrate?lt.__asyncHydrate(y,u,ct):ct()}else{ht.ce&&ht.ce._injectChildStyle(lt);const ct=u.subTree=zs(u);O(null,ct,g,p,u,h,c),d.el=ct.el}if($&&bt($,h),!vt&&(v=j&&j.onVnodeMounted)){const ct=d;bt(()=>Ct(v,F,ct),h)}(d.shapeFlag&256||F&&Re(F.vnode)&&F.vnode.shapeFlag&256)&&u.a&&bt(u.a,h),u.isMounted=!0,d=g=p=null}};u.scope.on();const k=u.effect=new Ai(A);u.scope.off();const b=u.update=k.run.bind(k),S=u.job=k.runIfDirty.bind(k);S.i=u,S.id=u.uid,k.scheduler=()=>xl(S),re(u,!0),b()},V=(u,d,g)=>{d.component=u;const p=u.vnode.props;u.vnode=d,u.next=null,qr(u,d.props,p,g),Kr(u,d.children,g),te(),Wl(u),ee()},q=(u,d,g,p,h,c,E,A,k=!1)=>{const b=u&&u.children,S=u?u.shapeFlag:0,v=d.children,{patchFlag:y,shapeFlag:j}=d;if(y>0){if(y&128){Ze(b,v,g,p,h,c,E,A,k);return}else if(y&256){le(b,v,g,p,h,c,E,A,k);return}}j&8?(S&16&&Te(b,h,c),v!==b&&m(g,v)):S&16?j&16?Ze(b,v,g,p,h,c,E,A,k):Te(b,h,c,!0):(S&8&&m(g,""),j&16&&Vt(v,g,p,h,c,E,A,k))},le=(u,d,g,p,h,c,E,A,k)=>{u=u||he,d=d||he;const b=u.length,S=d.length,v=Math.min(b,S);let y;for(y=0;y<v;y++){const j=d[y]=k?Yt(d[y]):Wt(d[y]);O(u[y],j,g,null,h,c,E,A,k)}b>S?Te(u,h,c,!0,!1,v):Vt(d,g,p,h,c,E,A,k,v)},Ze=(u,d,g,p,h,c,E,A,k)=>{let b=0;const S=d.length;let v=u.length-1,y=S-1;for(;b<=v&&b<=y;){const j=u[b],I=d[b]=k?Yt(d[b]):Wt(d[b]);if(Ge(j,I))O(j,I,g,null,h,c,E,A,k);else break;b++}for(;b<=v&&b<=y;){const j=u[v],I=d[y]=k?Yt(d[y]):Wt(d[y]);if(Ge(j,I))O(j,I,g,null,h,c,E,A,k);else break;v--,y--}if(b>v){if(b<=y){const j=y+1,I=j<S?d[j].el:p;for(;b<=y;)O(null,d[b]=k?Yt(d[b]):Wt(d[b]),g,I,h,c,E,A,k),b++}}else if(b>y)for(;b<=v;)jt(u[b],h,c,!0),b++;else{const j=b,I=b,$=new Map;for(b=I;b<=y;b++){const pt=d[b]=k?Yt(d[b]):Wt(d[b]);pt.key!=null&&$.set(pt.key,b)}let F,ht=0;const lt=y-I+1;let vt=!1,ct=0;const De=new Array(lt);for(b=0;b<lt;b++)De[b]=0;for(b=j;b<=v;b++){const pt=u[b];if(ht>=lt){jt(pt,h,c,!0);continue}let Ot;if(pt.key!=null)Ot=$.get(pt.key);else for(F=I;F<=y;F++)if(De[F-I]===0&&Ge(pt,d[F])){Ot=F;break}Ot===void 0?jt(pt,h,c,!0):(De[Ot-I]=b+1,Ot>=ct?ct=Ot:vt=!0,O(pt,d[Ot],g,null,h,c,E,A,k),ht++)}const yl=vt?Zr(De):he;for(F=yl.length-1,b=lt-1;b>=0;b--){const pt=I+b,Ot=d[pt],Tl=pt+1<S?d[pt+1].el:p;De[b]===0?O(null,Ot,g,Tl,h,c,E,A,k):vt&&(F<0||b!==yl[F]?ie(Ot,g,Tl,2):F--)}}},ie=(u,d,g,p,h=null)=>{const{el:c,type:E,transition:A,children:k,shapeFlag:b}=u;if(b&6){ie(u.component.subTree,d,g,p);return}if(b&128){u.suspense.move(d,g,p);return}if(b&64){E.move(u,d,g,Se);return}if(E===K){l(c,d,g);for(let v=0;v<k.length;v++)ie(k[v],d,g,p);l(u.anchor,d,g);return}if(E===ds){Q(u,d,g);return}if(p!==2&&b&1&&A)if(p===0)A.beforeEnter(c),l(c,d,g),bt(()=>A.enter(c),h);else{const{leave:v,delayLeave:y,afterLeave:j}=A,I=()=>l(c,d,g),$=()=>{v(c,()=>{I(),j&&j()})};y?y(c,I,$):$()}else l(c,d,g)},jt=(u,d,g,p=!1,h=!1)=>{const{type:c,props:E,ref:A,children:k,dynamicChildren:b,shapeFlag:S,patchFlag:v,dirs:y,cacheIndex:j}=u;if(v===-2&&(h=!1),A!=null&&Bs(A,null,g,u,!0),j!=null&&(d.renderCache[j]=void 0),S&256){d.ctx.deactivate(u);return}const I=S&1&&y,$=!Re(u);let F;if($&&(F=E&&E.onVnodeBeforeUnmount)&&Ct(F,d,u),S&6)vn(u.component,g,p);else{if(S&128){u.suspense.unmount(g,p);return}I&&ne(u,null,d,"beforeUnmount"),S&64?u.type.remove(u,d,g,Se,p):b&&!b.hasOnce&&(c!==K||v>0&&v&64)?Te(b,d,g,!1,!0):(c===K&&v&384||!h&&S&16)&&Te(k,d,g),p&&kl(u)}($&&(F=E&&E.onVnodeUnmounted)||I)&&bt(()=>{F&&Ct(F,d,u),I&&ne(u,null,d,"unmounted")},g)},kl=u=>{const{type:d,el:g,anchor:p,transition:h}=u;if(d===K){En(g,p);return}if(d===ds){G(u);return}const c=()=>{i(g),h&&!h.persisted&&h.afterLeave&&h.afterLeave()};if(u.shapeFlag&1&&h&&!h.persisted){const{leave:E,delayLeave:A}=h,k=()=>E(g,c);A?A(u.el,c,k):k()}else c()},En=(u,d)=>{let g;for(;u!==d;)g=w(u),i(u),u=g;i(d)},vn=(u,d,g)=>{const{bum:p,scope:h,job:c,subTree:E,um:A,m:k,a:b}=u;Ml(k),Ml(b),p&&os(p),h.stop(),c&&(c.flags|=8,jt(E,u,d,g)),A&&bt(A,d),bt(()=>{u.isUnmounted=!0},d),d&&d.pendingBranch&&!d.isUnmounted&&u.asyncDep&&!u.asyncResolved&&u.suspenseId===d.pendingId&&(d.deps--,d.deps===0&&d.resolve())},Te=(u,d,g,p=!1,h=!1,c=0)=>{for(let E=c;E<u.length;E++)jt(u[E],d,g,p,h)},Xe=u=>{if(u.shapeFlag&6)return Xe(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const d=w(u.anchor||u.el),g=d&&d[pr];return g?w(g):d};let Gs=!1;const Al=(u,d,g)=>{u==null?d._vnode&&jt(d._vnode,null,null,!0):O(d._vnode||null,u,d,null,null,null,g),d._vnode=u,Gs||(Gs=!0,Wl(),Hi(),Gs=!1)},Se={p:O,um:jt,m:ie,r:kl,mt:Ns,mc:Vt,pc:q,pbc:se,n:Xe,o:t};let El,vl;return{render:Al,hydrate:El,createApp:Hr(Al,El)}}function Ps({type:t,props:e},s){return s==="svg"&&t==="foreignObject"||s==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:s}function re({effect:t,job:e},s){s?(t.flags|=32,e.flags|=4):(t.flags&=-33,e.flags&=-5)}function Yr(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function on(t,e,s=!1){const l=t.children,i=e.children;if(D(l)&&D(i))for(let n=0;n<l.length;n++){const r=l[n];let o=i[n];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=i[n]=Yt(i[n]),o.el=r.el),!s&&o.patchFlag!==-2&&on(r,o)),o.type===Ts&&(o.el=r.el)}}function Zr(t){const e=t.slice(),s=[0];let l,i,n,r,o;const a=t.length;for(l=0;l<a;l++){const _=t[l];if(_!==0){if(i=s[s.length-1],t[i]<_){e[l]=i,s.push(l);continue}for(n=0,r=s.length-1;n<r;)o=n+r>>1,t[s[o]]<_?n=o+1:r=o;_<t[s[n]]&&(n>0&&(e[l]=s[n-1]),s[n]=l)}}for(n=s.length,r=s[n-1];n-- >0;)s[n]=r,r=e[r];return s}function an(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:an(e)}function Ml(t){if(t)for(let e=0;e<t.length;e++)t[e].flags|=8}const Xr=Symbol.for("v-scx"),to=()=>as(Xr);function us(t,e,s){return un(t,e,s)}function un(t,e,s=U){const{immediate:l,deep:i,flush:n,once:r}=s,o=rt({},s);let a;if(Ss)if(n==="sync"){const w=to();a=w.__watcherHandles||(w.__watcherHandles=[])}else if(!e||l)o.once=!0;else return{stop:Pt,resume:Pt,pause:Pt};const _=it;o.call=(w,N,W)=>Lt(w,_,N,W);let m=!1;n==="post"?o.scheduler=w=>{bt(w,_&&_.suspense)}:n!=="sync"&&(m=!0,o.scheduler=(w,N)=>{N?w():xl(w)}),o.augmentJob=w=>{e&&(w.flags|=4),m&&(w.flags|=2,_&&(w.id=_.uid,w.i=_))};const f=gr(t,e,o);return a&&a.push(f),f}function eo(t,e,s){const l=this.proxy,i=Y(t)?t.includes(".")?dn(l,t):()=>l[t]:t.bind(l,l);let n;C(e)?n=e:(n=e.handler,s=e);const r=Ke(this),o=un(i,n.bind(l),s);return r(),o}function dn(t,e){const s=e.split(".");return()=>{let l=t;for(let i=0;i<s.length&&l;i++)l=l[s[i]];return l}}const so=(t,e)=>e==="modelValue"||e==="model-value"?t.modelModifiers:t[`${e}Modifiers`]||t[`${Nt(e)}Modifiers`]||t[`${ge(e)}Modifiers`];function lo(t,e,...s){if(t.isUnmounted)return;const l=t.vnode.props||U;let i=s;const n=e.startsWith("update:"),r=n&&so(l,e.slice(7));r&&(r.trim&&(i=s.map(m=>Y(m)?m.trim():m)),r.number&&(i=s.map(gs)));let o,a=l[o=js(e)]||l[o=js(Nt(e))];!a&&n&&(a=l[o=js(ge(e))]),a&&Lt(a,t,6,i);const _=l[o+"Once"];if(_){if(!t.emitted)t.emitted={};else if(t.emitted[o])return;t.emitted[o]=!0,Lt(_,t,6,i)}}function mn(t,e,s=!1){const l=e.emitsCache,i=l.get(t);if(i!==void 0)return i;const n=t.emits;let r={},o=!1;if(!C(t)){const a=_=>{const m=mn(_,e,!0);m&&(o=!0,rt(r,m))};!s&&e.mixins.length&&e.mixins.forEach(a),t.extends&&a(t.extends),t.mixins&&t.mixins.forEach(a)}return!n&&!o?(B(t)&&l.set(t,null),null):(D(n)?n.forEach(a=>r[a]=null):rt(r,n),B(t)&&l.set(t,r),r)}function ys(t,e){return!t||!ps(e)?!1:(e=e.slice(2).replace(/Once$/,""),L(t,e[0].toLowerCase()+e.slice(1))||L(t,ge(e))||L(t,e))}function zs(t){const{type:e,vnode:s,proxy:l,withProxy:i,propsOptions:[n],slots:r,attrs:o,emit:a,render:_,renderCache:m,props:f,data:w,setupState:N,ctx:W,inheritAttrs:O}=t,Z=xs(t);let z,J;try{if(s.shapeFlag&4){const G=i||l,X=G;z=Wt(_.call(X,G,m,f,N,w,W)),J=o}else{const G=e;z=Wt(G.length>1?G(f,{attrs:o,slots:r,emit:a}):G(f,null)),J=e.props?o:io(o)}}catch(G){Ie.length=0,Es(G,t,1),z=tt(me)}let Q=z;if(J&&O!==!1){const G=Object.keys(J),{shapeFlag:X}=Q;G.length&&X&7&&(n&&G.some(el)&&(J=no(J,n)),Q=Ae(Q,J,!1,!0))}return s.dirs&&(Q=Ae(Q,null,!1,!0),Q.dirs=Q.dirs?Q.dirs.concat(s.dirs):s.dirs),s.transition&&hl(Q,s.transition),z=Q,xs(Z),z}const io=t=>{let e;for(const s in t)(s==="class"||s==="style"||ps(s))&&((e||(e={}))[s]=t[s]);return e},no=(t,e)=>{const s={};for(const l in t)(!el(l)||!(l.slice(9)in e))&&(s[l]=t[l]);return s};function ro(t,e,s){const{props:l,children:i,component:n}=t,{props:r,children:o,patchFlag:a}=e,_=n.emitsOptions;if(e.dirs||e.transition)return!0;if(s&&a>=0){if(a&1024)return!0;if(a&16)return l?Ul(l,r,_):!!r;if(a&8){const m=e.dynamicProps;for(let f=0;f<m.length;f++){const w=m[f];if(r[w]!==l[w]&&!ys(_,w))return!0}}}else return(i||o)&&(!o||!o.$stable)?!0:l===r?!1:l?r?Ul(l,r,_):!0:!!r;return!1}function Ul(t,e,s){const l=Object.keys(e);if(l.length!==Object.keys(t).length)return!0;for(let i=0;i<l.length;i++){const n=l[i];if(e[n]!==t[n]&&!ys(s,n))return!0}return!1}function oo({vnode:t,parent:e},s){for(;e;){const l=e.subTree;if(l.suspense&&l.suspense.activeBranch===t&&(l.el=t.el),l===t)(t=e.vnode).el=s,e=e.parent;else break}}const _n=t=>t.__isSuspense;function ao(t,e){e&&e.pendingBranch?D(t)?e.effects.push(...t):e.effects.push(t):hr(t)}const K=Symbol.for("v-fgt"),Ts=Symbol.for("v-txt"),me=Symbol.for("v-cmt"),ds=Symbol.for("v-stc"),Ie=[];let Et=null;function R(t=!1){Ie.push(Et=t?null:[])}function uo(){Ie.pop(),Et=Ie[Ie.length-1]||null}let He=1;function ql(t){He+=t,t<0&&Et&&(Et.hasOnce=!0)}function gn(t){return t.dynamicChildren=He>0?Et||he:null,uo(),He>0&&Et&&Et.push(t),t}function P(t,e,s,l,i,n){return gn(x(t,e,s,l,i,n,!0))}function _e(t,e,s,l,i){return gn(tt(t,e,s,l,i,!0))}function mo(t){return t?t.__v_isVNode===!0:!1}function Ge(t,e){return t.type===e.type&&t.key===e.key}const fn=({key:t})=>t??null,ms=({ref:t,ref_key:e,ref_for:s})=>(typeof t=="number"&&(t=""+t),t!=null?Y(t)||mt(t)||C(t)?{i:At,r:t,k:e,f:!!s}:t:null);function x(t,e=null,s=null,l=0,i=null,n=t===K?0:1,r=!1,o=!1){const a={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&fn(e),ref:e&&ms(e),scopeId:Ui,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:n,patchFlag:l,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:At};return o?(bl(a,s),n&128&&t.normalize(a)):s&&(a.shapeFlag|=Y(s)?8:16),He>0&&!r&&Et&&(a.patchFlag>0||n&6)&&a.patchFlag!==32&&Et.push(a),a}const tt=_o;function _o(t,e=null,s=null,l=0,i=null,n=!1){if((!t||t===Or)&&(t=me),mo(t)){const o=Ae(t,e,!0);return s&&bl(o,s),He>0&&!n&&Et&&(o.shapeFlag&6?Et[Et.indexOf(t)]=o:Et.push(o)),o.patchFlag=-2,o}if(vo(t)&&(t=t.__vccOpts),e){e=go(e);let{class:o,style:a}=e;o&&!Y(o)&&(e.class=Tt(o)),B(a)&&(_l(a)&&!D(a)&&(a=rt({},a)),e.style=il(a))}const r=Y(t)?1:_n(t)?128:br(t)?64:B(t)?4:C(t)?2:0;return x(t,e,s,l,i,r,n,!0)}function go(t){return t?_l(t)||Xi(t)?rt({},t):t:null}function Ae(t,e,s=!1,l=!1){const{props:i,ref:n,patchFlag:r,children:o,transition:a}=t,_=e?xo(i||{},e):i,m={__v_isVNode:!0,__v_skip:!0,type:t.type,props:_,key:_&&fn(_),ref:e&&e.ref?s&&n?D(n)?n.concat(ms(e)):[n,ms(e)]:ms(e):n,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetStart:t.targetStart,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==K?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:a,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Ae(t.ssContent),ssFallback:t.ssFallback&&Ae(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce};return a&&l&&hl(m,a.clone(m)),m}function Me(t=" ",e=0){return tt(Ts,null,t,e)}function fo(t,e){const s=tt(ds,null,t);return s.staticCount=e,s}function It(t="",e=!1){return e?(R(),_e(me,null,t)):tt(me,null,t)}function Wt(t){return t==null||typeof t=="boolean"?tt(me):D(t)?tt(K,null,t.slice()):typeof t=="object"?Yt(t):tt(Ts,null,String(t))}function Yt(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:Ae(t)}function bl(t,e){let s=0;const{shapeFlag:l}=t;if(e==null)e=null;else if(D(e))s=16;else if(typeof e=="object")if(l&65){const i=e.default;i&&(i._c&&(i._d=!1),bl(t,i()),i._c&&(i._d=!0));return}else{s=32;const i=e._;!i&&!Xi(e)?e._ctx=At:i===3&&At&&(At.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else C(e)?(e={default:e,_ctx:At},s=32):(e=String(e),l&64?(s=16,e=[Me(e)]):s=8);t.children=e,t.shapeFlag|=s}function xo(...t){const e={};for(let s=0;s<t.length;s++){const l=t[s];for(const i in l)if(i==="class")e.class!==l.class&&(e.class=Tt([e.class,l.class]));else if(i==="style")e.style=il([e.style,l.style]);else if(ps(i)){const n=e[i],r=l[i];r&&n!==r&&!(D(n)&&n.includes(r))&&(e[i]=n?[].concat(n,r):r)}else i!==""&&(e[i]=l[i])}return e}function Ct(t,e,s,l=null){Lt(t,e,7,[s,l])}const ho=Qi();let co=0;function po(t,e,s){const l=t.type,i=(e?e.appContext:t.appContext)||ho,n={uid:co++,vnode:t,type:l,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Pn(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:en(l,i),emitsOptions:mn(l,i),emit:null,emitted:null,propsDefaults:U,inheritAttrs:l.inheritAttrs,ctx:U,data:U,props:U,attrs:U,slots:U,refs:U,setupState:U,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return n.ctx={_:n},n.root=e?e.root:n,n.emit=lo.bind(null,n),t.ce&&t.ce(n),n}let it=null,cs,Ys;{const t=pi(),e=(s,l)=>{let i;return(i=t[s])||(i=t[s]=[]),i.push(l),n=>{i.length>1?i.forEach(r=>r(n)):i[0](n)}};cs=e("__VUE_INSTANCE_SETTERS__",s=>it=s),Ys=e("__VUE_SSR_SETTERS__",s=>Ss=s)}const Ke=t=>{const e=it;return cs(t),t.scope.on(),()=>{t.scope.off(),cs(e)}},$l=()=>{it&&it.scope.off(),cs(null)};function xn(t){return t.vnode.shapeFlag&4}let Ss=!1;function bo(t,e=!1,s=!1){e&&Ys(e);const{props:l,children:i}=t.vnode,n=xn(t);Ur(t,l,n,e),Vr(t,i,s);const r=n?wo(t,e):void 0;return e&&Ys(!1),r}function wo(t,e){const s=t.type;t.accessCache=Object.create(null),t.proxy=new Proxy(t.ctx,Rr);const{setup:l}=s;if(l){const i=t.setupContext=l.length>1?Ao(t):null,n=Ke(t);te();const r=Ve(l,t,0,[t.props,i]);if(ee(),n(),fi(r)){if(Re(t)||qi(t),r.then($l,$l),e)return r.then(o=>{Bl(t,o,e)}).catch(o=>{Es(o,t,0)});t.asyncDep=r}else Bl(t,r,e)}else hn(t,e)}function Bl(t,e,s){C(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:B(e)&&(t.setupState=Pi(e)),hn(t,s)}let Vl;function hn(t,e,s){const l=t.type;if(!t.render){if(!e&&Vl&&!l.render){const i=l.template||cl(t).template;if(i){const{isCustomElement:n,compilerOptions:r}=t.appContext.config,{delimiters:o,compilerOptions:a}=l,_=rt(rt({isCustomElement:n,delimiters:o},r),a);l.render=Vl(i,_)}}t.render=l.render||Pt}{const i=Ke(t);te();try{Wr(t)}finally{ee(),i()}}}const ko={get(t,e){return ot(t,"get",""),t[e]}};function Ao(t){const e=s=>{t.exposed=s||{}};return{attrs:new Proxy(t.attrs,ko),slots:t.slots,emit:t.emit,expose:e}}function Ds(t){return t.exposed?t.exposeProxy||(t.exposeProxy=new Proxy(Pi(or(t.exposed)),{get(e,s){if(s in e)return e[s];if(s in We)return We[s](t)},has(e,s){return s in e||s in We}})):t.proxy}function Eo(t,e=!0){return C(t)?t.displayName||t.name:t.name||e&&t.__name}function vo(t){return C(t)&&"__vccOpts"in t}const yo=(t,e)=>mr(t,e,Ss),To="3.5.5";/**
* @vue/runtime-dom v3.5.5
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Zs;const Kl=typeof window<"u"&&window.trustedTypes;if(Kl)try{Zs=Kl.createPolicy("vue",{createHTML:t=>t})}catch{}const cn=Zs?t=>Zs.createHTML(t):t=>t,So="http://www.w3.org/2000/svg",Do="http://www.w3.org/1998/Math/MathML",Ht=typeof document<"u"?document:null,Jl=Ht&&Ht.createElement("template"),No={insert:(t,e,s)=>{e.insertBefore(t,s||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,s,l)=>{const i=e==="svg"?Ht.createElementNS(So,t):e==="mathml"?Ht.createElementNS(Do,t):s?Ht.createElement(t,{is:s}):Ht.createElement(t);return t==="select"&&l&&l.multiple!=null&&i.setAttribute("multiple",l.multiple),i},createText:t=>Ht.createTextNode(t),createComment:t=>Ht.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Ht.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,s,l,i,n){const r=s?s.previousSibling:e.lastChild;if(i&&(i===n||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),s),!(i===n||!(i=i.nextSibling)););else{Jl.innerHTML=cn(l==="svg"?`<svg>${t}</svg>`:l==="mathml"?`<math>${t}</math>`:t);const o=Jl.content;if(l==="svg"||l==="mathml"){const a=o.firstChild;for(;a.firstChild;)o.appendChild(a.firstChild);o.removeChild(a)}e.insertBefore(o,s)}return[r?r.nextSibling:e.firstChild,s?s.previousSibling:e.lastChild]}},Go=Symbol("_vtc");function jo(t,e,s){const l=t[Go];l&&(e=(e?[e,...l]:[...l]).join(" ")),e==null?t.removeAttribute("class"):s?t.setAttribute("class",e):t.className=e}const Ql=Symbol("_vod"),Oo=Symbol("_vsh"),Co=Symbol(""),Ro=/(^|;)\s*display\s*:/;function Wo(t,e,s){const l=t.style,i=Y(s);let n=!1;if(s&&!i){if(e)if(Y(e))for(const r of e.split(";")){const o=r.slice(0,r.indexOf(":")).trim();s[o]==null&&_s(l,o,"")}else for(const r in e)s[r]==null&&_s(l,r,"");for(const r in s)r==="display"&&(n=!0),_s(l,r,s[r])}else if(i){if(e!==s){const r=l[Co];r&&(s+=";"+r),l.cssText=s,n=Ro.test(s)}}else e&&t.removeAttribute("style");Ql in t&&(t[Ql]=n?l.display:"",t[Oo]&&(l.display="none"))}const Yl=/\s*!important$/;function _s(t,e,s){if(D(s))s.forEach(l=>_s(t,e,l));else if(s==null&&(s=""),e.startsWith("--"))t.setProperty(e,s);else{const l=Io(t,e);Yl.test(s)?t.setProperty(ge(l),s.replace(Yl,""),"important"):t[l]=s}}const Zl=["Webkit","Moz","ms"],Ls={};function Io(t,e){const s=Ls[e];if(s)return s;let l=Nt(e);if(l!=="filter"&&l in t)return Ls[e]=l;l=ws(l);for(let i=0;i<Zl.length;i++){const n=Zl[i]+l;if(n in t)return Ls[e]=n}return e}const Xl="http://www.w3.org/1999/xlink";function ti(t,e,s,l,i,n=Wn(e)){l&&e.startsWith("xlink:")?s==null?t.removeAttributeNS(Xl,e.slice(6,e.length)):t.setAttributeNS(Xl,e,s):s==null||n&&!bi(s)?t.removeAttribute(e):t.setAttribute(e,n?"":zt(s)?String(s):s)}function Po(t,e,s,l){if(e==="innerHTML"||e==="textContent"){s!=null&&(t[e]=e==="innerHTML"?cn(s):s);return}const i=t.tagName;if(e==="value"&&i!=="PROGRESS"&&!i.includes("-")){const r=i==="OPTION"?t.getAttribute("value")||"":t.value,o=s==null?t.type==="checkbox"?"on":"":String(s);(r!==o||!("_value"in t))&&(t.value=o),s==null&&t.removeAttribute(e),t._value=s;return}let n=!1;if(s===""||s==null){const r=typeof t[e];r==="boolean"?s=bi(s):s==null&&r==="string"?(s="",n=!0):r==="number"&&(s=0,n=!0)}try{t[e]=s}catch{}n&&t.removeAttribute(e)}function Zt(t,e,s,l){t.addEventListener(e,s,l)}function zo(t,e,s,l){t.removeEventListener(e,s,l)}const ei=Symbol("_vei");function Lo(t,e,s,l,i=null){const n=t[ei]||(t[ei]={}),r=n[e];if(l&&r)r.value=l;else{const[o,a]=Fo(e);if(l){const _=n[e]=Uo(l,i);Zt(t,o,_,a)}else r&&(zo(t,o,r,a),n[e]=void 0)}}const si=/(?:Once|Passive|Capture)$/;function Fo(t){let e;if(si.test(t)){e={};let l;for(;l=t.match(si);)t=t.slice(0,t.length-l[0].length),e[l[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):ge(t.slice(2)),e]}let Fs=0;const Ho=Promise.resolve(),Mo=()=>Fs||(Ho.then(()=>Fs=0),Fs=Date.now());function Uo(t,e){const s=l=>{if(!l._vts)l._vts=Date.now();else if(l._vts<=s.attached)return;Lt(qo(l,s.value),e,5,[l])};return s.value=t,s.attached=Mo(),s}function qo(t,e){if(D(e)){const s=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{s.call(t),t._stopped=!0},e.map(l=>i=>!i._stopped&&l&&l(i))}else return e}const li=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,$o=(t,e,s,l,i,n)=>{const r=i==="svg";e==="class"?jo(t,l,r):e==="style"?Wo(t,s,l):ps(e)?el(e)||Lo(t,e,s,l,n):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Bo(t,e,l,r))?(Po(t,e,l),!t.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&ti(t,e,l,r,n,e!=="value")):(e==="true-value"?t._trueValue=l:e==="false-value"&&(t._falseValue=l),ti(t,e,l,r))};function Bo(t,e,s,l){if(l)return!!(e==="innerHTML"||e==="textContent"||e in t&&li(e)&&C(s));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const i=t.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return li(e)&&Y(s)?!1:!!(e in t||t._isVueCE&&(/[A-Z]/.test(e)||!Y(s)))}const Ee=t=>{const e=t.props["onUpdate:modelValue"]||!1;return D(e)?s=>os(e,s):e};function Vo(t){t.target.composing=!0}function ii(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const qt=Symbol("_assign"),Xt={created(t,{modifiers:{lazy:e,trim:s,number:l}},i){t[qt]=Ee(i);const n=l||i.props&&i.props.type==="number";Zt(t,e?"change":"input",r=>{if(r.target.composing)return;let o=t.value;s&&(o=o.trim()),n&&(o=gs(o)),t[qt](o)}),s&&Zt(t,"change",()=>{t.value=t.value.trim()}),e||(Zt(t,"compositionstart",Vo),Zt(t,"compositionend",ii),Zt(t,"change",ii))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,oldValue:s,modifiers:{lazy:l,trim:i,number:n}},r){if(t[qt]=Ee(r),t.composing)return;const o=(n||t.type==="number")&&!/^0\d/.test(t.value)?gs(t.value):t.value,a=e??"";o!==a&&(document.activeElement===t&&t.type!=="range"&&(l&&e===s||i&&t.value.trim()===a)||(t.value=a))}},pn={deep:!0,created(t,e,s){t[qt]=Ee(s),Zt(t,"change",()=>{const l=t._modelValue,i=Ue(t),n=t.checked,r=t[qt];if(D(l)){const o=nl(l,i),a=o!==-1;if(n&&!a)r(l.concat(i));else if(!n&&a){const _=[...l];_.splice(o,1),r(_)}}else if(ve(l)){const o=new Set(l);n?o.add(i):o.delete(i),r(o)}else r(bn(t,n))})},mounted:ni,beforeUpdate(t,e,s){t[qt]=Ee(s),ni(t,e,s)}};function ni(t,{value:e,oldValue:s},l){t._modelValue=e;let i;D(e)?i=nl(e,l.props.value)>-1:ve(e)?i=e.has(l.props.value):i=$e(e,bn(t,!0)),t.checked!==i&&(t.checked=i)}const Hs={deep:!0,created(t,{value:e,modifiers:{number:s}},l){const i=ve(e);Zt(t,"change",()=>{const n=Array.prototype.filter.call(t.options,r=>r.selected).map(r=>s?gs(Ue(r)):Ue(r));t[qt](t.multiple?i?new Set(n):n:n[0]),t._assigning=!0,Li(()=>{t._assigning=!1})}),t[qt]=Ee(l)},mounted(t,{value:e,modifiers:{number:s}}){ri(t,e)},beforeUpdate(t,e,s){t[qt]=Ee(s)},updated(t,{value:e,modifiers:{number:s}}){t._assigning||ri(t,e)}};function ri(t,e,s){const l=t.multiple,i=D(e);if(!(l&&!i&&!ve(e))){for(let n=0,r=t.options.length;n<r;n++){const o=t.options[n],a=Ue(o);if(l)if(i){const _=typeof a;_==="string"||_==="number"?o.selected=e.some(m=>String(m)===String(a)):o.selected=nl(e,a)>-1}else o.selected=e.has(a);else if($e(Ue(o),e)){t.selectedIndex!==n&&(t.selectedIndex=n);return}}!l&&t.selectedIndex!==-1&&(t.selectedIndex=-1)}}function Ue(t){return"_value"in t?t._value:t.value}function bn(t,e){const s=e?"_trueValue":"_falseValue";return s in t?t[s]:e}const Ko=rt({patchProp:$o},No);let oi;function Jo(){return oi||(oi=Jr(Ko))}const Qo=(...t)=>{const e=Jo().createApp(...t),{mount:s}=e;return e.mount=l=>{const i=Zo(l);if(!i)return;const n=e._component;!C(n)&&!n.render&&!n.template&&(n.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const r=s(i,!1,Yo(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),r},e};function Yo(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function Zo(t){return Y(t)?document.querySelector(t):t}const _t=(t,e)=>{const s=t.__vccOpts||t;for(const[l,i]of e)s[l]=i;return s},Xo={};function ta(t,e){return R(),P(K,null,[e[0]||(e[0]=x("h1",null,"GlossySnake",-1)),e[1]||(e[1]=x("p",null,[Me("INDEX PAGE | "),x("a",{href:"https://github.com/parkchamchi/GlossySnake"},"Repo")],-1))],64)}const ea=_t(Xo,[["render",ta],["__scopeId","data-v-0f95cfa1"]]),Jt=Be({}),st={on(t,e){Jt[t]||(Jt[t]=[]),Jt[t].push(e)},off(t,e){Jt[t]&&(Jt[t]=Jt[t].filter(s=>s!==e))},emit(t,e){Jt[t]&&Jt[t].forEach(s=>s(e))}};function nt(){}nt.prototype.host="https://api.glossysnake.com";nt.prototype.api="/api/v4";nt.prototype.uri=function(t){return this.host+this.api+t};nt.prototype.jsonHelper=async function(t){try{return await t.json()}catch(e){return console.log(e),{error:JSON.parse(JSON.stringify(e,Object.getOwnPropertyNames(e)))}}};nt.prototype.submit=async function(t,e="GET",s=null,l=!0){const i=this.uri(t);let n={method:e,headers:{"Content-type":"application/json; charset=UTF-8"},credentials:"include"};e!="GET"&&(n.body=JSON.stringify(s)),l&&(n.headers.Authorization="Token "+nt._key);const r=await fetch(i,n);if(!r.ok){const o=await this.jsonHelper(r),a=i+": "+r.statusText+`
> `+JSON.stringify(o);throw st.emit("addAlert",{message:a,alertClass:"alert-warning"}),new Error(a)}return this.emitCorpusesUpdate(t),r};nt.prototype.emitCorpusesUpdate=async function(t){["/corpuses/","/tasks/","/user/check","/user/get-temp-user","/user/logout","/rest-auth/registration/","/rest-auth/login/","/rest-auth/logout/"].some(s=>t.endsWith(s))||(st.emit("updateCorpuses"),st.emit("updateTasks"))};const sa={data(){return{api:new nt,loggedin:!1}},computed:{userinfo(){return this.loggedin?"Guest.":"Log in."}},methods:{meow(){console.log("meow")},async getTempUser(){const e=await(await this.api.submit("/user/get-temp-user","GET",null,!1)).json();return e.success?(nt._key=e.key,!0):(console.error("get-temp-user unsuccessful"),!1)},async updateUser(){if(!nt._key&&!await this.getTempUser()){console.error("could not get the temp user.");return}this.loggedin=!0,st.emit("updateCorpuses"),st.emit("updateTasks")},async logout(){this.api.submit("/user/logout").then(()=>{nt._key=null,this.loggedin=!1,this.updateUser()})}},async created(){await this.updateUser()}},la={id:"frontend_auth_div"},ia={class:"userinfo_p"};function na(t,e,s,l,i,n){return R(),P("div",la,[x("p",ia,xt(n.userinfo),1),x("p",{onClick:e[0]||(e[0]=r=>n.logout()),class:"btn logout_button"}," Logout ")])}const ra=_t(sa,[["render",na],["__scopeId","data-v-72d1c363"]]),oa=JSON.parse(localStorage.getItem("sharedState"))||{},T=Be({annotator_name:"chatgpt_ft0",lang_from:"German",lang_to:"English",toRemote:!0,openaiApiKey:null,openaiModel:"gpt-4o-mini",outerRetry:2,innerRetry:3,maxGloss:80,fullPrompt:!0,currentOpenCorpus:"",psPerScreen:16,...oa}),aa={data(){return T},watch:{annotator_name(){this.emitChange()},lang_from(){this.emitChange()},lang_to(){this.emitChange()},toRemote(){this.emitChange()}},methods:{emitChange(){T.annotator_name=this.annotator_name,T.lang_from=this.lang_from,T.lang_to=this.lang_to,T.toRemote=this.toRemote}}},ua={class:"container mt-4"},da={class:"row"},ma={class:"col-md-4"},_a={class:"col-md-4"},ga={class:"col-md-4"};function fa(t,e,s,l,i,n){return R(),P(K,null,[x("div",ua,[x("div",da,[x("div",ma,[e[5]||(e[5]=x("label",{for:"annotator_name"},"annotator_name:",-1)),kt(x("select",{"onUpdate:modelValue":e[0]||(e[0]=r=>t.annotator_name=r),name:"annotator_name",id:"annotator_name_select",class:"form-control"},e[4]||(e[4]=[fo('<option value="dummy">dummy</option><option value="chatgpt_ft0">chatgpt_ft0</option><option value="chatgpt_gpt-4o-mini-untrained_0">chatgpt_gpt-4o-mini-untrained_0</option><option value="chatgpt_gpt-4o-mini-pretrained_0">chatgpt_gpt-4o-mini-pretrained_0</option><option value="chatgpt_gpt-3.5-turbo-untrained_0">chatgpt_gpt-3.5-turbo-untrained_0</option><option value="chatgpt_gpt-3.5-turbo-pretrained_0">chatgpt_gpt-3.5-turbo-pretrained_0</option>',6)]),512),[[Hs,t.annotator_name]])]),x("div",_a,[e[7]||(e[7]=x("label",{for:"lang_from"},"lang_from:",-1)),kt(x("select",{"onUpdate:modelValue":e[1]||(e[1]=r=>t.lang_from=r),name:"lang_from",id:"lang_from_select",class:"form-control"},e[6]||(e[6]=[x("option",{value:"French"},"French",-1),x("option",{value:"German"},"German",-1),x("option",{value:"Latin"},"Latin",-1)]),512),[[Hs,t.lang_from]])]),x("div",ga,[e[9]||(e[9]=x("label",{for:"lang_to"},"lang_to:",-1)),kt(x("select",{"onUpdate:modelValue":e[2]||(e[2]=r=>t.lang_to=r),name:"lang_to",id:"lang_to_select",class:"form-control"},e[8]||(e[8]=[x("option",{value:"English"},"English",-1)]),512),[[Hs,t.lang_to]])])])]),e[11]||(e[11]=x("br",null,null,-1)),x("div",null,[kt(x("input",{"onUpdate:modelValue":e[3]||(e[3]=r=>t.toRemote=r),type:"checkbox",name:"toRemote",id:"toRemote_input",class:"form-check-input",checked:""},null,512),[[pn,t.toRemote]]),e[10]||(e[10]=x("label",{for:"toRemote_input",class:"form-check-label"},"To the remote server",-1))])],64)}const xa=_t(aa,[["render",fa]]),ha={data(){return T},watch:{openaiApiKey(){this.emitChange()},openaiModel(){this.emitChange()},outerRetry(){this.emitChange()},innerRetry(){this.emitChange()},maxGloss(){this.emitChange()},fullPrompt(){this.emitChange()}},computed:{visibility(){return!T.toRemote}},methods:{emitChange(){T.openaiApiKey=this.openaiApiKey,T.openaiModel=this.openaiModel,T.outerRetry=this.outerRetry,T.innerRetry=this.innerRetry,T.maxGloss=this.maxGloss,T.fullPrompt=this.fullPrompt}}},ca={key:0,class:"container mt-3"},pa={class:"row"},ba={class:"col-md-2"},wa={class:"col-md-2"},ka={class:"col-md-2"},Aa={class:"col-md-2"},Ea={class:"col-md-2"},va={class:"col-md-2 d-flex align-items-center"};function ya(t,e,s,l,i,n){return R(),P(K,null,[e[13]||(e[13]=x("h4",null,"Local Annotator Options",-1)),n.visibility?(R(),P("div",ca,[x("div",pa,[x("div",ba,[e[6]||(e[6]=x("label",{for:"openaiApiKey"},"OpenAI API Key",-1)),kt(x("input",{type:"password",class:"form-control",id:"openaiApiKey","onUpdate:modelValue":e[0]||(e[0]=r=>t.openaiApiKey=r)},null,512),[[Xt,t.openaiApiKey]])]),x("div",wa,[e[7]||(e[7]=x("label",{for:"openaiModel"},"OpenAI Model",-1)),kt(x("input",{type:"text",class:"form-control",id:"openaiModel","onUpdate:modelValue":e[1]||(e[1]=r=>t.openaiModel=r)},null,512),[[Xt,t.openaiModel]])]),x("div",ka,[e[8]||(e[8]=x("label",{for:"outerRetry"},"Outer Retry",-1)),kt(x("input",{type:"number",class:"form-control",id:"outerRetry","onUpdate:modelValue":e[2]||(e[2]=r=>t.outerRetry=r),min:"1"},null,512),[[Xt,t.outerRetry]])]),x("div",Aa,[e[9]||(e[9]=x("label",{for:"innerRetry"},"Inner Retry",-1)),kt(x("input",{type:"number",class:"form-control",id:"innerRetry","onUpdate:modelValue":e[3]||(e[3]=r=>t.innerRetry=r),min:"1"},null,512),[[Xt,t.innerRetry]])]),x("div",Ea,[e[10]||(e[10]=x("label",{for:"maxGloss"},"Max Gloss",-1)),kt(x("input",{type:"number",class:"form-control",id:"maxGloss","onUpdate:modelValue":e[4]||(e[4]=r=>t.maxGloss=r),min:"40"},null,512),[[Xt,t.maxGloss]])]),x("div",va,[kt(x("input",{type:"checkbox",class:"form-check-input",id:"fullPrompt","onUpdate:modelValue":e[5]||(e[5]=r=>t.fullPrompt=r)},null,512),[[pn,t.fullPrompt]]),e[11]||(e[11]=x("label",{class:"form-check-label",for:"fullPrompt"},"Full Prompt",-1))])]),e[12]||(e[12]=x("div",{class:"row"},[x("div",{class:"col-md-2 d-flex align-items-center"},[x("button",{class:"btn btn-link mt-3"},[x("a",{href:"https://github.com/parkchamchi/GlossySnake/blob/master/docs/design/local.md"},"Info")])])],-1))])):It("",!0)],64)}const Ta=_t(ha,[["render",ya]]),Sa={data(){return T},watch:{psPerScreen(){this.emitChange()}},methods:{emitChange(){T.psPerScreen=this.psPerScreen},exportData(){console.log("Exporting");const t=JSON.stringify(T,null,2),e=new Blob([t],{type:"application/json"}),s=URL.createObjectURL(e),l=document.createElement("a");l.href=s,l.download="sharedState.json",l.click(),URL.revokeObjectURL(s)},async importData(t){const s=await t.target.files[0].text(),l=JSON.parse(s);Object.keys(l).forEach(i=>{T.hasOwnProperty(i)&&(T[i]=l[i])})}},mounted(){us(()=>T,t=>{localStorage.setItem("sharedState",JSON.stringify(t))},{deep:!0})}},Da={class:"container mt-3"},Na={class:"row"},Ga={class:"col-md-2"},ja={class:"row"},Oa={class:"col-md-2 d-flex align-items-center"},Ca={class:"col-md-2 d-flex align-items-center"};function Ra(t,e,s,l,i,n){return R(),P(K,null,[e[4]||(e[4]=x("h4",null,"Misc. Options",-1)),x("div",Da,[x("div",Na,[x("div",Ga,[e[3]||(e[3]=x("label",{for:"psPerScreen"},[Me("Paragraphs per screen "),x("br"),x("em",null,"(0 for inf)")],-1)),kt(x("input",{type:"number",class:"form-control",id:"psPerScreen","onUpdate:modelValue":e[0]||(e[0]=r=>t.psPerScreen=r),min:"0"},null,512),[[Xt,t.psPerScreen]])])]),x("div",ja,[x("div",Oa,[x("button",{class:"btn btn-link mt-3",onClick:e[1]||(e[1]=(...r)=>n.exportData&&n.exportData(...r))},"Export")]),x("div",Ca,[x("input",{type:"file",onChange:e[2]||(e[2]=(...r)=>n.importData&&n.importData(...r)),class:"form-control"},null,32)])])])],64)}const Wa=_t(Sa,[["render",Ra]]),rs=[{corpus_id:"Winterreise",corpuses_history:[{paragraphs:[{pstate:"ANNOTATED",tokens:[{txt:"#",is_delimiter:!1,gloss:"#"},{txt:" ",is_delimiter:!0,gloss:null},{txt:"Gute",is_delimiter:!1,gloss:"Good"},{txt:" ",is_delimiter:!0,gloss:null},{txt:"Nacht.",is_delimiter:!1,gloss:"Night."}],is_delimiter:!1,token_delimiters:` 	
...
`)},txt(){return this.t.txt},gloss(){let t=this.t.gloss;return t=="!UNKNOWN"&&(t="-"),t}},methods:{toggle(){this.isSelected=!this.isSelected,this.$emit("selectionChanged",{tIndex:this.index,isSelected:this.isSelected})}}},qa={class:"token_ul list-group list-group-flush"},$a={class:"list-group-item token_txt"},Ba={class:"list-group-item gloss"},Va={key:1},Ka={key:2,class:"token_wrapper"};function Ja(t,e,s,l,i,n){return n.is_delimiter?n.should_linebreak?(R(),P("br",Va)):(R(),P("div",Ka,[x("span",null,xt(n.txt),1)])):(R(),P("div",{key:0,class:Tt(["token_wrapper","card",{"selected-token":i.isSelected}]),onClick:e[0]||(e[0]=r=>n.toggle())},[x("ul",qa,[x("li",$a,xt(n.txt),1),x("li",Ba,xt(n.gloss),1)])],2))}const Qa=_t(Ua,[["render",Ja],["__scopeId","data-v-6dcfb1f3"]]),Ya={props:{p:{type:Object,required:!0},index:{type:Number,required:!0},remote:{type:Boolean,default:!1}},components:{Token:Qa},computed:{isAnnotateButtonVisible(){return!this.p.is_delimiter&&this.p.tokens&&this.p.tokens.length},shouldShowManipulatorButtons(){return this.remote&&T.toRemote||!this.remote&&!T.toRemote&&T.openaiApiKey}},data(){return{selectedTokens:new Set,showPre:!1}},methods:{annotateP(){this.$emit("annotateP",this.index)},reannotateP(){this.$emit("reannotateP",this.index,Array.from(this.selectedTokens))},onSelectionChanged({tIndex:t,isSelected:e}){e?this.selectedTokens.add(t):this.selectedTokens.delete(t)}}},Za={class:"paragraph_wrapper"},Xa={key:0,class:"paragraph_annotate_buttons_span"},tu={key:1};function eu(t,e,s,l,i,n){const r=gt("Token");return R(),P("div",Za,[n.isAnnotateButtonVisible&&n.shouldShowManipulatorButtons?(R(),P("span",Xa,[x("button",{class:"corpus_button btn btn-light",onClick:e[0]||(e[0]=o=>n.annotateP(s.index))}," Annotate "),x("button",{class:"corpus_button btn btn-light",onClick:e[1]||(e[1]=o=>n.reannotateP(s.index))}," Reannotate "),e[2]||(e[2]=x("br",null,null,-1))])):It("",!0),i.showPre?(R(),P("pre",tu,xt(JSON.stringify(s.p)),1)):It("",!0),(R(!0),P(K,null,ue(s.p.tokens,(o,a)=>(R(),_e(r,{key:a,t:o,index:a,onSelectionChanged:n.onSelectionChanged},null,8,["t","index","onSelectionChanged"]))),128))])}const su=_t(Ya,[["render",eu],["__scopeId","data-v-d3c29f34"]]),lu={props:{corpus_id:{required:!0},corpus:{type:Object,required:!0},remote:{type:Boolean,default:!1}},components:{Paragraph:su},data(){return{api:new nt,sharedState:T,showPre:!1,mounted:!1}},computed:{isCorpusVisible(){return this.mounted&&T.currentOpenCorpus==this.corpus_id},currentP:{get(){return this.corpus.cursor||(this.corpus.cursor=0),this.corpus.cursor},set(t){let e=t;t<0&&(e=0),t>=this.corpus.paragraphs.length&&(e=this.corpus.paragraphs.length-1),this.corpus.cursor=e}},visibleParagraphs(){const t=Array.from({length:this.psPerScreen},(e,s)=>this.currentP+s);return this.corpus.paragraphs.filter((e,s)=>t.includes(s))},psPerScreen(){return T.psPerScreen>0?T.psPerScreen:this.corpus.paragraphs.length},pseudoState(){return!this.corpus.paragraphs||this.corpus.paragraphs.length<=0?"PLAIN":this.corpus.paragraphs[0].pstate},divideButtonClass(){const t=this.pseudoState=="PLAIN";return{"btn-primary":t,"btn-light":!t}},parseButtonClass(){const t=this.pseudoState=="DIVIDED";return{"btn-primary":t,"btn-light":!t}},annotateButtonClass(){const t=this.pseudoState=="PARSED";return{"btn-primary":t,"btn-light":!t}},header(){return this.remote?"REMOTE":"LOCAL"},shouldShowManipulatorButtons(){return this.remote&&T.toRemote||!this.remote&&!T.toRemote&&T.openaiApiKey}},methods:{toggleCorpusVisibility(){T.currentOpenCorpus==this.corpus_id?T.currentOpenCorpus="":T.currentOpenCorpus=this.corpus_id},download(){const t=JSON.stringify(this.corpus);console.log("Downloading...");let e=document.createElement("a"),s=new Blob([t],{type:"text/plain"});e.download=this.corpus_id+".corpus.json",e.href=URL.createObjectURL(s),e.click()},async divide(t=`
`){return T.toRemote?this.divideRemote(t):this.divideLocal(t)},async parse(){return T.toRemote?this.parseRemote():this.parseLocal()},async annotate(t=null){return T.toRemote?this.annotateRemote(t):this.annotateLocal(t)},async reannotate(t,e){if(!e){console.error("target_tokens is not given");return}if(e.length==0){st.emit("addAlert",{message:"No token selected.",alertClass:"alert-warning"});return}return T.toRemote?this.reannotateRemote(t,e):this.reannotateLocal(t,e)},async divideRemote(t){this.api.submit("/parser/divide","POST",{corpus_id:this.corpus_id,divide_options:{p_delims:[t]}})},async parseRemote(){this.api.submit("/parser/parse","POST",{corpus_id:this.corpus_id,parse_options:{t_delims:null}})},async annotateRemote(t){this.api.submit("/annotator/annotate","POST",{corpus_id:this.corpus_id,annotate_options:{annotator_name:this.sharedState.annotator_name,lang_from:this.sharedState.lang_from,lang_to:this.sharedState.lang_to,target_paragraphs:t}})},async reannotateRemote(t,e){this.api.submit("/annotator/reannotate","POST",{corpus_id:this.corpus_id,annotate_options:{annotator_name:this.sharedState.annotator_name,lang_from:this.sharedState.lang_from,lang_to:this.sharedState.lang_to,target_paragraphs:t},reannotate_options:{target_tokens:e}})},async divideLocal(t){di.divide_into_paragraphs(this.corpus,[t])},async parseLocal(){for(const t of this.corpus.paragraphs)di.parse_paragraph(t)},async annotateLocal(t){const e=gi(T.annotator_name),s=T.lang_from,l=T.lang_to;t&&(t.length==1&&t[0]==-1&&(t=this.corpus.paragraphs.map((i,n)=>({p:i,i:n})).filter(({p:i})=>!i.is_delimiter&&i.pstate!="ANNOTATED").map(({i})=>i)),console.log(t));for(const[i,n]of this.corpus.paragraphs.entries())t&&!t.includes(i)||await e.annotate(n,s,l)},async reannotateLocal(t,e){const s=gi(T.annotator_name),l=T.lang_from,i=T.lang_to,n=t[0],r=this.corpus.paragraphs[n];l||(l=r.annotator_info_obj.lang_from),i||(i=r.annotator_info_obj.lang_to),await s.reannotate(r,l,i,e)},scrollToOriginalHeader(){this.$refs.header.scrollIntoView({behavior:"smooth"})},handleResizeOrScroll(){this.isCorpusVisible&&this.scrollToOriginalHeader()},psPrev(){let t=this.currentP-this.psPerScreen;t>=0&&(this.currentP=t,this.scrollToTop())},psNext(){let t=this.currentP+this.psPerScreen;t<this.corpus.paragraphs.length&&(this.currentP=t,this.scrollToTop())},scrollToTop(){this.$nextTick(()=>{const t=this.$refs.corpus;t.scrollTop=0})},onAnnotateP(t){this.annotate([t])},onReannotateP(t,e){this.reannotate([t],e)}},watch:{isCorpusVisible(t){document.body.style.overflow=t?"hidden":"",this.scrollToOriginalHeader()}},mounted(){this.mounted=!0,window.addEventListener("resize",this.handleResizeOrScroll),window.addEventListener("scroll",this.handleResizeOrScroll)},beforeDestroy(){window.removeEventListener("resize",this.handleResizeOrScroll),window.removeEventListener("scroll",this.handleResizeOrScroll)}},iu={key:0,class:"pButtonsDiv"},nu=["max"],ru={key:1,class:"corpus",ref:"corpus"},ou={class:"corpus_buttons_span"},au={key:0},uu={key:0,class:"corpus-pre"};function du(t,e,s,l,i,n){const r=gt("Paragraph");return R(),P("div",{class:Tt(["corpus_wrapper",{"full-screen":n.isCorpusVisible}])},[e[11]||(e[11]=x("hr",null,null,-1)),x("h4",{onClick:e[0]||(e[0]=o=>n.toggleCorpusVisibility()),ref:"header"},xt(n.header+": "+s.corpus_id),513),n.isCorpusVisible?(R(),P("div",iu,[x("button",{class:"btn",onClick:e[1]||(e[1]=(...o)=>n.psPrev&&n.psPrev(...o))}," << "),kt(x("input",{"onUpdate:modelValue":e[2]||(e[2]=o=>n.currentP=o),type:"number",class:"form-control w-auto d-inline",min:0,max:s.corpus.paragraphs.length-1},null,8,nu),[[Xt,n.currentP,void 0,{number:!0}]]),x("span",null,"/"+xt(this.corpus.paragraphs.length-1),1),x("button",{class:"btn",onClick:e[3]||(e[3]=(...o)=>n.psNext&&n.psNext(...o))}," >> ")])):It("",!0),n.isCorpusVisible?(R(),P("div",ru,[x("span",ou,[x("button",{class:"corpus_button btn btn-light",onClick:e[4]||(e[4]=o=>n.download())},"Download"),n.shouldShowManipulatorButtons?(R(),P("span",au,[x("button",{class:Tt(["corpus_button","btn",n.divideButtonClass]),onClick:e[5]||(e[5]=o=>n.divide())},"Divide",2),x("button",{class:Tt(["corpus_button","btn",n.divideButtonClass]),onClick:e[6]||(e[6]=o=>n.divide("\\n\\n"))},"Divide (for poems)",2),x("button",{class:Tt(["corpus_button","btn",n.parseButtonClass]),onClick:e[7]||(e[7]=o=>n.parse())},"Parse",2),x("button",{class:Tt(["corpus_button","btn",n.annotateButtonClass]),onClick:e[8]||(e[8]=o=>n.annotate([-1]))}," Annotate ",2),x("button",{class:Tt(["corpus_button","btn",n.annotateButtonClass]),onClick:e[9]||(e[9]=o=>n.annotate(null))}," Annotate (Reset) ",2)])):It("",!0)]),e[10]||(e[10]=x("br",null,null,-1)),i.showPre?(R(),P("pre",uu,xt(JSON.stringify(s.corpus)),1)):It("",!0),(R(!0),P(K,null,ue(n.visibleParagraphs,(o,a)=>(R(),_e(r,{key:a,p:o,index:a,remote:s.remote,onAnnotateP:n.onAnnotateP,onReannotateP:n.onReannotateP},null,8,["p","index","remote","onAnnotateP","onReannotateP"]))),128))],512)):It("",!0)],2)}const mu=_t(lu,[["render",du],["__scopeId","data-v-20ed6ef6"]]),_u={components:{Corpus:mu},data(){return{api:new nt,sampleHost:"https://parkchamchi.github.io/GlossySnake/samples/v1/",db:null,localCorpuses:[...rs],remoteCorpuses:[],remoteSampleFilenames:[]}},watch:{localCorpuses:{handler(t){this.saveCorpuses(t)},deep:!0}},methods:{async updateCorpuses(){const e=await(await this.api.submit("/corpuses/")).json();this.remoteCorpuses=e},async getRemoteSamples(){await fetch(this.sampleHost).then(t=>t.json()).then(t=>{this.remoteSampleFilenames=t.filenames})},async getRemoteSampleCorpus(t){fetch(this.sampleHost+t).then(e=>e.json()).then(e=>{const s=t.replace(".corpus.json","");this.addLocalCorpus({corpus_id:s,corpus:e})})},async addLocalCorpus({corpus_id:t,corpus:e}){let s=t;s==""&&(s="Corpus");const l=new Set(this.localCorpuses.map(n=>n.corpus_id));let i=1;for(;l.has(s);)s=`${t} (${i++})`;this.localCorpuses.push({corpus_id:s,corpuses_history:[e]})},clearCorpuses(){this.localCorpuses=[...rs]},openDB(t,e,s){return new Promise((l,i)=>{const n=indexedDB.open(t,e);n.onupgradeneeded=r=>{const o=r.target.result;s(o)},n.onsuccess=r=>{l(r.target.result)},n.onerror=r=>{i(r.target.error)}})},getCorpuses(){return new Promise((t,e)=>{const i=this.db.transaction(["corpuses"],"readonly").objectStore("corpuses").getAll();i.onsuccess=()=>{t(i.result)},i.onerror=n=>{e(n.target.error)}})},saveCorpuses(t){const e=this.db.transaction(["corpuses"],"readwrite"),s=e.objectStore("corpuses");return s.clear(),t.forEach(l=>{const i=JSON.parse(JSON.stringify(l));s.put(i)}),e.complete}},async created(){st.on("updateCorpuses",this.updateCorpuses),st.on("addLocalCorpus",this.addLocalCorpus),this.getRemoteSamples(),this.db=await this.openDB("corpusDB",1,t=>{if(!t.objectStoreNames.contains("corpuses")){const e=t.createObjectStore("corpuses",{keyPath:"id",autoIncrement:!0});rs.forEach(s=>{e.add(s)})}}),this.localCorpuses=await this.getCorpuses()||[...rs]},mounted(){T.currentOpenCorpus=""},beforeDestroy(){st.off("updateCorpuses",this.updateCorpuses),st.off("addLocalCorpus",this.addLocalCorpus)}},gu={key:0},fu=["onClick"];function xu(t,e,s,l,i,n){const r=gt("Corpus");return R(),P(K,null,[x("p",{onClick:e[0]||(e[0]=(...o)=>n.clearCorpuses&&n.clearCorpuses(...o))},"[Clear data]"),i.remoteSampleFilenames.length>0?(R(),P("div",gu,[e[1]||(e[1]=x("h4",null,"Get a sample:",-1)),(R(!0),P(K,null,ue(i.remoteSampleFilenames,(o,a)=>(R(),P("p",{class:"sampleLinkP",onClick:_=>n.getRemoteSampleCorpus(o)},xt(o),9,fu))),256))])):It("",!0),x("div",null,[(R(!0),P(K,null,ue(i.localCorpuses,(o,a)=>(R(),_e(r,{key:a,corpus:o.corpuses_history.at(-1),corpus_id:o.corpus_id,remote:!1},null,8,["corpus","corpus_id"]))),128)),(R(!0),P(K,null,ue(i.remoteCorpuses,(o,a)=>(R(),_e(r,{key:a,corpus:o.corpuses_history.at(-1),corpus_id:o.corpus_id,remote:!0},null,8,["corpus","corpus_id"]))),128))])],64)}const hu=_t(_u,[["render",xu],["__scopeId","data-v-911862af"]]),cu={data(){return{api:new nt,originalText:""}},methods:{async onUploadButtonClicked(){return T.toRemote?this.uploadOriginalTextRemote():this.uploadOriginalTextLocal()},async onJsonFileInput(t){const s=await t.target.files[0].text(),l=JSON.parse(s);return T.toRemote?this.uploadJsonFileRemote(l):this.uploadJsonFileLocal(l)},async uploadOriginalTextRemote(){this.api.submit("/upload","POST",{original_text:this.originalText}).then(t=>t.json()).then(t=>{st.emit("addAlert",{message:"Uploaded corpus "+t.corpus_id})})},async uploadJsonFileRemote(t){this.api.submit("/upload","POST",{corpus:t}).then(e=>e.json()).then(e=>{st.emit("addAlert",{message:"Uploaded corpus "+e.corpus_id})})},async uploadOriginalTextLocal(){const t=this.makeTitle(this.originalText),e=Pa.init_with_txt(this.originalText);st.emit("addLocalCorpus",{corpus_id:t,corpus:e})},async uploadJsonFileLocal(t){const e=this.makeTitle(t.original_text);st.emit("addLocalCorpus",{corpus_id:e,corpus:t})},makeTitle(t,e=16){return t.substring(0,e)}}},pu={id:"frontend_upload_div"};function bu(t,e,s,l,i,n){return R(),P("div",pu,[e[3]||(e[3]=x("h3",null,"Upload...",-1)),e[4]||(e[4]=x("label",{for:"frontend_original_text"},"Original Text",-1)),e[5]||(e[5]=x("br",null,null,-1)),kt(x("textarea",{"onUpdate:modelValue":e[0]||(e[0]=r=>i.originalText=r),class:"context_input auto-resize field_input",name:"frontend_original_text",spellcheck:"false",autofocus:"",placeholder:"Original Text",id:"frontend_original_text_textarea"},null,512),[[Xt,i.originalText]]),e[6]||(e[6]=x("br",null,null,-1)),x("button",{onClick:e[1]||(e[1]=r=>n.onUploadButtonClicked()),id:"frontend_original_text_button",class:"btn btn-primary"}," Upload "),e[7]||(e[7]=x("br",null,null,-1)),e[8]||(e[8]=x("p",null,"...or the JSON file",-1)),x("input",{type:"file",id:"json_file_input",onChange:e[2]||(e[2]=(...r)=>n.onJsonFileInput&&n.onJsonFileInput(...r))},null,32),e[9]||(e[9]=x("br",null,null,-1))])}const wu=_t(cu,[["render",bu],["__scopeId","data-v-969ca212"]]),ku={props:{message:{type:String,required:!0},alertClass:{type:String,default:"alert-warning",validator(t){return["alert-success","alert-warning","alert-info","alert-light"].includes(t)}},timeout:{type:Number,default:5e4}},data(){return{showAlert:!1,alertMessage:this.message}},mounted(){this.showAlert=!0,setTimeout(()=>{this.showAlert=!1},this.timeout)}};function Au(t,e,s,l,i,n){return i.showAlert?(R(),P("div",{key:0,class:Tt(["alert",this.alertClass]),role:"alert"},xt(i.alertMessage),3)):It("",!0)}const Eu=_t(ku,[["render",Au]]),vu={components:{Alert:Eu},data(){return{alerts:[],maxAlerts:3}},methods:{addAlert({message:t,alertClass:e="alert-light"}){this.alerts.length>=this.maxAlerts&&this.alerts.shift(),this.alerts.push({message:t,alertClass:e})}},created(){st.on("addAlert",this.addAlert)},beforeDestroy(){st.off("addAlert",this.addAlert)}};function yu(t,e,s,l,i,n){const r=gt("Alert");return R(),P("div",null,[(R(!0),P(K,null,ue(i.alerts,(o,a)=>(R(),_e(r,{key:a,message:o.message,timeout:o.timeout,alertClass:o.alertClass},null,8,["message","timeout","alertClass"]))),128))])}const Tu=_t(vu,[["render",yu]]),Su={props:{task_id:{required:!0},status:{type:String,required:!0},target_corpus_id:{required:!0}},data(){return{api:new nt}},computed:{isAbortButtonShown(){return["READY","RUNNING"].includes(this.status)}},methods:{async abort(){this.api.submit("/tasks/"+this.task_id+"/abort")}}},Du={class:"task_wrapper"};function Nu(t,e,s,l,i,n){return R(),P("div",Du,[e[1]||(e[1]=x("hr",null,null,-1)),x("p",null,[Me(" Task: "+xt(s.task_id)+" ",1),n.isAbortButtonShown?(R(),P("button",{key:0,class:"task_button btn btn-light",onClick:e[0]||(e[0]=r=>n.abort())}," Abort ")):It("",!0),Me(" for corpus: "+xt(s.target_corpus_id)+" ("+xt(s.status)+") ",1)])])}const Gu=_t(Su,[["render",Nu]]),ju={components:{Task:Gu},data(){return{api:new nt,tasks:[]}},methods:{async updateTasks(){const e=await(await this.api.submit("/tasks/")).json();this.tasks=e}},created(){st.on("updateTasks",this.updateTasks)},beforeDestroy(){st.off("updateTasks",this.updateTasks)}},Ou={class:"tasks"};function Cu(t,e,s,l,i,n){const r=gt("Task");return R(),P(K,null,[e[0]||(e[0]=x("h3",null,"Tasks",-1)),x("div",Ou,[(R(!0),P(K,null,ue(i.tasks,(o,a)=>(R(),_e(r,{key:a,task_id:o.task_id,status:o.status,target_corpus_id:o.target_corpus_id},null,8,["task_id","status","target_corpus_id"]))),128))])],64)}const Ru=_t(ju,[["render",Cu],["__scopeId","data-v-cfa6af6c"]]),Wu={components:{Header:ea,RestAuth:ra,AnnotatorSelect:xa,LocalAnnotatorOptions:Ta,MiscOptions:Wa,CorpusesView:hu,UploadView:wu,AlertsView:Tu,TasksView:Ru},data(){return{}}};function Iu(t,e,s,l,i,n){const r=gt("Header"),o=gt("RestAuth"),a=gt("AnnotatorSelect"),_=gt("LocalAnnotatorOptions"),m=gt("MiscOptions"),f=gt("CorpusesView"),w=gt("UploadView"),N=gt("AlertsView"),W=gt("TasksView");return R(),P(K,null,[x("header",null,[tt(r)]),x("main",null,[tt(o),e[0]||(e[0]=x("hr",null,null,-1)),tt(a),e[1]||(e[1]=x("hr",null,null,-1)),tt(_),e[2]||(e[2]=x("hr",null,null,-1)),tt(m),e[3]||(e[3]=x("hr",null,null,-1)),tt(f),e[4]||(e[4]=x("hr",null,null,-1)),tt(w),e[5]||(e[5]=x("hr",null,null,-1)),tt(N),e[6]||(e[6]=x("hr",null,null,-1)),tt(W)])],64)}const Pu=_t(Wu,[["render",Iu],["__scopeId","data-v-05ed60fe"]]);Qo(Pu).mount("#app");
