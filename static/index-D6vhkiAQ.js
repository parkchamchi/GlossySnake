...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function Js(t){const e=Object.create(null);for(const s of t.split(","))e[s]=1;return s=>s in e}const M={},me=[],Ot=()=>{},ur=()=>!1,gs=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),Qs=t=>t.startsWith("onUpdate:"),st=Object.assign,Zs=(t,e)=>{const s=t.indexOf(e);s>-1&&t.splice(s,1)},dr=Object.prototype.hasOwnProperty,R=(t,e)=>dr.call(t,e),S=Array.isArray,_e=t=>Le(t)==="[object Map]",Ae=t=>Le(t)==="[object Set]",wl=t=>Le(t)==="[object Date]",j=t=>typeof t=="function",Q=t=>typeof t=="string",Ct=t=>typeof t=="symbol",B=t=>t!==null&&typeof t=="object",li=t=>(B(t)||j(t))&&j(t.then)&&j(t.catch),ii=Object.prototype.toString,Le=t=>ii.call(t),mr=t=>Le(t).slice(8,-1),ri=t=>Le(t)==="[object Object]",Ys=t=>Q(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Ne=Js(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),fs=t=>{const e=Object.create(null);return s=>e[s]||(e[s]=t(s))},_r=/-(\w)/g,vt=fs(t=>t.replace(_r,(e,s)=>s?s.toUpperCase():"")),gr=/\B([A-Z])/g,ae=fs(t=>t.replace(gr,"-$1").toLowerCase()),xs=fs(t=>t.charAt(0).toUpperCase()+t.slice(1)),Ds=fs(t=>t?`on${xs(t)}`:""),re=(t,e)=>!Object.is(t,e),ls=(t,...e)=>{for(let s=0;s<t.length;s++)t[s](...e)},ni=(t,e,s,l=!1)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,writable:l,value:s})},as=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let El;const oi=()=>El||(El=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Xs(t){if(S(t)){const e={};for(let s=0;s<t.length;s++){const l=t[s],i=Q(l)?cr(l):Xs(l);if(i)for(const r in i)e[r]=i[r]}return e}else if(Q(t)||B(t))return t}const fr=/;(?![^(]*\))/g,xr=/:([^]+)/,hr=/\/\*[^]*?\*\//g;function cr(t){const e={};return t.replace(hr,"").split(fr).forEach(s=>{if(s){const l=s.split(xr);l.length>1&&(e[l[0].trim()]=l[1].trim())}}),e}function jt(t){let e="";if(Q(t))e=t;else if(S(t))for(let s=0;s<t.length;s++){const l=jt(t[s]);l&&(e+=l+" ")}else if(B(t))for(const s in t)t[s]&&(e+=s+" ");return e.trim()}const pr="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",br=Js(pr);function ai(t){return!!t||t===""}function Ar(t,e){if(t.length!==e.length)return!1;let s=!0;for(let l=0;s&&l<t.length;l++)s=Me(t[l],e[l]);return s}function Me(t,e){if(t===e)return!0;let s=wl(t),l=wl(e);if(s||l)return s&&l?t.getTime()===e.getTime():!1;if(s=Ct(t),l=Ct(e),s||l)return t===e;if(s=S(t),l=S(e),s||l)return s&&l?Ar(t,e):!1;if(s=B(t),l=B(e),s||l){if(!s||!l)return!1;const i=Object.keys(t).length,r=Object.keys(e).length;if(i!==r)return!1;for(const n in t){const o=t.hasOwnProperty(n),u=e.hasOwnProperty(n);if(o&&!u||!o&&u||!Me(t[n],e[n]))return!1}}return String(t)===String(e)}function tl(t,e){return t.findIndex(s=>Me(s,e))}const ui=t=>!!(t&&t.__v_isRef===!0),pt=t=>Q(t)?t:t==null?"":S(t)||B(t)&&(t.toString===ii||!j(t.toString))?ui(t)?pt(t.value):JSON.stringify(t,di,2):String(t),di=(t,e)=>ui(e)?di(t,e.value):_e(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((s,[l,i],r)=>(s[Ss(l,r)+" =>"]=i,s),{})}:Ae(e)?{[`Set(${e.size})`]:[...e.values()].map(s=>Ss(s))}:Ct(e)?Ss(e):B(e)&&!S(e)&&!ri(e)?String(e):e,Ss=(t,e="")=>{var s;return Ct(t)?`Symbol(${(s=t.description)!=null?s:e})`:t};/**
* @vue/reactivity v3.5.5
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let xt;class kr{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=xt,!e&&xt&&(this.index=(xt.scopes||(xt.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,s;if(this.scopes)for(e=0,s=this.scopes.length;e<s;e++)this.scopes[e].pause();for(e=0,s=this.effects.length;e<s;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,s;if(this.scopes)for(e=0,s=this.scopes.length;e<s;e++)this.scopes[e].resume();for(e=0,s=this.effects.length;e<s;e++)this.effects[e].resume()}}run(e){if(this._active){const s=xt;try{return xt=this,e()}finally{xt=s}}}on(){xt=this}off(){xt=this.parent}stop(e){if(this._active){let s,l;for(s=0,l=this.effects.length;s<l;s++)this.effects[s].stop();for(s=0,l=this.cleanups.length;s<l;s++)this.cleanups[s]();if(this.scopes)for(s=0,l=this.scopes.length;s<l;s++)this.scopes[s].stop(!0);if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0,this._active=!1}}}function wr(){return xt}let L;const ys=new WeakSet;class mi{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.nextEffect=void 0,this.cleanup=void 0,this.scheduler=void 0,xt&&xt.active&&xt.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,ys.has(this)&&(ys.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||(this.flags|=8,this.nextEffect=Ge,Ge=this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,vl(this),gi(this);const e=L,s=wt;L=this,wt=!0;try{return this.fn()}finally{fi(this),L=e,wt=s,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)ll(e);this.deps=this.depsTail=void 0,vl(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?ys.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){zs(this)&&this.run()}get dirty(){return zs(this)}}let _i=0,Ge;function el(){_i++}function sl(){if(--_i>0)return;let t;for(;Ge;){let e=Ge;for(Ge=void 0;e;){const s=e.nextEffect;if(e.nextEffect=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(l){t||(t=l)}e=s}}if(t)throw t}function gi(t){for(let e=t.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function fi(t){let e,s=t.depsTail,l=s;for(;l;){const i=l.prevDep;l.version===-1?(l===s&&(s=i),ll(l),Er(l)):e=l,l.dep.activeLink=l.prevActiveLink,l.prevActiveLink=void 0,l=i}t.deps=e,t.depsTail=s}function zs(t){for(let e=t.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&xi(e.dep.computed)||e.dep.version!==e.version)return!0;return!!t._dirty}function xi(t){if(t.flags&4&&!(t.flags&16)||(t.flags&=-17,t.globalVersion===Ie))return;t.globalVersion=Ie;const e=t.dep;if(t.flags|=2,e.version>0&&!t.isSSR&&!zs(t)){t.flags&=-3;return}const s=L,l=wt;L=t,wt=!0;try{gi(t);const i=t.fn(t._value);(e.version===0||re(i,t._value))&&(t._value=i,e.version++)}catch(i){throw e.version++,i}finally{L=s,wt=l,fi(t),t.flags&=-3}}function ll(t){const{dep:e,prevSub:s,nextSub:l}=t;if(s&&(s.nextSub=l,t.prevSub=void 0),l&&(l.prevSub=s,t.nextSub=void 0),e.subs===t&&(e.subs=s),!e.subs&&e.computed){e.computed.flags&=-5;for(let i=e.computed.deps;i;i=i.nextDep)ll(i)}}function Er(t){const{prevDep:e,nextDep:s}=t;e&&(e.nextDep=s,t.prevDep=void 0),s&&(s.prevDep=e,t.nextDep=void 0)}let wt=!0;const hi=[];function Jt(){hi.push(wt),wt=!1}function Qt(){const t=hi.pop();wt=t===void 0?!0:t}function vl(t){const{cleanup:e}=t;if(t.cleanup=void 0,e){const s=L;L=void 0;try{e()}finally{L=s}}}let Ie=0;class vr{constructor(e,s){this.sub=e,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class ci{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0}track(e){if(!L||!wt||L===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==L)s=this.activeLink=new vr(L,this),L.deps?(s.prevDep=L.depsTail,L.depsTail.nextDep=s,L.depsTail=s):L.deps=L.depsTail=s,L.flags&4&&pi(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const l=s.nextDep;l.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=l),s.prevDep=L.depsTail,s.nextDep=void 0,L.depsTail.nextDep=s,L.depsTail=s,L.deps===s&&(L.deps=l)}return s}trigger(e){this.version++,Ie++,this.notify(e)}notify(e){el();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()}finally{sl()}}}function pi(t){const e=t.dep.computed;if(e&&!t.dep.subs){e.flags|=20;for(let l=e.deps;l;l=l.nextDep)pi(l)}const s=t.dep.subs;s!==t&&(t.prevSub=s,s&&(s.nextSub=t)),t.dep.subs=t}const Hs=new WeakMap,le=Symbol(""),Fs=Symbol(""),Re=Symbol("");function lt(t,e,s){if(wt&&L){let l=Hs.get(t);l||Hs.set(t,l=new Map);let i=l.get(s);i||l.set(s,i=new ci),i.track()}}function zt(t,e,s,l,i,r){const n=Hs.get(t);if(!n){Ie++;return}const o=u=>{u&&u.trigger()};if(el(),e==="clear")n.forEach(o);else{const u=S(t),g=u&&Ys(s);if(u&&s==="length"){const m=Number(l);n.forEach((f,k)=>{(k==="length"||k===Re||!Ct(k)&&k>=m)&&o(f)})}else switch(s!==void 0&&o(n.get(s)),g&&o(n.get(Re)),e){case"add":u?g&&o(n.get("length")):(o(n.get(le)),_e(t)&&o(n.get(Fs)));break;case"delete":u||(o(n.get(le)),_e(t)&&o(n.get(Fs)));break;case"set":_e(t)&&o(n.get(le));break}}sl()}function ue(t){const e=F(t);return e===t?e:(lt(e,"iterate",Re),Et(t)?e:e.map(ut))}function hs(t){return lt(t=F(t),"iterate",Re),t}const Tr={__proto__:null,[Symbol.iterator](){return Ns(this,Symbol.iterator,ut)},concat(...t){return ue(this).concat(...t.map(e=>S(e)?ue(e):e))},entries(){return Ns(this,"entries",t=>(t[1]=ut(t[1]),t))},every(t,e){return It(this,"every",t,e,void 0,arguments)},filter(t,e){return It(this,"filter",t,e,s=>s.map(ut),arguments)},find(t,e){return It(this,"find",t,e,ut,arguments)},findIndex(t,e){return It(this,"findIndex",t,e,void 0,arguments)},findLast(t,e){return It(this,"findLast",t,e,ut,arguments)},findLastIndex(t,e){return It(this,"findLastIndex",t,e,void 0,arguments)},forEach(t,e){return It(this,"forEach",t,e,void 0,arguments)},includes(...t){return Gs(this,"includes",t)},indexOf(...t){return Gs(this,"indexOf",t)},join(t){return ue(this).join(t)},lastIndexOf(...t){return Gs(this,"lastIndexOf",t)},map(t,e){return It(this,"map",t,e,void 0,arguments)},pop(){return Te(this,"pop")},push(...t){return Te(this,"push",t)},reduce(t,...e){return Tl(this,"reduce",t,e)},reduceRight(t,...e){return Tl(this,"reduceRight",t,e)},shift(){return Te(this,"shift")},some(t,e){return It(this,"some",t,e,void 0,arguments)},splice(...t){return Te(this,"splice",t)},toReversed(){return ue(this).toReversed()},toSorted(t){return ue(this).toSorted(t)},toSpliced(...t){return ue(this).toSpliced(...t)},unshift(...t){return Te(this,"unshift",t)},values(){return Ns(this,"values",ut)}};function Ns(t,e,s){const l=hs(t),i=l[e]();return l!==t&&!Et(t)&&(i._next=i.next,i.next=()=>{const r=i._next();return r.value&&(r.value=s(r.value)),r}),i}const Dr=Array.prototype;function It(t,e,s,l,i,r){const n=hs(t),o=n!==t&&!Et(t),u=n[e];if(u!==Dr[e]){const f=u.apply(t,r);return o?ut(f):f}let g=s;n!==t&&(o?g=function(f,k){return s.call(this,ut(f),k,t)}:s.length>2&&(g=function(f,k){return s.call(this,f,k,t)}));const m=u.call(n,g,l);return o&&i?i(m):m}function Tl(t,e,s,l){const i=hs(t);let r=s;return i!==t&&(Et(t)?s.length>3&&(r=function(n,o,u){return s.call(this,n,o,u,t)}):r=function(n,o,u){return s.call(this,n,ut(o),u,t)}),i[e](r,...l)}function Gs(t,e,s){const l=F(t);lt(l,"iterate",Re);const i=l[e](...s);return(i===-1||i===!1)&&ol(s[0])?(s[0]=F(s[0]),l[e](...s)):i}function Te(t,e,s=[]){Jt(),el();const l=F(t)[e].apply(t,s);return sl(),Qt(),l}const Sr=Js("__proto__,__v_isRef,__isVue"),bi=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Ct));function yr(t){Ct(t)||(t=String(t));const e=F(this);return lt(e,"has",t),e.hasOwnProperty(t)}class Ai{constructor(e=!1,s=!1){this._isReadonly=e,this._isShallow=s}get(e,s,l){const i=this._isReadonly,r=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return r;if(s==="__v_raw")return l===(i?r?Lr:vi:r?Ei:wi).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(l)?e:void 0;const n=S(e);if(!i){let u;if(n&&(u=Tr[s]))return u;if(s==="hasOwnProperty")return yr}const o=Reflect.get(e,s,at(e)?e:l);return(Ct(s)?bi.has(s):Sr(s))||(i||lt(e,"get",s),r)?o:at(o)?n&&Ys(s)?o:o.value:B(o)?i?Ti(o):qe(o):o}}class ki extends Ai{constructor(e=!1){super(!1,e)}set(e,s,l,i){let r=e[s];if(!this._isShallow){const u=ce(r);if(!Et(l)&&!ce(l)&&(r=F(r),l=F(l)),!S(e)&&at(r)&&!at(l))return u?!1:(r.value=l,!0)}const n=S(e)&&Ys(s)?Number(s)<e.length:R(e,s),o=Reflect.set(e,s,l,at(e)?e:i);return e===F(i)&&(n?re(l,r)&&zt(e,"set",s,l):zt(e,"add",s,l)),o}deleteProperty(e,s){const l=R(e,s);e[s];const i=Reflect.deleteProperty(e,s);return i&&l&&zt(e,"delete",s,void 0),i}has(e,s){const l=Reflect.has(e,s);return(!Ct(s)||!bi.has(s))&&lt(e,"has",s),l}ownKeys(e){return lt(e,"iterate",S(e)?"length":le),Reflect.ownKeys(e)}}class Nr extends Ai{constructor(e=!1){super(!0,e)}set(e,s){return!0}deleteProperty(e,s){return!0}}const Gr=new ki,jr=new Nr,Or=new ki(!0);const il=t=>t,cs=t=>Reflect.getPrototypeOf(t);function Ze(t,e,s=!1,l=!1){t=t.__v_raw;const i=F(t),r=F(e);s||(re(e,r)&&lt(i,"get",e),lt(i,"get",r));const{has:n}=cs(i),o=l?il:s?al:ut;if(n.call(i,e))return o(t.get(e));if(n.call(i,r))return o(t.get(r));t!==i&&t.get(e)}function Ye(t,e=!1){const s=this.__v_raw,l=F(s),i=F(t);return e||(re(t,i)&&lt(l,"has",t),lt(l,"has",i)),t===i?s.has(t):s.has(t)||s.has(i)}function Xe(t,e=!1){return t=t.__v_raw,!e&&lt(F(t),"iterate",le),Reflect.get(t,"size",t)}function Dl(t,e=!1){!e&&!Et(t)&&!ce(t)&&(t=F(t));const s=F(this);return cs(s).has.call(s,t)||(s.add(t),zt(s,"add",t,t)),this}function Sl(t,e,s=!1){!s&&!Et(e)&&!ce(e)&&(e=F(e));const l=F(this),{has:i,get:r}=cs(l);let n=i.call(l,t);n||(t=F(t),n=i.call(l,t));const o=r.call(l,t);return l.set(t,e),n?re(e,o)&&zt(l,"set",t,e):zt(l,"add",t,e),this}function yl(t){const e=F(this),{has:s,get:l}=cs(e);let i=s.call(e,t);i||(t=F(t),i=s.call(e,t)),l&&l.call(e,t);const r=e.delete(t);return i&&zt(e,"delete",t,void 0),r}function Nl(){const t=F(this),e=t.size!==0,s=t.clear();return e&&zt(t,"clear",void 0,void 0),s}function ts(t,e){return function(l,i){const r=this,n=r.__v_raw,o=F(n),u=e?il:t?al:ut;return!t&&lt(o,"iterate",le),n.forEach((g,m)=>l.call(i,u(g),u(m),r))}}function es(t,e,s){return function(...l){const i=this.__v_raw,r=F(i),n=_e(r),o=t==="entries"||t===Symbol.iterator&&n,u=t==="keys"&&n,g=i[t](...l),m=s?il:e?al:ut;return!e&&lt(r,"iterate",u?Fs:le),{next(){const{value:f,done:k}=g.next();return k?{value:f,done:k}:{value:o?[m(f[0]),m(f[1])]:m(f),done:k}},[Symbol.iterator](){return this}}}}function qt(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function Cr(){const t={get(r){return Ze(this,r)},get size(){return Xe(this)},has:Ye,add:Dl,set:Sl,delete:yl,clear:Nl,forEach:ts(!1,!1)},e={get(r){return Ze(this,r,!1,!0)},get size(){return Xe(this)},has:Ye,add(r){return Dl.call(this,r,!0)},set(r,n){return Sl.call(this,r,n,!0)},delete:yl,clear:Nl,forEach:ts(!1,!0)},s={get(r){return Ze(this,r,!0)},get size(){return Xe(this,!0)},has(r){return Ye.call(this,r,!0)},add:qt("add"),set:qt("set"),delete:qt("delete"),clear:qt("clear"),forEach:ts(!0,!1)},l={get(r){return Ze(this,r,!0,!0)},get size(){return Xe(this,!0)},has(r){return Ye.call(this,r,!0)},add:qt("add"),set:qt("set"),delete:qt("delete"),clear:qt("clear"),forEach:ts(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=es(r,!1,!1),s[r]=es(r,!0,!1),e[r]=es(r,!1,!0),l[r]=es(r,!0,!0)}),[t,s,e,l]}const[Wr,Ir,Rr,Pr]=Cr();function rl(t,e){const s=e?t?Pr:Rr:t?Ir:Wr;return(l,i,r)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?l:Reflect.get(R(s,i)&&i in l?s:l,i,r)}const zr={get:rl(!1,!1)},Hr={get:rl(!1,!0)},Fr={get:rl(!0,!1)};const wi=new WeakMap,Ei=new WeakMap,vi=new WeakMap,Lr=new WeakMap;function Mr(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function qr(t){return t.__v_skip||!Object.isExtensible(t)?0:Mr(mr(t))}function qe(t){return ce(t)?t:nl(t,!1,Gr,zr,wi)}function Ur(t){return nl(t,!1,Or,Hr,Ei)}function Ti(t){return nl(t,!0,jr,Fr,vi)}function nl(t,e,s,l,i){if(!B(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=i.get(t);if(r)return r;const n=qr(t);if(n===0)return t;const o=new Proxy(t,n===2?l:s);return i.set(t,o),o}function ge(t){return ce(t)?ge(t.__v_raw):!!(t&&t.__v_isReactive)}function ce(t){return!!(t&&t.__v_isReadonly)}function Et(t){return!!(t&&t.__v_isShallow)}function ol(t){return t?!!t.__v_raw:!1}function F(t){const e=t&&t.__v_raw;return e?F(e):t}function Br(t){return!R(t,"__v_skip")&&Object.isExtensible(t)&&ni(t,"__v_skip",!0),t}const ut=t=>B(t)?qe(t):t,al=t=>B(t)?Ti(t):t;function at(t){return t?t.__v_isRef===!0:!1}function Vr(t){return at(t)?t.value:t}const Kr={get:(t,e,s)=>e==="__v_raw"?t:Vr(Reflect.get(t,e,s)),set:(t,e,s,l)=>{const i=t[e];return at(i)&&!at(s)?(i.value=s,!0):Reflect.set(t,e,s,l)}};function Di(t){return ge(t)?t:new Proxy(t,Kr)}class $r{constructor(e,s,l){this.fn=e,this.setter=s,this._value=void 0,this.dep=new ci(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Ie-1,this.effect=this,this.__v_isReadonly=!s,this.isSSR=l}notify(){this.flags|=16,L!==this&&this.dep.notify()}get value(){const e=this.dep.track();return xi(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function Jr(t,e,s=!1){let l,i;return j(t)?l=t:(l=t.get,i=t.set),new $r(l,i,s)}const ss={},us=new WeakMap;let se;function Qr(t,e=!1,s=se){if(s){let l=us.get(s);l||us.set(s,l=[]),l.push(t)}}function Zr(t,e,s=M){const{immediate:l,deep:i,once:r,scheduler:n,augmentJob:o,call:u}=s,g=y=>i?y:Et(y)||i===!1||i===0?Pt(y,1):Pt(y);let m,f,k,G,I=!1,W=!1;if(at(t)?(f=()=>t.value,I=Et(t)):ge(t)?(f=()=>g(t),I=!0):S(t)?(W=!0,I=t.some(y=>ge(y)||Et(y)),f=()=>t.map(y=>{if(at(y))return y.value;if(ge(y))return g(y);if(j(y))return u?u(y,2):y()})):j(t)?e?f=u?()=>u(t,2):t:f=()=>{if(k){Jt();try{k()}finally{Qt()}}const y=se;se=m;try{return u?u(t,3,[G]):t(G)}finally{se=y}}:f=Ot,e&&i){const y=f,Z=i===!0?1/0:i;f=()=>Pt(y(),Z)}const it=wr(),H=()=>{m.stop(),it&&Zs(it.effects,m)};if(r)if(e){const y=e;e=(...Z)=>{y(...Z),H()}}else{const y=f;f=()=>{y(),H()}}let K=W?new Array(t.length).fill(ss):ss;const $=y=>{if(!(!(m.flags&1)||!m.dirty&&!y))if(e){const Z=m.run();if(i||I||(W?Z.some((Lt,Tt)=>re(Lt,K[Tt])):re(Z,K))){k&&k();const Lt=se;se=m;try{const Tt=[Z,K===ss?void 0:W&&K[0]===ss?[]:K,G];u?u(e,3,Tt):e(...Tt),K=Z}finally{se=Lt}}}else m.run()};return o&&o($),m=new mi(f),m.scheduler=n?()=>n($,!1):$,G=y=>Qr(y,!1,m),k=m.onStop=()=>{const y=us.get(m);if(y){if(u)u(y,4);else for(const Z of y)Z();us.delete(m)}},e?l?$(!0):K=m.run():n?n($.bind(null,!0),!0):m.run(),H.pause=m.pause.bind(m),H.resume=m.resume.bind(m),H.stop=H,H}function Pt(t,e=1/0,s){if(e<=0||!B(t)||t.__v_skip||(s=s||new Set,s.has(t)))return t;if(s.add(t),e--,at(t))Pt(t.value,e,s);else if(S(t))for(let l=0;l<t.length;l++)Pt(t[l],e,s);else if(Ae(t)||_e(t))t.forEach(l=>{Pt(l,e,s)});else if(ri(t)){for(const l in t)Pt(t[l],e,s);for(const l of Object.getOwnPropertySymbols(t))Object.prototype.propertyIsEnumerable.call(t,l)&&Pt(t[l],e,s)}return t}/**
* @vue/runtime-core v3.5.5
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ue(t,e,s,l){try{return l?t(...l):t()}catch(i){ps(i,e,s)}}function Wt(t,e,s,l){if(j(t)){const i=Ue(t,e,s,l);return i&&li(i)&&i.catch(r=>{ps(r,e,s)}),i}if(S(t)){const i=[];for(let r=0;r<t.length;r++)i.push(Wt(t[r],e,s,l));return i}}function ps(t,e,s,l=!0){const i=e?e.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:n}=e&&e.appContext.config||M;if(e){let o=e.parent;const u=e.proxy,g=`https://vuejs.org/error-reference/#runtime-${s}`;for(;o;){const m=o.ec;if(m){for(let f=0;f<m.length;f++)if(m[f](t,u,g)===!1)return}o=o.parent}if(r){Jt(),Ue(r,null,10,[t,u,g]),Qt();return}}Yr(t,s,i,l,n)}function Yr(t,e,s,l=!0,i=!1){if(i)throw t;console.error(t)}let Pe=!1,Ls=!1;const ot=[];let Nt=0;const fe=[];let Bt=null,de=0;const Si=Promise.resolve();let ul=null;function yi(t){const e=ul||Si;return t?e.then(this?t.bind(this):t):e}function Xr(t){let e=Pe?Nt+1:0,s=ot.length;for(;e<s;){const l=e+s>>>1,i=ot[l],r=ze(i);r<t||r===t&&i.flags&2?e=l+1:s=l}return e}function dl(t){if(!(t.flags&1)){const e=ze(t),s=ot[ot.length-1];!s||!(t.flags&2)&&e>=ze(s)?ot.push(t):ot.splice(Xr(e),0,t),t.flags|=1,Ni()}}function Ni(){!Pe&&!Ls&&(Ls=!0,ul=Si.then(ji))}function tn(t){S(t)?fe.push(...t):Bt&&t.id===-1?Bt.splice(de+1,0,t):t.flags&1||(fe.push(t),t.flags|=1),Ni()}function Gl(t,e,s=Pe?Nt+1:0){for(;s<ot.length;s++){const l=ot[s];if(l&&l.flags&2){if(t&&l.id!==t.uid)continue;ot.splice(s,1),s--,l.flags&4&&(l.flags&=-2),l(),l.flags&=-2}}}function Gi(t){if(fe.length){const e=[...new Set(fe)].sort((s,l)=>ze(s)-ze(l));if(fe.length=0,Bt){Bt.push(...e);return}for(Bt=e,de=0;de<Bt.length;de++){const s=Bt[de];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}Bt=null,de=0}}const ze=t=>t.id==null?t.flags&2?-1:1/0:t.id;function ji(t){Ls=!1,Pe=!0;try{for(Nt=0;Nt<ot.length;Nt++){const e=ot[Nt];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),Ue(e,e.i,e.i?15:14),e.flags&=-2)}}finally{for(;Nt<ot.length;Nt++){const e=ot[Nt];e&&(e.flags&=-2)}Nt=0,ot.length=0,Gi(),Pe=!1,ul=null,(ot.length||fe.length)&&ji()}}let ht=null,Oi=null;function ds(t){const e=ht;return ht=t,Oi=t&&t.type.__scopeId||null,e}function en(t,e=ht,s){if(!e||t._n)return t;const l=(...i)=>{l._d&&Hl(-1);const r=ds(e);let n;try{n=t(...i)}finally{ds(r),l._d&&Hl(1)}return n};return l._n=!0,l._c=!0,l._d=!0,l}function je(t,e){if(ht===null)return t;const s=Es(ht),l=t.dirs||(t.dirs=[]);for(let i=0;i<e.length;i++){let[r,n,o,u=M]=e[i];r&&(j(r)&&(r={mounted:r,updated:r}),r.deep&&Pt(n),l.push({dir:r,instance:s,value:n,oldValue:void 0,arg:o,modifiers:u}))}return t}function te(t,e,s,l){const i=t.dirs,r=e&&e.dirs;for(let n=0;n<i.length;n++){const o=i[n];r&&(o.oldValue=r[n].value);let u=o.dir[l];u&&(Jt(),Wt(u,s,8,[t.el,o,t,e]),Qt())}}const sn=Symbol("_vte"),ln=t=>t.__isTeleport;function ml(t,e){t.shapeFlag&6&&t.component?(t.transition=e,ml(t.component.subTree,e)):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function Ci(t){t.ids=[t.ids[0]+t.ids[2]+++"-",0,0]}function Ms(t,e,s,l,i=!1){if(S(t)){t.forEach((I,W)=>Ms(I,e&&(S(e)?e[W]:e),s,l,i));return}if(Oe(l)&&!i)return;const r=l.shapeFlag&4?Es(l.component):l.el,n=i?null:r,{i:o,r:u}=t,g=e&&e.r,m=o.refs===M?o.refs={}:o.refs,f=o.setupState,k=F(f),G=f===M?()=>!1:I=>R(k,I);if(g!=null&&g!==u&&(Q(g)?(m[g]=null,G(g)&&(f[g]=null)):at(g)&&(g.value=null)),j(u))Ue(u,o,12,[n,m]);else{const I=Q(u),W=at(u);if(I||W){const it=()=>{if(t.f){const H=I?G(u)?f[u]:m[u]:u.value;i?S(H)&&Zs(H,r):S(H)?H.includes(r)||H.push(r):I?(m[u]=[r],G(u)&&(f[u]=m[u])):(u.value=[r],t.k&&(m[t.k]=u.value))}else I?(m[u]=n,G(u)&&(f[u]=n)):W&&(u.value=n,t.k&&(m[t.k]=n))};n?(it.id=-1,ft(it,s)):it()}}}const Oe=t=>!!t.type.__asyncLoader,Wi=t=>t.type.__isKeepAlive;function rn(t,e){Ii(t,"a",e)}function nn(t,e){Ii(t,"da",e)}function Ii(t,e,s=tt){const l=t.__wdc||(t.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(bs(e,l,s),s){let i=s.parent;for(;i&&i.parent;)Wi(i.parent.vnode)&&on(l,e,s,i),i=i.parent}}function on(t,e,s,l){const i=bs(e,t,l,!0);Ri(()=>{Zs(l[e],i)},s)}function bs(t,e,s=tt,l=!1){if(s){const i=s[t]||(s[t]=[]),r=e.__weh||(e.__weh=(...n)=>{Jt();const o=Be(s),u=Wt(e,s,t,n);return o(),Qt(),u});return l?i.unshift(r):i.push(r),r}}const Ft=t=>(e,s=tt)=>{(!ws||t==="sp")&&bs(t,(...l)=>e(...l),s)},an=Ft("bm"),un=Ft("m"),dn=Ft("bu"),mn=Ft("u"),_n=Ft("bum"),Ri=Ft("um"),gn=Ft("sp"),fn=Ft("rtg"),xn=Ft("rtc");function hn(t,e=tt){bs("ec",t,e)}const Pi="components";function At(t,e){return pn(Pi,t,!0,e)||t}const cn=Symbol.for("v-ndc");function pn(t,e,s=!0,l=!1){const i=ht||tt;if(i){const r=i.type;if(t===Pi){const o=oo(r,!1);if(o&&(o===e||o===vt(e)||o===xs(vt(e))))return r}const n=jl(i[t]||r[t],e)||jl(i.appContext[t],e);return!n&&l?r:n}}function jl(t,e){return t&&(t[e]||t[vt(e)]||t[xs(vt(e))])}function ie(t,e,s,l){let i;const r=s,n=S(t);if(n||Q(t)){const o=n&&ge(t);let u=!1;o&&(u=!Et(t),t=hs(t)),i=new Array(t.length);for(let g=0,m=t.length;g<m;g++)i[g]=e(u?ut(t[g]):t[g],g,void 0,r)}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,r)}else if(B(t))if(t[Symbol.iterator])i=Array.from(t,(o,u)=>e(o,u,void 0,r));else{const o=Object.keys(t);i=new Array(o.length);for(let u=0,g=o.length;u<g;u++){const m=o[u];i[u]=e(t[m],m,u,r)}}else i=[];return i}const qs=t=>t?lr(t)?Es(t):qs(t.parent):null,Ce=st(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>qs(t.parent),$root:t=>qs(t.root),$host:t=>t.ce,$emit:t=>t.emit,$options:t=>_l(t),$forceUpdate:t=>t.f||(t.f=()=>{dl(t.update)}),$nextTick:t=>t.n||(t.n=yi.bind(t.proxy)),$watch:t=>Fn.bind(t)}),js=(t,e)=>t!==M&&!t.__isScriptSetup&&R(t,e),bn={get({_:t},e){if(e==="__v_skip")return!0;const{ctx:s,setupState:l,data:i,props:r,accessCache:n,type:o,appContext:u}=t;let g;if(e[0]!=="$"){const G=n[e];if(G!==void 0)switch(G){case 1:return l[e];case 2:return i[e];case 4:return s[e];case 3:return r[e]}else{if(js(l,e))return n[e]=1,l[e];if(i!==M&&R(i,e))return n[e]=2,i[e];if((g=t.propsOptions[0])&&R(g,e))return n[e]=3,r[e];if(s!==M&&R(s,e))return n[e]=4,s[e];Us&&(n[e]=0)}}const m=Ce[e];let f,k;if(m)return e==="$attrs"&&lt(t.attrs,"get",""),m(t);if((f=o.__cssModules)&&(f=f[e]))return f;if(s!==M&&R(s,e))return n[e]=4,s[e];if(k=u.config.globalProperties,R(k,e))return k[e]},set({_:t},e,s){const{data:l,setupState:i,ctx:r}=t;return js(i,e)?(i[e]=s,!0):l!==M&&R(l,e)?(l[e]=s,!0):R(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=s,!0)},has({_:{data:t,setupState:e,accessCache:s,ctx:l,appContext:i,propsOptions:r}},n){let o;return!!s[n]||t!==M&&R(t,n)||js(e,n)||(o=r[0])&&R(o,n)||R(l,n)||R(Ce,n)||R(i.config.globalProperties,n)},defineProperty(t,e,s){return s.get!=null?t._.accessCache[e]=0:R(s,"value")&&this.set(t,e,s.value,null),Reflect.defineProperty(t,e,s)}};function Ol(t){return S(t)?t.reduce((e,s)=>(e[s]=null,e),{}):t}let Us=!0;function An(t){const e=_l(t),s=t.proxy,l=t.ctx;Us=!1,e.beforeCreate&&Cl(e.beforeCreate,t,"bc");const{data:i,computed:r,methods:n,watch:o,provide:u,inject:g,created:m,beforeMount:f,mounted:k,beforeUpdate:G,updated:I,activated:W,deactivated:it,beforeDestroy:H,beforeUnmount:K,destroyed:$,unmounted:y,render:Z,renderTracked:Lt,renderTriggered:Tt,errorCaptured:Mt,serverPrefetch:Ve,expose:Zt,inheritAttrs:ke,components:Ke,directives:$e,filters:vs}=e;if(g&&kn(g,l,null),n)for(const V in n){const q=n[V];j(q)&&(l[V]=q.bind(s))}if(i){const V=i.call(s,s);B(V)&&(t.data=qe(V))}if(Us=!0,r)for(const V in r){const q=r[V],Yt=j(q)?q.bind(s,s):j(q.get)?q.get.bind(s,s):Ot,Je=!j(q)&&j(q.set)?q.set.bind(s):Ot,Xt=uo({get:Yt,set:Je});Object.defineProperty(l,V,{enumerable:!0,configurable:!0,get:()=>Xt.value,set:Dt=>Xt.value=Dt})}if(o)for(const V in o)zi(o[V],l,s,V);if(u){const V=j(u)?u.call(s):u;Reflect.ownKeys(V).forEach(q=>{Sn(q,V[q])})}m&&Cl(m,t,"c");function rt(V,q){S(q)?q.forEach(Yt=>V(Yt.bind(s))):q&&V(q.bind(s))}if(rt(an,f),rt(un,k),rt(dn,G),rt(mn,I),rt(rn,W),rt(nn,it),rt(hn,Mt),rt(xn,Lt),rt(fn,Tt),rt(_n,K),rt(Ri,y),rt(gn,Ve),S(Zt))if(Zt.length){const V=t.exposed||(t.exposed={});Zt.forEach(q=>{Object.defineProperty(V,q,{get:()=>s[q],set:Yt=>s[q]=Yt})})}else t.exposed||(t.exposed={});Z&&t.render===Ot&&(t.render=Z),ke!=null&&(t.inheritAttrs=ke),Ke&&(t.components=Ke),$e&&(t.directives=$e),Ve&&Ci(t)}function kn(t,e,s=Ot){S(t)&&(t=Bs(t));for(const l in t){const i=t[l];let r;B(i)?"default"in i?r=is(i.from||l,i.default,!0):r=is(i.from||l):r=is(i),at(r)?Object.defineProperty(e,l,{enumerable:!0,configurable:!0,get:()=>r.value,set:n=>r.value=n}):e[l]=r}}function Cl(t,e,s){Wt(S(t)?t.map(l=>l.bind(e.proxy)):t.bind(e.proxy),e,s)}function zi(t,e,s,l){let i=l.includes(".")?Yi(s,l):()=>s[l];if(Q(t)){const r=e[t];j(r)&&Cs(i,r)}else if(j(t))Cs(i,t.bind(s));else if(B(t))if(S(t))t.forEach(r=>zi(r,e,s,l));else{const r=j(t.handler)?t.handler.bind(s):e[t.handler];j(r)&&Cs(i,r,t)}}function _l(t){const e=t.type,{mixins:s,extends:l}=e,{mixins:i,optionsCache:r,config:{optionMergeStrategies:n}}=t.appContext,o=r.get(e);let u;return o?u=o:!i.length&&!s&&!l?u=e:(u={},i.length&&i.forEach(g=>ms(u,g,n,!0)),ms(u,e,n)),B(e)&&r.set(e,u),u}function ms(t,e,s,l=!1){const{mixins:i,extends:r}=e;r&&ms(t,r,s,!0),i&&i.forEach(n=>ms(t,n,s,!0));for(const n in e)if(!(l&&n==="expose")){const o=wn[n]||s&&s[n];t[n]=o?o(t[n],e[n]):e[n]}return t}const wn={data:Wl,props:Il,emits:Il,methods:Se,computed:Se,beforeCreate:nt,created:nt,beforeMount:nt,mounted:nt,beforeUpdate:nt,updated:nt,beforeDestroy:nt,beforeUnmount:nt,destroyed:nt,unmounted:nt,activated:nt,deactivated:nt,errorCaptured:nt,serverPrefetch:nt,components:Se,directives:Se,watch:vn,provide:Wl,inject:En};function Wl(t,e){return e?t?function(){return st(j(t)?t.call(this,this):t,j(e)?e.call(this,this):e)}:e:t}function En(t,e){return Se(Bs(t),Bs(e))}function Bs(t){if(S(t)){const e={};for(let s=0;s<t.length;s++)e[t[s]]=t[s];return e}return t}function nt(t,e){return t?[...new Set([].concat(t,e))]:e}function Se(t,e){return t?st(Object.create(null),t,e):e}function Il(t,e){return t?S(t)&&S(e)?[...new Set([...t,...e])]:st(Object.create(null),Ol(t),Ol(e??{})):e}function vn(t,e){if(!t)return e;if(!e)return t;const s=st(Object.create(null),t);for(const l in e)s[l]=nt(t[l],e[l]);return s}function Hi(){return{app:null,config:{isNativeTag:ur,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Tn=0;function Dn(t,e){return function(l,i=null){j(l)||(l=st({},l)),i!=null&&!B(i)&&(i=null);const r=Hi(),n=new WeakSet,o=[];let u=!1;const g=r.app={_uid:Tn++,_component:l,_props:i,_container:null,_context:r,_instance:null,version:mo,get config(){return r.config},set config(m){},use(m,...f){return n.has(m)||(m&&j(m.install)?(n.add(m),m.install(g,...f)):j(m)&&(n.add(m),m(g,...f))),g},mixin(m){return r.mixins.includes(m)||r.mixins.push(m),g},component(m,f){return f?(r.components[m]=f,g):r.components[m]},directive(m,f){return f?(r.directives[m]=f,g):r.directives[m]},mount(m,f,k){if(!u){const G=g._ceVNode||Y(l,i);return G.appContext=r,k===!0?k="svg":k===!1&&(k=void 0),f&&e?e(G,m):t(G,m,k),u=!0,g._container=m,m.__vue_app__=g,Es(G.component)}},onUnmount(m){o.push(m)},unmount(){u&&(Wt(o,g._instance,16),t(null,g._container),delete g._container.__vue_app__)},provide(m,f){return r.provides[m]=f,g},runWithContext(m){const f=xe;xe=g;try{return m()}finally{xe=f}}};return g}}let xe=null;function Sn(t,e){if(tt){let s=tt.provides;const l=tt.parent&&tt.parent.provides;l===s&&(s=tt.provides=Object.create(l)),s[t]=e}}function is(t,e,s=!1){const l=tt||ht;if(l||xe){const i=xe?xe._context.provides:l?l.parent==null?l.vnode.appContext&&l.vnode.appContext.provides:l.parent.provides:void 0;if(i&&t in i)return i[t];if(arguments.length>1)return s&&j(e)?e.call(l&&l.proxy):e}}const Fi={},Li=()=>Object.create(Fi),Mi=t=>Object.getPrototypeOf(t)===Fi;function yn(t,e,s,l=!1){const i={},r=Li();t.propsDefaults=Object.create(null),qi(t,e,i,r);for(const n in t.propsOptions[0])n in i||(i[n]=void 0);s?t.props=l?i:Ur(i):t.type.props?t.props=i:t.props=r,t.attrs=r}function Nn(t,e,s,l){const{props:i,attrs:r,vnode:{patchFlag:n}}=t,o=F(i),[u]=t.propsOptions;let g=!1;if((l||n>0)&&!(n&16)){if(n&8){const m=t.vnode.dynamicProps;for(let f=0;f<m.length;f++){let k=m[f];if(As(t.emitsOptions,k))continue;const G=e[k];if(u)if(R(r,k))G!==r[k]&&(r[k]=G,g=!0);else{const I=vt(k);i[I]=Vs(u,o,I,G,t,!1)}else G!==r[k]&&(r[k]=G,g=!0)}}}else{qi(t,e,i,r)&&(g=!0);let m;for(const f in o)(!e||!R(e,f)&&((m=ae(f))===f||!R(e,m)))&&(u?s&&(s[f]!==void 0||s[m]!==void 0)&&(i[f]=Vs(u,o,f,void 0,t,!0)):delete i[f]);if(r!==o)for(const f in r)(!e||!R(e,f))&&(delete r[f],g=!0)}g&&zt(t.attrs,"set","")}function qi(t,e,s,l){const[i,r]=t.propsOptions;let n=!1,o;if(e)for(let u in e){if(Ne(u))continue;const g=e[u];let m;i&&R(i,m=vt(u))?!r||!r.includes(m)?s[m]=g:(o||(o={}))[m]=g:As(t.emitsOptions,u)||(!(u in l)||g!==l[u])&&(l[u]=g,n=!0)}if(r){const u=F(s),g=o||M;for(let m=0;m<r.length;m++){const f=r[m];s[f]=Vs(i,u,f,g[f],t,!R(g,f))}}return n}function Vs(t,e,s,l,i,r){const n=t[s];if(n!=null){const o=R(n,"default");if(o&&l===void 0){const u=n.default;if(n.type!==Function&&!n.skipFactory&&j(u)){const{propsDefaults:g}=i;if(s in g)l=g[s];else{const m=Be(i);l=g[s]=u.call(null,e),m()}}else l=u;i.ce&&i.ce._setProp(s,l)}n[0]&&(r&&!o?l=!1:n[1]&&(l===""||l===ae(s))&&(l=!0))}return l}const Gn=new WeakMap;function Ui(t,e,s=!1){const l=s?Gn:e.propsCache,i=l.get(t);if(i)return i;const r=t.props,n={},o=[];let u=!1;if(!j(t)){const m=f=>{u=!0;const[k,G]=Ui(f,e,!0);st(n,k),G&&o.push(...G)};!s&&e.mixins.length&&e.mixins.forEach(m),t.extends&&m(t.extends),t.mixins&&t.mixins.forEach(m)}if(!r&&!u)return B(t)&&l.set(t,me),me;if(S(r))for(let m=0;m<r.length;m++){const f=vt(r[m]);Rl(f)&&(n[f]=M)}else if(r)for(const m in r){const f=vt(m);if(Rl(f)){const k=r[m],G=n[f]=S(k)||j(k)?{type:k}:st({},k),I=G.type;let W=!1,it=!0;if(S(I))for(let H=0;H<I.length;++H){const K=I[H],$=j(K)&&K.name;if($==="Boolean"){W=!0;break}else $==="String"&&(it=!1)}else W=j(I)&&I.name==="Boolean";G[0]=W,G[1]=it,(W||R(G,"default"))&&o.push(f)}}const g=[n,o];return B(t)&&l.set(t,g),g}function Rl(t){return t[0]!=="$"&&!Ne(t)}const Bi=t=>t[0]==="_"||t==="$stable",gl=t=>S(t)?t.map(Gt):[Gt(t)],jn=(t,e,s)=>{if(e._n)return e;const l=en((...i)=>gl(e(...i)),s);return l._c=!1,l},Vi=(t,e,s)=>{const l=t._ctx;for(const i in t){if(Bi(i))continue;const r=t[i];if(j(r))e[i]=jn(i,r,l);else if(r!=null){const n=gl(r);e[i]=()=>n}}},Ki=(t,e)=>{const s=gl(e);t.slots.default=()=>s},$i=(t,e,s)=>{for(const l in e)(s||l!=="_")&&(t[l]=e[l])},On=(t,e,s)=>{const l=t.slots=Li();if(t.vnode.shapeFlag&32){const i=e._;i?($i(l,e,s),s&&ni(l,"_",i,!0)):Vi(e,l)}else e&&Ki(t,e)},Cn=(t,e,s)=>{const{vnode:l,slots:i}=t;let r=!0,n=M;if(l.shapeFlag&32){const o=e._;o?s&&o===1?r=!1:$i(i,e,s):(r=!e.$stable,Vi(e,i)),n=e}else e&&(Ki(t,e),n={default:1});if(r)for(const o in i)!Bi(o)&&n[o]==null&&delete i[o]},ft=Kn;function Wn(t){return In(t)}function In(t,e){const s=oi();s.__VUE__=!0;const{insert:l,remove:i,patchProp:r,createElement:n,createText:o,createComment:u,setText:g,setElementText:m,parentNode:f,nextSibling:k,setScopeId:G=Ot,insertStaticContent:I}=t,W=(a,d,_,c=null,x=null,h=null,w=void 0,A=null,b=!!d.dynamicChildren)=>{if(a===d)return;a&&!De(a,d)&&(c=Qe(a),Dt(a,x,h,!0),a=null),d.patchFlag===-2&&(b=!1,d.dynamicChildren=null);const{type:p,ref:D,shapeFlag:E}=d;switch(p){case ks:it(a,d,_,c);break;case ne:H(a,d,_,c);break;case rs:a==null&&K(d,_,c,w);break;case J:Ke(a,d,_,c,x,h,w,A,b);break;default:E&1?Z(a,d,_,c,x,h,w,A,b):E&6?$e(a,d,_,c,x,h,w,A,b):(E&64||E&128)&&p.process(a,d,_,c,x,h,w,A,b,Ee)}D!=null&&x&&Ms(D,a&&a.ref,h,d||a,!d)},it=(a,d,_,c)=>{if(a==null)l(d.el=o(d.children),_,c);else{const x=d.el=a.el;d.children!==a.children&&g(x,d.children)}},H=(a,d,_,c)=>{a==null?l(d.el=u(d.children||""),_,c):d.el=a.el},K=(a,d,_,c)=>{[a.el,a.anchor]=I(a.children,d,_,c,a.el,a.anchor)},$=({el:a,anchor:d},_,c)=>{let x;for(;a&&a!==d;)x=k(a),l(a,_,c),a=x;l(d,_,c)},y=({el:a,anchor:d})=>{let _;for(;a&&a!==d;)_=k(a),i(a),a=_;i(d)},Z=(a,d,_,c,x,h,w,A,b)=>{d.type==="svg"?w="svg":d.type==="math"&&(w="mathml"),a==null?Lt(d,_,c,x,h,w,A,b):Ve(a,d,x,h,w,A,b)},Lt=(a,d,_,c,x,h,w,A)=>{let b,p;const{props:D,shapeFlag:E,transition:T,dirs:N}=a;if(b=a.el=n(a.type,h,D&&D.is,D),E&8?m(b,a.children):E&16&&Mt(a.children,b,null,c,x,Os(a,h),w,A),N&&te(a,null,c,"created"),Tt(b,a,a.scopeId,w,c),D){for(const U in D)U!=="value"&&!Ne(U)&&r(b,U,null,D[U],h,c);"value"in D&&r(b,"value",null,D.value,h),(p=D.onVnodeBeforeMount)&&yt(p,c,a)}N&&te(a,null,c,"beforeMount");const C=Rn(x,T);C&&T.beforeEnter(b),l(b,d,_),((p=D&&D.onVnodeMounted)||C||N)&&ft(()=>{p&&yt(p,c,a),C&&T.enter(b),N&&te(a,null,c,"mounted")},x)},Tt=(a,d,_,c,x)=>{if(_&&G(a,_),c)for(let h=0;h<c.length;h++)G(a,c[h]);if(x){let h=x.subTree;if(d===h||tr(h.type)&&(h.ssContent===d||h.ssFallback===d)){const w=x.vnode;Tt(a,w,w.scopeId,w.slotScopeIds,x.parent)}}},Mt=(a,d,_,c,x,h,w,A,b=0)=>{for(let p=b;p<a.length;p++){const D=a[p]=A?Vt(a[p]):Gt(a[p]);W(null,D,d,_,c,x,h,w,A)}},Ve=(a,d,_,c,x,h,w)=>{const A=d.el=a.el;let{patchFlag:b,dynamicChildren:p,dirs:D}=d;b|=a.patchFlag&16;const E=a.props||M,T=d.props||M;let N;if(_&&ee(_,!1),(N=T.onVnodeBeforeUpdate)&&yt(N,_,d,a),D&&te(d,a,_,"beforeUpdate"),_&&ee(_,!0),(E.innerHTML&&T.innerHTML==null||E.textContent&&T.textContent==null)&&m(A,""),p?Zt(a.dynamicChildren,p,A,_,c,Os(d,x),h):w||q(a,d,A,null,_,c,Os(d,x),h,!1),b>0){if(b&16)ke(A,E,T,_,x);else if(b&2&&E.class!==T.class&&r(A,"class",null,T.class,x),b&4&&r(A,"style",E.style,T.style,x),b&8){const C=d.dynamicProps;for(let U=0;U<C.length;U++){const z=C[U],mt=E[z],X=T[z];(X!==mt||z==="value")&&r(A,z,mt,X,x,_)}}b&1&&a.children!==d.children&&m(A,d.children)}else!w&&p==null&&ke(A,E,T,_,x);((N=T.onVnodeUpdated)||D)&&ft(()=>{N&&yt(N,_,d,a),D&&te(d,a,_,"updated")},c)},Zt=(a,d,_,c,x,h,w)=>{for(let A=0;A<d.length;A++){const b=a[A],p=d[A],D=b.el&&(b.type===J||!De(b,p)||b.shapeFlag&70)?f(b.el):_;W(b,p,D,null,c,x,h,w,!0)}},ke=(a,d,_,c,x)=>{if(d!==_){if(d!==M)for(const h in d)!Ne(h)&&!(h in _)&&r(a,h,d[h],null,x,c);for(const h in _){if(Ne(h))continue;const w=_[h],A=d[h];w!==A&&h!=="value"&&r(a,h,A,w,x,c)}"value"in _&&r(a,"value",d.value,_.value,x)}},Ke=(a,d,_,c,x,h,w,A,b)=>{const p=d.el=a?a.el:o(""),D=d.anchor=a?a.anchor:o("");let{patchFlag:E,dynamicChildren:T,slotScopeIds:N}=d;N&&(A=A?A.concat(N):N),a==null?(l(p,_,c),l(D,_,c),Mt(d.children||[],_,D,x,h,w,A,b)):E>0&&E&64&&T&&a.dynamicChildren?(Zt(a.dynamicChildren,T,_,x,h,w,A),(d.key!=null||x&&d===x.subTree)&&Ji(a,d,!0)):q(a,d,_,D,x,h,w,A,b)},$e=(a,d,_,c,x,h,w,A,b)=>{d.slotScopeIds=A,a==null?d.shapeFlag&512?x.ctx.activate(d,_,c,w,b):vs(d,_,c,x,h,w,b):xl(a,d,b)},vs=(a,d,_,c,x,h,w)=>{const A=a.component=so(a,c,x);if(Wi(a)&&(A.ctx.renderer=Ee),lo(A,!1,w),A.asyncDep){if(x&&x.registerDep(A,rt,w),!a.el){const b=A.subTree=Y(ne);H(null,b,d,_)}}else rt(A,a,d,_,x,h,w)},xl=(a,d,_)=>{const c=d.component=a.component;if(Bn(a,d,_))if(c.asyncDep&&!c.asyncResolved){V(c,d,_);return}else c.next=d,c.update();else d.el=a.el,c.vnode=d},rt=(a,d,_,c,x,h,w)=>{const A=()=>{if(a.isMounted){let{next:E,bu:T,u:N,parent:C,vnode:U}=a;{const _t=Qi(a);if(_t){E&&(E.el=U.el,V(a,E,w)),_t.asyncDep.then(()=>{a.isUnmounted||A()});return}}let z=E,mt;ee(a,!1),E?(E.el=U.el,V(a,E,w)):E=U,T&&ls(T),(mt=E.props&&E.props.onVnodeBeforeUpdate)&&yt(mt,C,E,U),ee(a,!0);const X=Ws(a),kt=a.subTree;a.subTree=X,W(kt,X,f(kt.el),Qe(kt),a,x,h),E.el=X.el,z===null&&Vn(a,X.el),N&&ft(N,x),(mt=E.props&&E.props.onVnodeUpdated)&&ft(()=>yt(mt,C,E,U),x)}else{let E;const{el:T,props:N}=d,{bm:C,m:U,parent:z,root:mt,type:X}=a,kt=Oe(d);if(ee(a,!1),C&&ls(C),!kt&&(E=N&&N.onVnodeBeforeMount)&&yt(E,z,d),ee(a,!0),T&&bl){const _t=()=>{a.subTree=Ws(a),bl(T,a.subTree,a,x,null)};kt&&X.__asyncHydrate?X.__asyncHydrate(T,a,_t):_t()}else{mt.ce&&mt.ce._injectChildStyle(X);const _t=a.subTree=Ws(a);W(null,_t,_,c,a,x,h),d.el=_t.el}if(U&&ft(U,x),!kt&&(E=N&&N.onVnodeMounted)){const _t=d;ft(()=>yt(E,z,_t),x)}(d.shapeFlag&256||z&&Oe(z.vnode)&&z.vnode.shapeFlag&256)&&a.a&&ft(a.a,x),a.isMounted=!0,d=_=c=null}};a.scope.on();const b=a.effect=new mi(A);a.scope.off();const p=a.update=b.run.bind(b),D=a.job=b.runIfDirty.bind(b);D.i=a,D.id=a.uid,b.scheduler=()=>dl(D),ee(a,!0),p()},V=(a,d,_)=>{d.component=a;const c=a.vnode.props;a.vnode=d,a.next=null,Nn(a,d.props,c,_),Cn(a,d.children,_),Jt(),Gl(a),Qt()},q=(a,d,_,c,x,h,w,A,b=!1)=>{const p=a&&a.children,D=a?a.shapeFlag:0,E=d.children,{patchFlag:T,shapeFlag:N}=d;if(T>0){if(T&128){Je(p,E,_,c,x,h,w,A,b);return}else if(T&256){Yt(p,E,_,c,x,h,w,A,b);return}}N&8?(D&16&&we(p,x,h),E!==p&&m(_,E)):D&16?N&16?Je(p,E,_,c,x,h,w,A,b):we(p,x,h,!0):(D&8&&m(_,""),N&16&&Mt(E,_,c,x,h,w,A,b))},Yt=(a,d,_,c,x,h,w,A,b)=>{a=a||me,d=d||me;const p=a.length,D=d.length,E=Math.min(p,D);let T;for(T=0;T<E;T++){const N=d[T]=b?Vt(d[T]):Gt(d[T]);W(a[T],N,_,null,x,h,w,A,b)}p>D?we(a,x,h,!0,!1,E):Mt(d,_,c,x,h,w,A,b,E)},Je=(a,d,_,c,x,h,w,A,b)=>{let p=0;const D=d.length;let E=a.length-1,T=D-1;for(;p<=E&&p<=T;){const N=a[p],C=d[p]=b?Vt(d[p]):Gt(d[p]);if(De(N,C))W(N,C,_,null,x,h,w,A,b);else break;p++}for(;p<=E&&p<=T;){const N=a[E],C=d[T]=b?Vt(d[T]):Gt(d[T]);if(De(N,C))W(N,C,_,null,x,h,w,A,b);else break;E--,T--}if(p>E){if(p<=T){const N=T+1,C=N<D?d[N].el:c;for(;p<=T;)W(null,d[p]=b?Vt(d[p]):Gt(d[p]),_,C,x,h,w,A,b),p++}}else if(p>T)for(;p<=E;)Dt(a[p],x,h,!0),p++;else{const N=p,C=p,U=new Map;for(p=C;p<=T;p++){const gt=d[p]=b?Vt(d[p]):Gt(d[p]);gt.key!=null&&U.set(gt.key,p)}let z,mt=0;const X=T-C+1;let kt=!1,_t=0;const ve=new Array(X);for(p=0;p<X;p++)ve[p]=0;for(p=N;p<=E;p++){const gt=a[p];if(mt>=X){Dt(gt,x,h,!0);continue}let St;if(gt.key!=null)St=U.get(gt.key);else for(z=C;z<=T;z++)if(ve[z-C]===0&&De(gt,d[z])){St=z;break}St===void 0?Dt(gt,x,h,!0):(ve[St-C]=p+1,St>=_t?_t=St:kt=!0,W(gt,d[St],_,null,x,h,w,A,b),mt++)}const Al=kt?Pn(ve):me;for(z=Al.length-1,p=X-1;p>=0;p--){const gt=C+p,St=d[gt],kl=gt+1<D?d[gt+1].el:c;ve[p]===0?W(null,St,_,kl,x,h,w,A,b):kt&&(z<0||p!==Al[z]?Xt(St,_,kl,2):z--)}}},Xt=(a,d,_,c,x=null)=>{const{el:h,type:w,transition:A,children:b,shapeFlag:p}=a;if(p&6){Xt(a.component.subTree,d,_,c);return}if(p&128){a.suspense.move(d,_,c);return}if(p&64){w.move(a,d,_,Ee);return}if(w===J){l(h,d,_);for(let E=0;E<b.length;E++)Xt(b[E],d,_,c);l(a.anchor,d,_);return}if(w===rs){$(a,d,_);return}if(c!==2&&p&1&&A)if(c===0)A.beforeEnter(h),l(h,d,_),ft(()=>A.enter(h),x);else{const{leave:E,delayLeave:T,afterLeave:N}=A,C=()=>l(h,d,_),U=()=>{E(h,()=>{C(),N&&N()})};T?T(h,C,U):U()}else l(h,d,_)},Dt=(a,d,_,c=!1,x=!1)=>{const{type:h,props:w,ref:A,children:b,dynamicChildren:p,shapeFlag:D,patchFlag:E,dirs:T,cacheIndex:N}=a;if(E===-2&&(x=!1),A!=null&&Ms(A,null,_,a,!0),N!=null&&(d.renderCache[N]=void 0),D&256){d.ctx.deactivate(a);return}const C=D&1&&T,U=!Oe(a);let z;if(U&&(z=w&&w.onVnodeBeforeUnmount)&&yt(z,d,a),D&6)ar(a.component,_,c);else{if(D&128){a.suspense.unmount(_,c);return}C&&te(a,null,d,"beforeUnmount"),D&64?a.type.remove(a,d,_,Ee,c):p&&!p.hasOnce&&(h!==J||E>0&&E&64)?we(p,d,_,!1,!0):(h===J&&E&384||!x&&D&16)&&we(b,d,_),c&&hl(a)}(U&&(z=w&&w.onVnodeUnmounted)||C)&&ft(()=>{z&&yt(z,d,a),C&&te(a,null,d,"unmounted")},_)},hl=a=>{const{type:d,el:_,anchor:c,transition:x}=a;if(d===J){or(_,c);return}if(d===rs){y(a);return}const h=()=>{i(_),x&&!x.persisted&&x.afterLeave&&x.afterLeave()};if(a.shapeFlag&1&&x&&!x.persisted){const{leave:w,delayLeave:A}=x,b=()=>w(_,h);A?A(a.el,h,b):b()}else h()},or=(a,d)=>{let _;for(;a!==d;)_=k(a),i(a),a=_;i(d)},ar=(a,d,_)=>{const{bum:c,scope:x,job:h,subTree:w,um:A,m:b,a:p}=a;Pl(b),Pl(p),c&&ls(c),x.stop(),h&&(h.flags|=8,Dt(w,a,d,_)),A&&ft(A,d),ft(()=>{a.isUnmounted=!0},d),d&&d.pendingBranch&&!d.isUnmounted&&a.asyncDep&&!a.asyncResolved&&a.suspenseId===d.pendingId&&(d.deps--,d.deps===0&&d.resolve())},we=(a,d,_,c=!1,x=!1,h=0)=>{for(let w=h;w<a.length;w++)Dt(a[w],d,_,c,x)},Qe=a=>{if(a.shapeFlag&6)return Qe(a.component.subTree);if(a.shapeFlag&128)return a.suspense.next();const d=k(a.anchor||a.el),_=d&&d[sn];return _?k(_):d};let Ts=!1;const cl=(a,d,_)=>{a==null?d._vnode&&Dt(d._vnode,null,null,!0):W(d._vnode||null,a,d,null,null,null,_),d._vnode=a,Ts||(Ts=!0,Gl(),Gi(),Ts=!1)},Ee={p:W,um:Dt,m:Xt,r:hl,mt:vs,mc:Mt,pc:q,pbc:Zt,n:Qe,o:t};let pl,bl;return{render:cl,hydrate:pl,createApp:Dn(cl,pl)}}function Os({type:t,props:e},s){return s==="svg"&&t==="foreignObject"||s==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:s}function ee({effect:t,job:e},s){s?(t.flags|=32,e.flags|=4):(t.flags&=-33,e.flags&=-5)}function Rn(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function Ji(t,e,s=!1){const l=t.children,i=e.children;if(S(l)&&S(i))for(let r=0;r<l.length;r++){const n=l[r];let o=i[r];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=i[r]=Vt(i[r]),o.el=n.el),!s&&o.patchFlag!==-2&&Ji(n,o)),o.type===ks&&(o.el=n.el)}}function Pn(t){const e=t.slice(),s=[0];let l,i,r,n,o;const u=t.length;for(l=0;l<u;l++){const g=t[l];if(g!==0){if(i=s[s.length-1],t[i]<g){e[l]=i,s.push(l);continue}for(r=0,n=s.length-1;r<n;)o=r+n>>1,t[s[o]]<g?r=o+1:n=o;g<t[s[r]]&&(r>0&&(e[l]=s[r-1]),s[r]=l)}}for(r=s.length,n=s[r-1];r-- >0;)s[r]=n,n=e[n];return s}function Qi(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:Qi(e)}function Pl(t){if(t)for(let e=0;e<t.length;e++)t[e].flags|=8}const zn=Symbol.for("v-scx"),Hn=()=>is(zn);function Cs(t,e,s){return Zi(t,e,s)}function Zi(t,e,s=M){const{immediate:l,deep:i,flush:r,once:n}=s,o=st({},s);let u;if(ws)if(r==="sync"){const k=Hn();u=k.__watcherHandles||(k.__watcherHandles=[])}else if(!e||l)o.once=!0;else return{stop:Ot,resume:Ot,pause:Ot};const g=tt;o.call=(k,G,I)=>Wt(k,g,G,I);let m=!1;r==="post"?o.scheduler=k=>{ft(k,g&&g.suspense)}:r!=="sync"&&(m=!0,o.scheduler=(k,G)=>{G?k():dl(k)}),o.augmentJob=k=>{e&&(k.flags|=4),m&&(k.flags|=2,g&&(k.id=g.uid,k.i=g))};const f=Zr(t,e,o);return u&&u.push(f),f}function Fn(t,e,s){const l=this.proxy,i=Q(t)?t.includes(".")?Yi(l,t):()=>l[t]:t.bind(l,l);let r;j(e)?r=e:(r=e.handler,s=e);const n=Be(this),o=Zi(i,r.bind(l),s);return n(),o}function Yi(t,e){const s=e.split(".");return()=>{let l=t;for(let i=0;i<s.length&&l;i++)l=l[s[i]];return l}}const Ln=(t,e)=>e==="modelValue"||e==="model-value"?t.modelModifiers:t[`${e}Modifiers`]||t[`${vt(e)}Modifiers`]||t[`${ae(e)}Modifiers`];function Mn(t,e,...s){if(t.isUnmounted)return;const l=t.vnode.props||M;let i=s;const r=e.startsWith("update:"),n=r&&Ln(l,e.slice(7));n&&(n.trim&&(i=s.map(m=>Q(m)?m.trim():m)),n.number&&(i=s.map(as)));let o,u=l[o=Ds(e)]||l[o=Ds(vt(e))];!u&&r&&(u=l[o=Ds(ae(e))]),u&&Wt(u,t,6,i);const g=l[o+"Once"];if(g){if(!t.emitted)t.emitted={};else if(t.emitted[o])return;t.emitted[o]=!0,Wt(g,t,6,i)}}function Xi(t,e,s=!1){const l=e.emitsCache,i=l.get(t);if(i!==void 0)return i;const r=t.emits;let n={},o=!1;if(!j(t)){const u=g=>{const m=Xi(g,e,!0);m&&(o=!0,st(n,m))};!s&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}return!r&&!o?(B(t)&&l.set(t,null),null):(S(r)?r.forEach(u=>n[u]=null):st(n,r),B(t)&&l.set(t,n),n)}function As(t,e){return!t||!gs(e)?!1:(e=e.slice(2).replace(/Once$/,""),R(t,e[0].toLowerCase()+e.slice(1))||R(t,ae(e))||R(t,e))}function Ws(t){const{type:e,vnode:s,proxy:l,withProxy:i,propsOptions:[r],slots:n,attrs:o,emit:u,render:g,renderCache:m,props:f,data:k,setupState:G,ctx:I,inheritAttrs:W}=t,it=ds(t);let H,K;try{if(s.shapeFlag&4){const y=i||l,Z=y;H=Gt(g.call(Z,y,m,f,G,k,I)),K=o}else{const y=e;H=Gt(y.length>1?y(f,{attrs:o,slots:n,emit:u}):y(f,null)),K=e.props?o:qn(o)}}catch(y){We.length=0,ps(y,t,1),H=Y(ne)}let $=H;if(K&&W!==!1){const y=Object.keys(K),{shapeFlag:Z}=$;y.length&&Z&7&&(r&&y.some(Qs)&&(K=Un(K,r)),$=pe($,K,!1,!0))}return s.dirs&&($=pe($,null,!1,!0),$.dirs=$.dirs?$.dirs.concat(s.dirs):s.dirs),s.transition&&ml($,s.transition),H=$,ds(it),H}const qn=t=>{let e;for(const s in t)(s==="class"||s==="style"||gs(s))&&((e||(e={}))[s]=t[s]);return e},Un=(t,e)=>{const s={};for(const l in t)(!Qs(l)||!(l.slice(9)in e))&&(s[l]=t[l]);return s};function Bn(t,e,s){const{props:l,children:i,component:r}=t,{props:n,children:o,patchFlag:u}=e,g=r.emitsOptions;if(e.dirs||e.transition)return!0;if(s&&u>=0){if(u&1024)return!0;if(u&16)return l?zl(l,n,g):!!n;if(u&8){const m=e.dynamicProps;for(let f=0;f<m.length;f++){const k=m[f];if(n[k]!==l[k]&&!As(g,k))return!0}}}else return(i||o)&&(!o||!o.$stable)?!0:l===n?!1:l?n?zl(l,n,g):!0:!!n;return!1}function zl(t,e,s){const l=Object.keys(e);if(l.length!==Object.keys(t).length)return!0;for(let i=0;i<l.length;i++){const r=l[i];if(e[r]!==t[r]&&!As(s,r))return!0}return!1}function Vn({vnode:t,parent:e},s){for(;e;){const l=e.subTree;if(l.suspense&&l.suspense.activeBranch===t&&(l.el=t.el),l===t)(t=e.vnode).el=s,e=e.parent;else break}}const tr=t=>t.__isSuspense;function Kn(t,e){e&&e.pendingBranch?S(t)?e.effects.push(...t):e.effects.push(t):tn(t)}const J=Symbol.for("v-fgt"),ks=Symbol.for("v-txt"),ne=Symbol.for("v-cmt"),rs=Symbol.for("v-stc"),We=[];let ct=null;function O(t=!1){We.push(ct=t?null:[])}function $n(){We.pop(),ct=We[We.length-1]||null}let He=1;function Hl(t){He+=t,t<0&&ct&&(ct.hasOnce=!0)}function er(t){return t.dynamicChildren=He>0?ct||me:null,$n(),He>0&&ct&&ct.push(t),t}function P(t,e,s,l,i,r){return er(v(t,e,s,l,i,r,!0))}function oe(t,e,s,l,i){return er(Y(t,e,s,l,i,!0))}function Jn(t){return t?t.__v_isVNode===!0:!1}function De(t,e){return t.type===e.type&&t.key===e.key}const sr=({key:t})=>t??null,ns=({ref:t,ref_key:e,ref_for:s})=>(typeof t=="number"&&(t=""+t),t!=null?Q(t)||at(t)||j(t)?{i:ht,r:t,k:e,f:!!s}:t:null);function v(t,e=null,s=null,l=0,i=null,r=t===J?0:1,n=!1,o=!1){const u={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&sr(e),ref:e&&ns(e),scopeId:Oi,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:l,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:ht};return o?(fl(u,s),r&128&&t.normalize(u)):s&&(u.shapeFlag|=Q(s)?8:16),He>0&&!n&&ct&&(u.patchFlag>0||r&6)&&u.patchFlag!==32&&ct.push(u),u}const Y=Qn;function Qn(t,e=null,s=null,l=0,i=null,r=!1){if((!t||t===cn)&&(t=ne),Jn(t)){const o=pe(t,e,!0);return s&&fl(o,s),He>0&&!r&&ct&&(o.shapeFlag&6?ct[ct.indexOf(t)]=o:ct.push(o)),o.patchFlag=-2,o}if(ao(t)&&(t=t.__vccOpts),e){e=Zn(e);let{class:o,style:u}=e;o&&!Q(o)&&(e.class=jt(o)),B(u)&&(ol(u)&&!S(u)&&(u=st({},u)),e.style=Xs(u))}const n=Q(t)?1:tr(t)?128:ln(t)?64:B(t)?4:j(t)?2:0;return v(t,e,s,l,i,n,r,!0)}function Zn(t){return t?ol(t)||Mi(t)?st({},t):t:null}function pe(t,e,s=!1,l=!1){const{props:i,ref:r,patchFlag:n,children:o,transition:u}=t,g=e?Xn(i||{},e):i,m={__v_isVNode:!0,__v_skip:!0,type:t.type,props:g,key:g&&sr(g),ref:e&&e.ref?s&&r?S(r)?r.concat(ns(e)):[r,ns(e)]:ns(e):r,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetStart:t.targetStart,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==J?n===-1?16:n|16:n,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:u,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&pe(t.ssContent),ssFallback:t.ssFallback&&pe(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce};return u&&l&&ml(m,u.clone(m)),m}function he(t=" ",e=0){return Y(ks,null,t,e)}function Yn(t,e){const s=Y(rs,null,t);return s.staticCount=e,s}function $t(t="",e=!1){return e?(O(),oe(ne,null,t)):Y(ne,null,t)}function Gt(t){return t==null||typeof t=="boolean"?Y(ne):S(t)?Y(J,null,t.slice()):typeof t=="object"?Vt(t):Y(ks,null,String(t))}function Vt(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:pe(t)}function fl(t,e){let s=0;const{shapeFlag:l}=t;if(e==null)e=null;else if(S(e))s=16;else if(typeof e=="object")if(l&65){const i=e.default;i&&(i._c&&(i._d=!1),fl(t,i()),i._c&&(i._d=!0));return}else{s=32;const i=e._;!i&&!Mi(e)?e._ctx=ht:i===3&&ht&&(ht.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else j(e)?(e={default:e,_ctx:ht},s=32):(e=String(e),l&64?(s=16,e=[he(e)]):s=8);t.children=e,t.shapeFlag|=s}function Xn(...t){const e={};for(let s=0;s<t.length;s++){const l=t[s];for(const i in l)if(i==="class")e.class!==l.class&&(e.class=jt([e.class,l.class]));else if(i==="style")e.style=Xs([e.style,l.style]);else if(gs(i)){const r=e[i],n=l[i];n&&r!==n&&!(S(r)&&r.includes(n))&&(e[i]=r?[].concat(r,n):n)}else i!==""&&(e[i]=l[i])}return e}function yt(t,e,s,l=null){Wt(t,e,7,[s,l])}const to=Hi();let eo=0;function so(t,e,s){const l=t.type,i=(e?e.appContext:t.appContext)||to,r={uid:eo++,vnode:t,type:l,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new kr(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ui(l,i),emitsOptions:Xi(l,i),emit:null,emitted:null,propsDefaults:M,inheritAttrs:l.inheritAttrs,ctx:M,data:M,props:M,attrs:M,slots:M,refs:M,setupState:M,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=Mn.bind(null,r),t.ce&&t.ce(r),r}let tt=null,_s,Ks;{const t=oi(),e=(s,l)=>{let i;return(i=t[s])||(i=t[s]=[]),i.push(l),r=>{i.length>1?i.forEach(n=>n(r)):i[0](r)}};_s=e("__VUE_INSTANCE_SETTERS__",s=>tt=s),Ks=e("__VUE_SSR_SETTERS__",s=>ws=s)}const Be=t=>{const e=tt;return _s(t),t.scope.on(),()=>{t.scope.off(),_s(e)}},Fl=()=>{tt&&tt.scope.off(),_s(null)};function lr(t){return t.vnode.shapeFlag&4}let ws=!1;function lo(t,e=!1,s=!1){e&&Ks(e);const{props:l,children:i}=t.vnode,r=lr(t);yn(t,l,r,e),On(t,i,s);const n=r?io(t,e):void 0;return e&&Ks(!1),n}function io(t,e){const s=t.type;t.accessCache=Object.create(null),t.proxy=new Proxy(t.ctx,bn);const{setup:l}=s;if(l){const i=t.setupContext=l.length>1?no(t):null,r=Be(t);Jt();const n=Ue(l,t,0,[t.props,i]);if(Qt(),r(),li(n)){if(Oe(t)||Ci(t),n.then(Fl,Fl),e)return n.then(o=>{Ll(t,o,e)}).catch(o=>{ps(o,t,0)});t.asyncDep=n}else Ll(t,n,e)}else ir(t,e)}function Ll(t,e,s){j(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:B(e)&&(t.setupState=Di(e)),ir(t,s)}let Ml;function ir(t,e,s){const l=t.type;if(!t.render){if(!e&&Ml&&!l.render){const i=l.template||_l(t).template;if(i){const{isCustomElement:r,compilerOptions:n}=t.appContext.config,{delimiters:o,compilerOptions:u}=l,g=st(st({isCustomElement:r,delimiters:o},n),u);l.render=Ml(i,g)}}t.render=l.render||Ot}{const i=Be(t);Jt();try{An(t)}finally{Qt(),i()}}}const ro={get(t,e){return lt(t,"get",""),t[e]}};function no(t){const e=s=>{t.exposed=s||{}};return{attrs:new Proxy(t.attrs,ro),slots:t.slots,emit:t.emit,expose:e}}function Es(t){return t.exposed?t.exposeProxy||(t.exposeProxy=new Proxy(Di(Br(t.exposed)),{get(e,s){if(s in e)return e[s];if(s in Ce)return Ce[s](t)},has(e,s){return s in e||s in Ce}})):t.proxy}function oo(t,e=!0){return j(t)?t.displayName||t.name:t.name||e&&t.__name}function ao(t){return j(t)&&"__vccOpts"in t}const uo=(t,e)=>Jr(t,e,ws),mo="3.5.5";/**
* @vue/runtime-dom v3.5.5
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let $s;const ql=typeof window<"u"&&window.trustedTypes;if(ql)try{$s=ql.createPolicy("vue",{createHTML:t=>t})}catch{}const rr=$s?t=>$s.createHTML(t):t=>t,_o="http://www.w3.org/2000/svg",go="http://www.w3.org/1998/Math/MathML",Rt=typeof document<"u"?document:null,Ul=Rt&&Rt.createElement("template"),fo={insert:(t,e,s)=>{e.insertBefore(t,s||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,s,l)=>{const i=e==="svg"?Rt.createElementNS(_o,t):e==="mathml"?Rt.createElementNS(go,t):s?Rt.createElement(t,{is:s}):Rt.createElement(t);return t==="select"&&l&&l.multiple!=null&&i.setAttribute("multiple",l.multiple),i},createText:t=>Rt.createTextNode(t),createComment:t=>Rt.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Rt.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,s,l,i,r){const n=s?s.previousSibling:e.lastChild;if(i&&(i===r||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),s),!(i===r||!(i=i.nextSibling)););else{Ul.innerHTML=rr(l==="svg"?`<svg>${t}</svg>`:l==="mathml"?`<math>${t}</math>`:t);const o=Ul.content;if(l==="svg"||l==="mathml"){const u=o.firstChild;for(;u.firstChild;)o.appendChild(u.firstChild);o.removeChild(u)}e.insertBefore(o,s)}return[n?n.nextSibling:e.firstChild,s?s.previousSibling:e.lastChild]}},xo=Symbol("_vtc");function ho(t,e,s){const l=t[xo];l&&(e=(e?[e,...l]:[...l]).join(" ")),e==null?t.removeAttribute("class"):s?t.setAttribute("class",e):t.className=e}const Bl=Symbol("_vod"),co=Symbol("_vsh"),po=Symbol(""),bo=/(^|;)\s*display\s*:/;function Ao(t,e,s){const l=t.style,i=Q(s);let r=!1;if(s&&!i){if(e)if(Q(e))for(const n of e.split(";")){const o=n.slice(0,n.indexOf(":")).trim();s[o]==null&&os(l,o,"")}else for(const n in e)s[n]==null&&os(l,n,"");for(const n in s)n==="display"&&(r=!0),os(l,n,s[n])}else if(i){if(e!==s){const n=l[po];n&&(s+=";"+n),l.cssText=s,r=bo.test(s)}}else e&&t.removeAttribute("style");Bl in t&&(t[Bl]=r?l.display:"",t[co]&&(l.display="none"))}const Vl=/\s*!important$/;function os(t,e,s){if(S(s))s.forEach(l=>os(t,e,l));else if(s==null&&(s=""),e.startsWith("--"))t.setProperty(e,s);else{const l=ko(t,e);Vl.test(s)?t.setProperty(ae(l),s.replace(Vl,""),"important"):t[l]=s}}const Kl=["Webkit","Moz","ms"],Is={};function ko(t,e){const s=Is[e];if(s)return s;let l=vt(e);if(l!=="filter"&&l in t)return Is[e]=l;l=xs(l);for(let i=0;i<Kl.length;i++){const r=Kl[i]+l;if(r in t)return Is[e]=r}return e}const $l="http://www.w3.org/1999/xlink";function Jl(t,e,s,l,i,r=br(e)){l&&e.startsWith("xlink:")?s==null?t.removeAttributeNS($l,e.slice(6,e.length)):t.setAttributeNS($l,e,s):s==null||r&&!ai(s)?t.removeAttribute(e):t.setAttribute(e,r?"":Ct(s)?String(s):s)}function wo(t,e,s,l){if(e==="innerHTML"||e==="textContent"){s!=null&&(t[e]=e==="innerHTML"?rr(s):s);return}const i=t.tagName;if(e==="value"&&i!=="PROGRESS"&&!i.includes("-")){const n=i==="OPTION"?t.getAttribute("value")||"":t.value,o=s==null?t.type==="checkbox"?"on":"":String(s);(n!==o||!("_value"in t))&&(t.value=o),s==null&&t.removeAttribute(e),t._value=s;return}let r=!1;if(s===""||s==null){const n=typeof t[e];n==="boolean"?s=ai(s):s==null&&n==="string"?(s="",r=!0):n==="number"&&(s=0,r=!0)}try{t[e]=s}catch{}r&&t.removeAttribute(e)}function Kt(t,e,s,l){t.addEventListener(e,s,l)}function Eo(t,e,s,l){t.removeEventListener(e,s,l)}const Ql=Symbol("_vei");function vo(t,e,s,l,i=null){const r=t[Ql]||(t[Ql]={}),n=r[e];if(l&&n)n.value=l;else{const[o,u]=To(e);if(l){const g=r[e]=yo(l,i);Kt(t,o,g,u)}else n&&(Eo(t,o,n,u),r[e]=void 0)}}const Zl=/(?:Once|Passive|Capture)$/;function To(t){let e;if(Zl.test(t)){e={};let l;for(;l=t.match(Zl);)t=t.slice(0,t.length-l[0].length),e[l[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):ae(t.slice(2)),e]}let Rs=0;const Do=Promise.resolve(),So=()=>Rs||(Do.then(()=>Rs=0),Rs=Date.now());function yo(t,e){const s=l=>{if(!l._vts)l._vts=Date.now();else if(l._vts<=s.attached)return;Wt(No(l,s.value),e,5,[l])};return s.value=t,s.attached=So(),s}function No(t,e){if(S(e)){const s=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{s.call(t),t._stopped=!0},e.map(l=>i=>!i._stopped&&l&&l(i))}else return e}const Yl=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,Go=(t,e,s,l,i,r)=>{const n=i==="svg";e==="class"?ho(t,l,n):e==="style"?Ao(t,s,l):gs(e)?Qs(e)||vo(t,e,s,l,r):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):jo(t,e,l,n))?(wo(t,e,l),!t.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&Jl(t,e,l,n,r,e!=="value")):(e==="true-value"?t._trueValue=l:e==="false-value"&&(t._falseValue=l),Jl(t,e,l,n))};function jo(t,e,s,l){if(l)return!!(e==="innerHTML"||e==="textContent"||e in t&&Yl(e)&&j(s));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const i=t.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return Yl(e)&&Q(s)?!1:!!(e in t||t._isVueCE&&(/[A-Z]/.test(e)||!Q(s)))}const be=t=>{const e=t.props["onUpdate:modelValue"]||!1;return S(e)?s=>ls(e,s):e};function Oo(t){t.target.composing=!0}function Xl(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const Ht=Symbol("_assign"),Co={created(t,{modifiers:{lazy:e,trim:s,number:l}},i){t[Ht]=be(i);const r=l||i.props&&i.props.type==="number";Kt(t,e?"change":"input",n=>{if(n.target.composing)return;let o=t.value;s&&(o=o.trim()),r&&(o=as(o)),t[Ht](o)}),s&&Kt(t,"change",()=>{t.value=t.value.trim()}),e||(Kt(t,"compositionstart",Oo),Kt(t,"compositionend",Xl),Kt(t,"change",Xl))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,oldValue:s,modifiers:{lazy:l,trim:i,number:r}},n){if(t[Ht]=be(n),t.composing)return;const o=(r||t.type==="number")&&!/^0\d/.test(t.value)?as(t.value):t.value,u=e??"";o!==u&&(document.activeElement===t&&t.type!=="range"&&(l&&e===s||i&&t.value.trim()===u)||(t.value=u))}},Wo={deep:!0,created(t,e,s){t[Ht]=be(s),Kt(t,"change",()=>{const l=t._modelValue,i=Fe(t),r=t.checked,n=t[Ht];if(S(l)){const o=tl(l,i),u=o!==-1;if(r&&!u)n(l.concat(i));else if(!r&&u){const g=[...l];g.splice(o,1),n(g)}}else if(Ae(l)){const o=new Set(l);r?o.add(i):o.delete(i),n(o)}else n(nr(t,r))})},mounted:ti,beforeUpdate(t,e,s){t[Ht]=be(s),ti(t,e,s)}};function ti(t,{value:e,oldValue:s},l){t._modelValue=e;let i;S(e)?i=tl(e,l.props.value)>-1:Ae(e)?i=e.has(l.props.value):i=Me(e,nr(t,!0)),t.checked!==i&&(t.checked=i)}const Ps={deep:!0,created(t,{value:e,modifiers:{number:s}},l){const i=Ae(e);Kt(t,"change",()=>{const r=Array.prototype.filter.call(t.options,n=>n.selected).map(n=>s?as(Fe(n)):Fe(n));t[Ht](t.multiple?i?new Set(r):r:r[0]),t._assigning=!0,yi(()=>{t._assigning=!1})}),t[Ht]=be(l)},mounted(t,{value:e,modifiers:{number:s}}){ei(t,e)},beforeUpdate(t,e,s){t[Ht]=be(s)},updated(t,{value:e,modifiers:{number:s}}){t._assigning||ei(t,e)}};function ei(t,e,s){const l=t.multiple,i=S(e);if(!(l&&!i&&!Ae(e))){for(let r=0,n=t.options.length;r<n;r++){const o=t.options[r],u=Fe(o);if(l)if(i){const g=typeof u;g==="string"||g==="number"?o.selected=e.some(m=>String(m)===String(u)):o.selected=tl(e,u)>-1}else o.selected=e.has(u);else if(Me(Fe(o),e)){t.selectedIndex!==r&&(t.selectedIndex=r);return}}!l&&t.selectedIndex!==-1&&(t.selectedIndex=-1)}}function Fe(t){return"_value"in t?t._value:t.value}function nr(t,e){const s=e?"_trueValue":"_falseValue";return s in t?t[s]:e}const Io=st({patchProp:Go},fo);let si;function Ro(){return si||(si=Wn(Io))}const Po=(...t)=>{const e=Ro().createApp(...t),{mount:s}=e;return e.mount=l=>{const i=Ho(l);if(!i)return;const r=e._component;!j(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const n=s(i,!1,zo(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),n},e};function zo(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function Ho(t){return Q(t)?document.querySelector(t):t}const bt=(t,e)=>{const s=t.__vccOpts||t;for(const[l,i]of e)s[l]=i;return s},Fo={};function Lo(t,e){return O(),P(J,null,[e[0]||(e[0]=v("h1",null,"GlossySnake",-1)),e[1]||(e[1]=v("p",null,[he("INDEX PAGE "),v("span",{class:"index_version_span"},[he("Vue.js version | "),v("a",{href:"js"},"JS version"),he(" | "),v("a",{href:"https://github.com/parkchamchi/GlossySnake"},"Repo")])],-1))],64)}const Mo=bt(Fo,[["render",Lo],["__scopeId","data-v-9ab11fd8"]]),Ut=qe({}),dt={on(t,e){Ut[t]||(Ut[t]=[]),Ut[t].push(e)},off(t,e){Ut[t]&&(Ut[t]=Ut[t].filter(s=>s!==e))},emit(t,e){Ut[t]&&Ut[t].forEach(s=>s(e))}};function et(){}et.prototype.host="https://api.glossysnake.com";et.prototype.api="/api/v4";et.prototype.uri=function(t){return this.host+this.api+t};et.prototype.jsonHelper=async function(t){try{return await t.json()}catch(e){return console.log(e),{error:JSON.parse(JSON.stringify(e,Object.getOwnPropertyNames(e)))}}};et.prototype.submit=async function(t,e="GET",s=null,l=!0){const i=this.uri(t);let r={method:e,headers:{"Content-type":"application/json; charset=UTF-8"},credentials:"include"};e!="GET"&&(r.body=JSON.stringify(s)),l&&(r.headers.Authorization="Token "+et._key);const n=await fetch(i,r);if(!n.ok){const o=await this.jsonHelper(n),u=i+": "+n.statusText+`
> `+JSON.stringify(o);throw dt.emit("addAlert",{message:u,alertClass:"alert-warning"}),new Error(u)}return this.emitCorpusesUpdate(t),n};et.prototype.emitCorpusesUpdate=async function(t){["/corpuses/","/tasks/","/user/check","/user/get-temp-user","/user/logout","/rest-auth/registration/","/rest-auth/login/","/rest-auth/logout/"].some(s=>t.endsWith(s))||(dt.emit("updateCorpuses"),dt.emit("updateTasks"))};const qo={data(){return{api:new et,loggedin:!1}},computed:{userinfo(){return this.loggedin?"Guest.":"Log in."}},methods:{meow(){console.log("meow")},async getTempUser(){const e=await(await this.api.submit("/user/get-temp-user","GET",null,!1)).json();return e.success?(et._key=e.key,!0):(console.error("get-temp-user unsuccessful"),!1)},async updateUser(){if(!et._key&&!await this.getTempUser()){console.error("could not get the temp user.");return}this.loggedin=!0,dt.emit("updateCorpuses"),dt.emit("updateTasks")},async logout(){this.api.submit("/user/logout").then(()=>{et._key=null,this.loggedin=!1,this.updateUser()})}},async created(){await this.updateUser()}},Uo={id:"frontend_auth_div"},Bo={class:"userinfo_p"};function Vo(t,e,s,l,i,r){return O(),P("div",Uo,[v("p",Bo,pt(r.userinfo),1),v("p",{onClick:e[0]||(e[0]=n=>r.logout()),class:"btn logout_button"}," Logout ")])}const Ko=bt(qo,[["render",Vo],["__scopeId","data-v-bb2b082d"]]),ye=qe({annotator_name:"chatgpt_ft0",lang_from:"German",lang_to:"English"}),$o={data(){return ye},watch:{annotator_name(){this.emitChange()},lang_from(){this.emitChange()},lang_to(){this.emitChange()}},methods:{emitChange(){ye.annotator_name=this.annotator_name,ye.lang_from=this.lang_from,ye.lang_to=this.lang_to}}},Jo={class:"container mt-4"},Qo={class:"row"},Zo={class:"col-md-4"},Yo={class:"col-md-4"},Xo={class:"col-md-4"};function ta(t,e,s,l,i,r){return O(),P("div",Jo,[v("div",Qo,[v("div",Zo,[e[4]||(e[4]=v("label",{for:"annotator_name"},"annotator_name:",-1)),je(v("select",{"onUpdate:modelValue":e[0]||(e[0]=n=>t.annotator_name=n),name:"annotator_name",id:"annotator_name_select",class:"form-control"},e[3]||(e[3]=[Yn('<option value="dummy">dummy</option><option value="chatgpt_ft0">chatgpt_ft0</option><option value="chatgpt_gpt-4o-mini-untrained_0">chatgpt_gpt-4o-mini-untrained_0</option><option value="chatgpt_gpt-4o-mini-pretrained_0">chatgpt_gpt-4o-mini-pretrained_0</option><option value="chatgpt_gpt-3.5-turbo-untrained_0">chatgpt_gpt-3.5-turbo-untrained_0</option><option value="chatgpt_gpt-3.5-turbo-pretrained_0">chatgpt_gpt-3.5-turbo-pretrained_0</option>',6)]),512),[[Ps,t.annotator_name]])]),v("div",Yo,[e[6]||(e[6]=v("label",{for:"lang_from"},"lang_from:",-1)),je(v("select",{"onUpdate:modelValue":e[1]||(e[1]=n=>t.lang_from=n),name:"lang_from",id:"lang_from_select",class:"form-control"},e[5]||(e[5]=[v("option",{value:"French"},"French",-1),v("option",{value:"German"},"German",-1)]),512),[[Ps,t.lang_from]])]),v("div",Xo,[e[8]||(e[8]=v("label",{for:"lang_to"},"lang_to:",-1)),je(v("select",{"onUpdate:modelValue":e[2]||(e[2]=n=>t.lang_to=n),name:"lang_to",id:"lang_to_select",class:"form-control"},e[7]||(e[7]=[v("option",{value:"English"},"English",-1)]),512),[[Ps,t.lang_to]])])])])}const ea=bt($o,[["render",ta]]),sa=[{corpus_id:"Winterreise",corpuses_history:[{paragraphs:[{pstate:"ANNOTATED",tokens:[{txt:"#",is_delimiter:!1,gloss:"#"},{txt:" ",is_delimiter:!0,gloss:null},{txt:"Gute",is_delimiter:!1,gloss:"Good"},{txt:" ",is_delimiter:!0,gloss:null},{txt:"Nacht.",is_delimiter:!1,gloss:"Night."}],is_delimiter:!1,token_delimiters:` 	
...
L'âme, en un repli sombre où tout semble finir,
Sent quelque chose encor palpiter sous un voile...
C'est toi qui dors dans l'ombre, ô sacré souvenir! "`,p_div_locs:"[260, 262, 516, 518, 753, 755, 1005, 1007, 1233, 1235, 1480, 1482, 1706, 1708, 1934, 1936, 2129, 2131, 2315, 2317, 2506, 2508, 2697, 2699, 2867, 2869, 3074, 3076, 3263, 3265, 3459, 3461, 3643, 3645, 3838, 3840, 4022, 4024, 4228, 4230, 4420, 4422, 4626, 4628, 4837, 4839, 5017, 5019, 5193, 5195, 5380, 5382, 5587, 5589, 5792, 5794, 6001, 6003, 6191, 6193, 6396, 6398, 6578, 6580, 6764, 6766, 6981, 6983, 7174, 7176, 7383, 7385, 7566, 7568, 7767]"}]}],la={props:{t:{type:Object,required:!0},index:{type:Number,required:!0}},data(){return{isSelected:!1}},computed:{is_delimiter(){return this.t.is_delimiter},should_linebreak(){return this.t.txt.includes(`
`)},txt(){return this.t.txt},gloss(){let t=this.t.gloss;return t=="!UNKNOWN"&&(t="-"),t}},methods:{toggle(){this.isSelected=!this.isSelected,this.$emit("selectionChanged",{tIndex:this.index,isSelected:this.isSelected})}}},ia={class:"token_ul list-group list-group-flush"},ra={class:"list-group-item token_txt"},na={class:"list-group-item gloss"},oa={key:1},aa={key:2,class:"token_wrapper"};function ua(t,e,s,l,i,r){return r.is_delimiter?r.should_linebreak?(O(),P("br",oa)):(O(),P("div",aa,[v("span",null,pt(r.txt),1)])):(O(),P("div",{key:0,class:jt(["token_wrapper","card",{"selected-token":i.isSelected}]),onClick:e[0]||(e[0]=n=>r.toggle())},[v("ul",ia,[v("li",ra,pt(r.txt),1),v("li",na,pt(r.gloss),1)])],2))}const da=bt(la,[["render",ua],["__scopeId","data-v-77eee0fc"]]),ma={props:{p:{type:Object,required:!0},index:{type:Number,required:!0},remote:{type:Boolean,default:!1}},components:{Token:da},computed:{isAnnotateButtonVisible(){return this.remote&&!this.p.is_delimiter&&this.p.tokens&&this.p.tokens.length}},data(){return{selectedTokens:new Set,showPre:!1}},methods:{annotateP(){this.$emit("annotateP",this.index)},reannotateP(){this.$emit("reannotateP",this.index,Array.from(this.selectedTokens))},onSelectionChanged({tIndex:t,isSelected:e}){e?this.selectedTokens.add(t):this.selectedTokens.delete(t)}}},_a={class:"paragraph_wrapper"},ga={key:0,class:"paragraph_annotate_buttons_span"},fa={key:1};function xa(t,e,s,l,i,r){const n=At("Token");return O(),P("div",_a,[r.isAnnotateButtonVisible?(O(),P("span",ga,[v("button",{class:"corpus_button btn btn-light",onClick:e[0]||(e[0]=o=>r.annotateP(s.index))}," Annotate "),v("button",{class:"corpus_button btn btn-light",onClick:e[1]||(e[1]=o=>r.reannotateP(s.index))}," Reannotate "),e[2]||(e[2]=v("br",null,null,-1))])):$t("",!0),i.showPre?(O(),P("pre",fa,pt(JSON.stringify(s.p)),1)):$t("",!0),(O(!0),P(J,null,ie(s.p.tokens,(o,u)=>(O(),oe(n,{key:u,t:o,index:u,onSelectionChanged:r.onSelectionChanged},null,8,["t","index","onSelectionChanged"]))),128))])}const ha=bt(ma,[["render",xa],["__scopeId","data-v-c2ae8ec4"]]),ca={props:{corpus_id:{required:!0},corpus:{type:Object,required:!0},remote:{type:Boolean,default:!1}},components:{Paragraph:ha},data(){return{api:new et,sharedState:ye,isCorpusVisible:!1,showPre:!1}},computed:{pseudoState(){return!this.corpus.paragraphs||this.corpus.paragraphs.length<=0?"PLAIN":this.corpus.paragraphs[0].pstate},divideButtonClass(){const t=this.pseudoState=="PLAIN";return{"btn-primary":t,"btn-light":!t}},parseButtonClass(){const t=this.pseudoState=="DIVIDED";return{"btn-primary":t,"btn-light":!t}},annotateButtonClass(){const t=this.pseudoState=="PARSED";return{"btn-primary":t,"btn-light":!t}},header(){return this.remote?"REMOTE":"LOCAL"}},methods:{toggleCorpusVisibility(){this.isCorpusVisible=!this.isCorpusVisible},download(){const t=JSON.stringify(this.corpus);console.log("Downloading...");let e=document.createElement("a"),s=new Blob([t],{type:"text/plain"});e.download=this.corpus_id+".corpus.json",e.href=URL.createObjectURL(s),e.click()},async divide(t=`
`){this.api.submit("/parser/divide","POST",{corpus_id:this.corpus_id,divide_options:{p_delims:[t]}})},async parse(){this.api.submit("/parser/parse","POST",{corpus_id:this.corpus_id,parse_options:{t_delims:null}})},async annotate(t=null){this.api.submit("/annotator/annotate","POST",{corpus_id:this.corpus_id,annotate_options:{annotator_name:this.sharedState.annotator_name,lang_from:this.sharedState.lang_from,lang_to:this.sharedState.lang_to,target_paragraphs:t}})},async reannotate(t,e){if(!e){console.error("target_tokens is not given");return}if(e.length==0){dt.emit("addAlert",{message:"No token selected.",alertClass:"alert-warning"});return}this.api.submit("/annotator/reannotate","POST",{corpus_id:this.corpus_id,annotate_options:{annotator_name:this.sharedState.annotator_name,lang_from:this.sharedState.lang_from,lang_to:this.sharedState.lang_to,target_paragraphs:t},reannotate_options:{target_tokens:e}})},onAnnotateP(t){this.annotate([t])},onReannotateP(t,e){this.reannotate([t],e)}}},pa={class:"corpus_wrapper"},ba={key:0,class:"corpus"},Aa={class:"corpus_buttons_span"},ka={key:0},wa={key:0,class:"corpus-pre"};function Ea(t,e,s,l,i,r){const n=At("Paragraph");return O(),P("div",pa,[e[9]||(e[9]=v("hr",null,null,-1)),v("h4",{onClick:e[0]||(e[0]=o=>r.toggleCorpusVisibility())},pt(r.header+": "+s.corpus_id),1),i.isCorpusVisible?(O(),P("div",ba,[v("span",Aa,[v("button",{class:"corpus_button btn btn-light",onClick:e[1]||(e[1]=o=>r.download())},"Download"),s.remote?(O(),P("span",ka,[v("button",{class:jt(["corpus_button","btn",r.divideButtonClass]),onClick:e[2]||(e[2]=o=>r.divide())},"Divide",2),v("button",{class:jt(["corpus_button","btn",r.divideButtonClass]),onClick:e[3]||(e[3]=o=>r.divide("\\n\\n"))},"Divide (for poems)",2),v("button",{class:jt(["corpus_button","btn",r.parseButtonClass]),onClick:e[4]||(e[4]=o=>r.parse())},"Parse",2),v("button",{class:jt(["corpus_button","btn",r.annotateButtonClass]),onClick:e[5]||(e[5]=o=>r.annotate([-1]))}," Annotate ",2),v("button",{class:jt(["corpus_button","btn",r.annotateButtonClass]),onClick:e[6]||(e[6]=o=>r.annotate(null))}," Annotate (Reset) ",2)])):$t("",!0)]),e[7]||(e[7]=v("br",null,null,-1)),i.showPre?(O(),P("pre",wa,pt(JSON.stringify(s.corpus)),1)):$t("",!0),e[8]||(e[8]=v("h4",null,"paragraphs",-1)),(O(!0),P(J,null,ie(s.corpus.paragraphs,(o,u)=>(O(),oe(n,{key:u,p:o,index:u,remote:s.remote,onAnnotateP:r.onAnnotateP,onReannotateP:r.onReannotateP},null,8,["p","index","remote","onAnnotateP","onReannotateP"]))),128))])):$t("",!0)])}const va=bt(ca,[["render",Ea],["__scopeId","data-v-53c0ebc1"]]),Ta={components:{Corpus:va},data(){return{api:new et,sampleHost:"https://parkchamchi.github.io/GlossySnake/samples/v1/",localCorpuses:[...sa],remoteCorpuses:[],remoteSampleFilenames:[]}},methods:{async updateCorpuses(){const e=await(await this.api.submit("/corpuses/")).json();this.remoteCorpuses=e},async getRemoteSamples(){await fetch(this.sampleHost).then(t=>t.json()).then(t=>{this.remoteSampleFilenames=t.filenames})},async getRemoteSampleCorpus(t){fetch(this.sampleHost+t).then(e=>e.json()).then(e=>{this.localCorpuses.push({corpus_id:t.replace(".corpus.json",""),corpuses_history:[e]})}).then(()=>{this.remoteSampleFilenames.pop(t)})}},created(){dt.on("updateCorpuses",this.updateCorpuses),this.getRemoteSamples()},beforeDestroy(){dt.off("updateCorpuses",this.updateCorpuses)}},Da={key:0},Sa=["onClick"];function ya(t,e,s,l,i,r){const n=At("Corpus");return O(),P(J,null,[i.remoteSampleFilenames.length>0?(O(),P("div",Da,[e[0]||(e[0]=v("h4",null,"Get a sample:",-1)),(O(!0),P(J,null,ie(i.remoteSampleFilenames,(o,u)=>(O(),P("p",{class:"sampleLinkP",onClick:g=>r.getRemoteSampleCorpus(o)},pt(o),9,Sa))),256))])):$t("",!0),v("div",null,[(O(!0),P(J,null,ie(i.localCorpuses,(o,u)=>(O(),oe(n,{key:u,corpus:o.corpuses_history.at(-1),corpus_id:o.corpus_id,remote:!1},null,8,["corpus","corpus_id"]))),128)),(O(!0),P(J,null,ie(i.remoteCorpuses,(o,u)=>(O(),oe(n,{key:u,corpus:o.corpuses_history.at(-1),corpus_id:o.corpus_id,remote:!0},null,8,["corpus","corpus_id"]))),128))])],64)}const Na=bt(Ta,[["render",ya],["__scopeId","data-v-2b726278"]]),Ga={data(){return{api:new et,originalText:"",toRemote:!0}},methods:{async onUploadButtonClicked(){this.api.submit("/upload","POST",{original_text:this.originalText}).then(t=>t.json()).then(t=>{dt.emit("addAlert",{message:"Uploaded corpus "+t.corpus_id})})},async onJsonFileInput(t){let s=await t.target.files[0].text();s=JSON.parse(s),this.api.submit("/upload","POST",{corpus:s}).then(l=>l.json()).then(l=>{dt.emit("addAlert",{message:"Uploaded corpus "+l.corpus_id})})}}},ja={id:"frontend_upload_div"};function Oa(t,e,s,l,i,r){return O(),P("div",ja,[e[4]||(e[4]=v("h3",null,"Upload...",-1)),e[5]||(e[5]=v("label",{for:"frontend_original_text"},"Original Text",-1)),e[6]||(e[6]=v("br",null,null,-1)),je(v("textarea",{"onUpdate:modelValue":e[0]||(e[0]=n=>i.originalText=n),class:"context_input auto-resize field_input",name:"frontend_original_text",spellcheck:"false",autofocus:"",placeholder:"Original Text",id:"frontend_original_text_textarea"},null,512),[[Co,i.originalText]]),e[7]||(e[7]=v("br",null,null,-1)),v("button",{onClick:e[1]||(e[1]=n=>r.onUploadButtonClicked()),id:"frontend_original_text_button",class:"btn btn-primary"}," Upload "),e[8]||(e[8]=v("br",null,null,-1)),e[9]||(e[9]=v("p",null,"...or the JSON file",-1)),v("input",{type:"file",id:"json_file_input",onChange:e[2]||(e[2]=(...n)=>r.onJsonFileInput&&r.onJsonFileInput(...n))},null,32),e[10]||(e[10]=v("br",null,null,-1)),e[11]||(e[11]=v("br",null,null,-1)),je(v("input",{"onUpdate:modelValue":e[3]||(e[3]=n=>i.toRemote=n),type:"checkbox",name:"toRemote",id:"toRemote_input",class:"form-check-input",checked:"",disabled:""},null,512),[[Wo,i.toRemote]]),e[12]||(e[12]=v("label",{for:"toRemote_input",class:"form-check-label"},"To the Server",-1))])}const Ca=bt(Ga,[["render",Oa],["__scopeId","data-v-fbd76497"]]),Wa={props:{message:{type:String,required:!0},alertClass:{type:String,default:"alert-warning",validator(t){return["alert-success","alert-warning","alert-info","alert-light"].includes(t)}},timeout:{type:Number,default:5e4}},data(){return{showAlert:!1,alertMessage:this.message}},mounted(){this.showAlert=!0,setTimeout(()=>{this.showAlert=!1},this.timeout)}};function Ia(t,e,s,l,i,r){return i.showAlert?(O(),P("div",{key:0,class:jt(["alert",this.alertClass]),role:"alert"},pt(i.alertMessage),3)):$t("",!0)}const Ra=bt(Wa,[["render",Ia]]),Pa={components:{Alert:Ra},data(){return{alerts:[],maxAlerts:3}},methods:{addAlert({message:t,alertClass:e="alert-light"}){this.alerts.length>=this.maxAlerts&&this.alerts.shift(),this.alerts.push({message:t,alertClass:e})}},created(){dt.on("addAlert",this.addAlert)},beforeDestroy(){dt.off("addAlert",this.addAlert)}};function za(t,e,s,l,i,r){const n=At("Alert");return O(),P("div",null,[(O(!0),P(J,null,ie(i.alerts,(o,u)=>(O(),oe(n,{key:u,message:o.message,timeout:o.timeout,alertClass:o.alertClass},null,8,["message","timeout","alertClass"]))),128))])}const Ha=bt(Pa,[["render",za]]),Fa={props:{task_id:{required:!0},status:{type:String,required:!0},target_corpus_id:{required:!0}},data(){return{api:new et}},computed:{isAbortButtonShown(){return["READY","RUNNING"].includes(this.status)}},methods:{async abort(){this.api.submit("/tasks/"+this.task_id+"/abort")}}},La={class:"task_wrapper"};function Ma(t,e,s,l,i,r){return O(),P("div",La,[e[1]||(e[1]=v("hr",null,null,-1)),v("p",null,[he(" Task: "+pt(s.task_id)+" ",1),r.isAbortButtonShown?(O(),P("button",{key:0,class:"task_button btn btn-light",onClick:e[0]||(e[0]=n=>r.abort())}," Abort ")):$t("",!0),he(" for corpus: "+pt(s.target_corpus_id)+" ("+pt(s.status)+") ",1)])])}const qa=bt(Fa,[["render",Ma]]),Ua={components:{Task:qa},data(){return{api:new et,tasks:[]}},methods:{async updateTasks(){const e=await(await this.api.submit("/tasks/")).json();this.tasks=e}},created(){dt.on("updateTasks",this.updateTasks)},beforeDestroy(){dt.off("updateTasks",this.updateTasks)}};function Ba(t,e,s,l,i,r){const n=At("Task");return O(),P(J,null,[e[0]||(e[0]=v("h3",null,"Tasks",-1)),v("div",null,[(O(!0),P(J,null,ie(i.tasks,(o,u)=>(O(),oe(n,{key:u,task_id:o.task_id,status:o.status,target_corpus_id:o.target_corpus_id},null,8,["task_id","status","target_corpus_id"]))),128))])],64)}const Va=bt(Ua,[["render",Ba]]),Ka={components:{Header:Mo,RestAuth:Ko,AnnotatorSelect:ea,CorpusesView:Na,UploadView:Ca,AlertsView:Ha,TasksView:Va},data(){return{}}};function $a(t,e,s,l,i,r){const n=At("Header"),o=At("RestAuth"),u=At("AnnotatorSelect"),g=At("CorpusesView"),m=At("UploadView"),f=At("AlertsView"),k=At("TasksView");return O(),P(J,null,[v("header",null,[Y(n)]),v("main",null,[Y(o),e[0]||(e[0]=v("hr",null,null,-1)),Y(u),e[1]||(e[1]=v("hr",null,null,-1)),Y(g),e[2]||(e[2]=v("hr",null,null,-1)),Y(m),e[3]||(e[3]=v("hr",null,null,-1)),Y(f),e[4]||(e[4]=v("hr",null,null,-1)),Y(k)])],64)}const Ja=bt(Ka,[["render",$a],["__scopeId","data-v-a82af39b"]]);Po(Ja).mount("#app");
