...
`)},txt(){return this.t.txt},gloss(){let t=this.t.gloss;return t=="!UNKNOWN"&&(t="-"),t}},methods:{toggle(){this.isSelected=!this.isSelected,this.$emit("selectionChanged",{tIndex:this.index,isSelected:this.isSelected})}}},ma={class:"token_ul list-group list-group-flush"},_a={class:"list-group-item token_txt"},ga={class:"list-group-item gloss"},fa={key:1},xa={key:2,class:"token_wrapper"};function ha(t,e,s,l,i,r){return r.is_delimiter?r.should_linebreak?(C(),z("br",fa)):(C(),z("div",xa,[v("span",null,pt(r.txt),1)])):(C(),z("div",{key:0,class:jt(["token_wrapper","card",{"selected-token":i.isSelected}]),onClick:e[0]||(e[0]=n=>r.toggle())},[v("ul",ma,[v("li",_a,pt(r.txt),1),v("li",ga,pt(r.gloss),1)])],2))}const ca=bt(da,[["render",ha],["__scopeId","data-v-77eee0fc"]]),pa={props:{p:{type:Object,required:!0},index:{type:Number,required:!0},remote:{type:Boolean,default:!1}},components:{Token:ca},computed:{isAnnotateButtonVisible(){return this.remote&&!this.p.is_delimiter&&this.p.tokens&&this.p.tokens.length}},data(){return{selectedTokens:new Set,showPre:!1}},methods:{annotateP(){this.$emit("annotateP",this.index)},reannotateP(){this.$emit("reannotateP",this.index,Array.from(this.selectedTokens))},onSelectionChanged({tIndex:t,isSelected:e}){e?this.selectedTokens.add(t):this.selectedTokens.delete(t)}}},ba={class:"paragraph_wrapper"},Aa={key:0,class:"paragraph_annotate_buttons_span"},ka={key:1};function wa(t,e,s,l,i,r){const n=At("Token");return C(),z("div",ba,[r.isAnnotateButtonVisible?(C(),z("span",Aa,[v("button",{class:"corpus_button btn btn-light",onClick:e[0]||(e[0]=o=>r.annotateP(s.index))}," Annotate "),v("button",{class:"corpus_button btn btn-light",onClick:e[1]||(e[1]=o=>r.reannotateP(s.index))}," Reannotate "),e[2]||(e[2]=v("br",null,null,-1))])):ae("",!0),i.showPre?(C(),z("pre",ka,pt(JSON.stringify(s.p)),1)):ae("",!0),(C(!0),z(J,null,ie(s.p.tokens,(o,u)=>(C(),oe(n,{key:u,t:o,index:u,onSelectionChanged:r.onSelectionChanged},null,8,["t","index","onSelectionChanged"]))),128))])}const Ea=bt(pa,[["render",wa],["__scopeId","data-v-c2ae8ec4"]]),va={props:{corpus_id:{required:!0},corpus:{type:Object,required:!0},remote:{type:Boolean,default:!1}},components:{Paragraph:Ea},data(){return{api:new st,sharedState:Ct,isCorpusVisible:!1,showPre:!1}},computed:{pseudoState(){return!this.corpus.paragraphs||this.corpus.paragraphs.length<=0?"PLAIN":this.corpus.paragraphs[0].pstate},divideButtonClass(){const t=this.pseudoState=="PLAIN";return{"btn-primary":t,"btn-light":!t}},parseButtonClass(){const t=this.pseudoState=="DIVIDED";return{"btn-primary":t,"btn-light":!t}},annotateButtonClass(){const t=this.pseudoState=="PARSED";return{"btn-primary":t,"btn-light":!t}},header(){return this.remote?"REMOTE":"LOCAL"}},methods:{toggleCorpusVisibility(){this.isCorpusVisible=!this.isCorpusVisible},download(){const t=JSON.stringify(this.corpus);console.log("Downloading...");let e=document.createElement("a"),s=new Blob([t],{type:"text/plain"});e.download=this.corpus_id+".corpus.json",e.href=URL.createObjectURL(s),e.click()},async divide(t=`
`){return Ct.toRemote?this.divideRemote(t):this.divideLocal(t)},async parse(){return Ct.toRemote?this.parseRemote():this.parseLocal()},async annotate(t=null){this.api.submit("/annotator/annotate","POST",{corpus_id:this.corpus_id,annotate_options:{annotator_name:this.sharedState.annotator_name,lang_from:this.sharedState.lang_from,lang_to:this.sharedState.lang_to,target_paragraphs:t}})},async reannotate(t,e){if(!e){console.error("target_tokens is not given");return}if(e.length==0){Y.emit("addAlert",{message:"No token selected.",alertClass:"alert-warning"});return}this.api.submit("/annotator/reannotate","POST",{corpus_id:this.corpus_id,annotate_options:{annotator_name:this.sharedState.annotator_name,lang_from:this.sharedState.lang_from,lang_to:this.sharedState.lang_to,target_paragraphs:t},reannotate_options:{target_tokens:e}})},async divideRemote(t){this.api.submit("/parser/divide","POST",{corpus_id:this.corpus_id,divide_options:{p_delims:[t]}})},async parseRemote(){this.api.submit("/parser/parse","POST",{corpus_id:this.corpus_id,parse_options:{t_delims:null}})},async divideLocal(t){ri.divide_into_paragraphs(this.corpus,[t])},async parseLocal(){for(const t of this.corpus.paragraphs)ri.parse_paragraph(t)},onAnnotateP(t){this.annotate([t])},onReannotateP(t,e){this.reannotate([t],e)}}},Ta={class:"corpus_wrapper"},Da={key:0,class:"corpus"},Sa={class:"corpus_buttons_span"},ya={key:0,class:"corpus-pre"};function Na(t,e,s,l,i,r){const n=At("Paragraph");return C(),z("div",Ta,[e[9]||(e[9]=v("hr",null,null,-1)),v("h4",{onClick:e[0]||(e[0]=o=>r.toggleCorpusVisibility())},pt(r.header+": "+s.corpus_id),1),i.isCorpusVisible?(C(),z("div",Da,[v("span",Sa,[v("button",{class:"corpus_button btn btn-light",onClick:e[1]||(e[1]=o=>r.download())},"Download"),v("span",null,[v("button",{class:jt(["corpus_button","btn",r.divideButtonClass]),onClick:e[2]||(e[2]=o=>r.divide())},"Divide",2),v("button",{class:jt(["corpus_button","btn",r.divideButtonClass]),onClick:e[3]||(e[3]=o=>r.divide("\\n\\n"))},"Divide (for poems)",2),v("button",{class:jt(["corpus_button","btn",r.parseButtonClass]),onClick:e[4]||(e[4]=o=>r.parse())},"Parse",2),v("button",{class:jt(["corpus_button","btn",r.annotateButtonClass]),onClick:e[5]||(e[5]=o=>r.annotate([-1]))}," Annotate ",2),v("button",{class:jt(["corpus_button","btn",r.annotateButtonClass]),onClick:e[6]||(e[6]=o=>r.annotate(null))}," Annotate (Reset) ",2)])]),e[7]||(e[7]=v("br",null,null,-1)),i.showPre?(C(),z("pre",ya,pt(JSON.stringify(s.corpus)),1)):ae("",!0),e[8]||(e[8]=v("h4",null,"paragraphs",-1)),(C(!0),z(J,null,ie(s.corpus.paragraphs,(o,u)=>(C(),oe(n,{key:u,p:o,index:u,remote:s.remote,onAnnotateP:r.onAnnotateP,onReannotateP:r.onReannotateP},null,8,["p","index","remote","onAnnotateP","onReannotateP"]))),128))])):ae("",!0)])}const Ga=bt(va,[["render",Na],["__scopeId","data-v-bc26ee08"]]),ja={components:{Corpus:Ga},data(){return{api:new st,sampleHost:"https://parkchamchi.github.io/GlossySnake/samples/v1/",localCorpuses:[...na],remoteCorpuses:[],remoteSampleFilenames:[]}},methods:{async updateCorpuses(){const e=await(await this.api.submit("/corpuses/")).json();this.remoteCorpuses=e},async getRemoteSamples(){await fetch(this.sampleHost).then(t=>t.json()).then(t=>{this.remoteSampleFilenames=t.filenames})},async getRemoteSampleCorpus(t){fetch(this.sampleHost+t).then(e=>e.json()).then(e=>{const s=t.replace(".corpus.json","");this.addLocalCorpus({corpus_id:s,corpus:e})}).then(()=>{this.remoteSampleFilenames=this.remoteSampleFilenames.filter(e=>e!==t)})},async addLocalCorpus({corpus_id:t,corpus:e}){this.localCorpuses.push({corpus_id:t,corpuses_history:[e]})}},created(){Y.on("updateCorpuses",this.updateCorpuses),Y.on("addLocalCorpus",this.addLocalCorpus),this.getRemoteSamples()},beforeDestroy(){Y.off("updateCorpuses",this.updateCorpuses),Y.off("addLocalCorpus",this.addLocalCorpus)}},Ca={key:0},Oa=["onClick"];function Wa(t,e,s,l,i,r){const n=At("Corpus");return C(),z(J,null,[i.remoteSampleFilenames.length>0?(C(),z("div",Ca,[e[0]||(e[0]=v("h4",null,"Get a sample:",-1)),(C(!0),z(J,null,ie(i.remoteSampleFilenames,(o,u)=>(C(),z("p",{class:"sampleLinkP",onClick:g=>r.getRemoteSampleCorpus(o)},pt(o),9,Oa))),256))])):ae("",!0),v("div",null,[(C(!0),z(J,null,ie(i.localCorpuses,(o,u)=>(C(),oe(n,{key:u,corpus:o.corpuses_history.at(-1),corpus_id:o.corpus_id,remote:!1},null,8,["corpus","corpus_id"]))),128)),(C(!0),z(J,null,ie(i.remoteCorpuses,(o,u)=>(C(),oe(n,{key:u,corpus:o.corpuses_history.at(-1),corpus_id:o.corpus_id,remote:!0},null,8,["corpus","corpus_id"]))),128))])],64)}const Ra=bt(ja,[["render",Wa],["__scopeId","data-v-11e061a2"]]),Ia={data(){return{api:new st,originalText:""}},methods:{async onUploadButtonClicked(){return Ct.toRemote?this.uploadOriginalTextRemote():this.uploadOriginalTextLocal()},async onJsonFileInput(t){const s=await t.target.files[0].text(),l=JSON.parse(s);return Ct.toRemote?this.uploadJsonFileRemote(l):this.uploadJsonFileLocal(l)},async uploadOriginalTextRemote(){this.api.submit("/upload","POST",{original_text:this.originalText}).then(t=>t.json()).then(t=>{Y.emit("addAlert",{message:"Uploaded corpus "+t.corpus_id})})},async uploadJsonFileRemote(t){this.api.submit("/upload","POST",{corpus:t}).then(e=>e.json()).then(e=>{Y.emit("addAlert",{message:"Uploaded corpus "+e.corpus_id})})},async uploadOriginalTextLocal(){const t="the corpus id (TODO)",e=aa.init_with_txt(this.originalText);Y.emit("addLocalCorpus",{corpus_id:t,corpus:e})},async uploadJsonFileLocal(t){Y.emit("addLocalCorpus",{corpus_id:"the corpus id (JSON) (TODO)",corpus:t})}}},Pa={id:"frontend_upload_div"};function za(t,e,s,l,i,r){return C(),z("div",Pa,[e[3]||(e[3]=v("h3",null,"Upload...",-1)),e[4]||(e[4]=v("label",{for:"frontend_original_text"},"Original Text",-1)),e[5]||(e[5]=v("br",null,null,-1)),Se(v("textarea",{"onUpdate:modelValue":e[0]||(e[0]=n=>i.originalText=n),class:"context_input auto-resize field_input",name:"frontend_original_text",spellcheck:"false",autofocus:"",placeholder:"Original Text",id:"frontend_original_text_textarea"},null,512),[[Po,i.originalText]]),e[6]||(e[6]=v("br",null,null,-1)),v("button",{onClick:e[1]||(e[1]=n=>r.onUploadButtonClicked()),id:"frontend_original_text_button",class:"btn btn-primary"}," Upload "),e[7]||(e[7]=v("br",null,null,-1)),e[8]||(e[8]=v("p",null,"...or the JSON file",-1)),v("input",{type:"file",id:"json_file_input",onChange:e[2]||(e[2]=(...n)=>r.onJsonFileInput&&r.onJsonFileInput(...n))},null,32),e[9]||(e[9]=v("br",null,null,-1))])}const Ha=bt(Ia,[["render",za],["__scopeId","data-v-fb0a1a09"]]),Fa={props:{message:{type:String,required:!0},alertClass:{type:String,default:"alert-warning",validator(t){return["alert-success","alert-warning","alert-info","alert-light"].includes(t)}},timeout:{type:Number,default:5e4}},data(){return{showAlert:!1,alertMessage:this.message}},mounted(){this.showAlert=!0,setTimeout(()=>{this.showAlert=!1},this.timeout)}};function La(t,e,s,l,i,r){return i.showAlert?(C(),z("div",{key:0,class:jt(["alert",this.alertClass]),role:"alert"},pt(i.alertMessage),3)):ae("",!0)}const Ma=bt(Fa,[["render",La]]),qa={components:{Alert:Ma},data(){return{alerts:[],maxAlerts:3}},methods:{addAlert({message:t,alertClass:e="alert-light"}){this.alerts.length>=this.maxAlerts&&this.alerts.shift(),this.alerts.push({message:t,alertClass:e})}},created(){Y.on("addAlert",this.addAlert)},beforeDestroy(){Y.off("addAlert",this.addAlert)}};function Ua(t,e,s,l,i,r){const n=At("Alert");return C(),z("div",null,[(C(!0),z(J,null,ie(i.alerts,(o,u)=>(C(),oe(n,{key:u,message:o.message,timeout:o.timeout,alertClass:o.alertClass},null,8,["message","timeout","alertClass"]))),128))])}const Ba=bt(qa,[["render",Ua]]),Va={props:{task_id:{required:!0},status:{type:String,required:!0},target_corpus_id:{required:!0}},data(){return{api:new st}},computed:{isAbortButtonShown(){return["READY","RUNNING"].includes(this.status)}},methods:{async abort(){this.api.submit("/tasks/"+this.task_id+"/abort")}}},Ka={class:"task_wrapper"};function $a(t,e,s,l,i,r){return C(),z("div",Ka,[e[1]||(e[1]=v("hr",null,null,-1)),v("p",null,[ms(" Task: "+pt(s.task_id)+" ",1),r.isAbortButtonShown?(C(),z("button",{key:0,class:"task_button btn btn-light",onClick:e[0]||(e[0]=n=>r.abort())}," Abort ")):ae("",!0),ms(" for corpus: "+pt(s.target_corpus_id)+" ("+pt(s.status)+") ",1)])])}const Ja=bt(Va,[["render",$a]]),Qa={components:{Task:Ja},data(){return{api:new st,tasks:[]}},methods:{async updateTasks(){const e=await(await this.api.submit("/tasks/")).json();this.tasks=e}},created(){Y.on("updateTasks",this.updateTasks)},beforeDestroy(){Y.off("updateTasks",this.updateTasks)}};function Za(t,e,s,l,i,r){const n=At("Task");return C(),z(J,null,[e[0]||(e[0]=v("h3",null,"Tasks",-1)),v("div",null,[(C(!0),z(J,null,ie(i.tasks,(o,u)=>(C(),oe(n,{key:u,task_id:o.task_id,status:o.status,target_corpus_id:o.target_corpus_id},null,8,["task_id","status","target_corpus_id"]))),128))])],64)}const Ya=bt(Qa,[["render",Za]]),Xa={components:{Header:Vo,RestAuth:Zo,AnnotatorSelect:ra,CorpusesView:Ra,UploadView:Ha,AlertsView:Ba,TasksView:Ya},data(){return{}}};function tu(t,e,s,l,i,r){const n=At("Header"),o=At("RestAuth"),u=At("AnnotatorSelect"),g=At("CorpusesView"),m=At("UploadView"),f=At("AlertsView"),k=At("TasksView");return C(),z(J,null,[v("header",null,[X(n)]),v("main",null,[X(o),e[0]||(e[0]=v("hr",null,null,-1)),X(u),e[1]||(e[1]=v("hr",null,null,-1)),X(g),e[2]||(e[2]=v("hr",null,null,-1)),X(m),e[3]||(e[3]=v("hr",null,null,-1)),X(f),e[4]||(e[4]=v("hr",null,null,-1)),X(k)])],64)}const eu=bt(Xa,[["render",tu],["__scopeId","data-v-a82af39b"]]);Lo(eu).mount("#app");
